 ...
 */
package net.wit.plugin.weixinpay.natives;
 ...
 * @version 3.0
 */
@Controller("adminWeiXinNativePayController")
@RequestMapping("/admin/payment_plugin/weixinpay/natives")
public class WeiXinNativePayController extends BaseController {

	@Resource(name = "weixinNativePayPlugin")
	private WeiXinNativePayPlugin weixinNativePayPlugin;
	...
	public @ResponseBody
	Message install() {
		if (!weixinNativePayPlugin.getIsInstalled()) {
			PluginConfig pluginConfig = new PluginConfig();
			pluginConfig.setPluginId(weixinNativePayPlugin.getId());
	...
	Message uninstall() {
		if (weixinNativePayPlugin.getIsInstalled()) {
			PluginConfig pluginConfig = weixinNativePayPlugin.getPluginConfig();
	...
	public String setting(ModelMap model) {
		...
		return "/net/wit/plugin/weixinpay/natives/setting";
	}
