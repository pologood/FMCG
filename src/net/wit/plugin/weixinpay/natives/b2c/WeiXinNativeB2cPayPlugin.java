 ...
 * @version 3.0
 */
@Component("weixinNativeB2cPayPlugin")
public class WeiXinNativeB2cPayPlugin extends PaymentPlugin {
	...
	public String getInstallUrl() {
		return "weixinpay/natives/b2c/install.jhtml";
	}

	@Override
	public String getUninstallUrl() {
		return "weixinpay/natives/b2c/uninstall.jhtml";
	}

	@Override
	public String getSettingUrl() {
		return "weixinpay/natives/b2c/setting.jhtml";
	}
