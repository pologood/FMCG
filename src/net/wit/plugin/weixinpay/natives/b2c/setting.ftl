...
<title>${message("admin.plugin.wxpay.setting")} - Powered By rsico</title>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="appId" class="text" value="${pluginConfig.attributes.get("appId")}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="appKey" class="text" value="${pluginConfig.attributes.get("appKey")}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>partnerKey:
				</th>
				<td>
