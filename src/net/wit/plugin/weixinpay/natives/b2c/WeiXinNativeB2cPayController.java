 ...
 */
package net.wit.plugin.weixinpay.natives.b2c;
...
/**
 * Controller - 微信手机在线支付-b2c
 * @author rsico Team
 * @version 3.0
 */
@Controller("adminWeiXinNativeB2cPayController")
@RequestMapping("/admin/payment_plugin/weixinpay/natives/b2c")
public class WeiXinNativeB2cPayController extends BaseController {

	@Resource(name = "weixinNativeB2cPayPlugin")
	private WeiXinNativeB2cPayPlugin weixinNativeB2cPayPlugin;
	...
	public @ResponseBody
	Message install() {
		if (!weixinNativeB2cPayPlugin.getIsInstalled()) {
			PluginConfig pluginConfig = new PluginConfig();
			pluginConfig.setPluginId(weixinNativeB2cPayPlugin.getId());
	...
	Message uninstall() {
		if (weixinNativeB2cPayPlugin.getIsInstalled()) {
			PluginConfig pluginConfig = weixinNativeB2cPayPlugin.getPluginConfig();
	...
	public String setting(ModelMap model) {
		...
		return "/net/wit/plugin/weixinpay/natives/b2c/setting";
	}
