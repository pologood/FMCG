 ...
 * @version 3.0
 */
@Component("weixinNativePayPlugin")
public class WeiXinNativePayPlugin extends PaymentPlugin {
	...
	public String getInstallUrl() {
		return "weixinpay/natives/install.jhtml";
	}

	@Override
	public String getUninstallUrl() {
		return "weixinpay/natives/uninstall.jhtml";
	}

	@Override
	public String getSettingUrl() {
		return "weixinpay/natives/setting.jhtml";
	}
