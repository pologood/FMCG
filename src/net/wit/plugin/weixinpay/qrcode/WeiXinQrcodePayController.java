 ...
 * @version 3.0
 */
@Controller("adminWeiXinPayQrcodeController")
@RequestMapping("/admin/payment_plugin/weixinpay/qrcode")
public class WeiXinQrcodePayController extends BaseController {

	@Resource(name = "weixinQrcodePayPlugin")
	private WeiXinQrcodePayPlugin weixinQrcodePayPlugin;
	...
	public @ResponseBody
	Message install() {
		if (!weixinQrcodePayPlugin.getIsInstalled()) {
			PluginConfig pluginConfig = new PluginConfig();
			pluginConfig.setPluginId(weixinQrcodePayPlugin.getId());
	...
	Message uninstall() {
		if (weixinQrcodePayPlugin.getIsInstalled()) {
			PluginConfig pluginConfig = weixinQrcodePayPlugin.getPluginConfig();
	...
	public String setting(ModelMap model) {
		...
		return "/net/wit/plugin/weixinpay/qrcode/setting";
	}
