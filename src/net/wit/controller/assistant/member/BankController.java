...
import net.wit.controller.assistant.model.BankInfoModel;
import net.wit.controller.assistant.model.DataBlock;
import net.wit.controller.assistant.model.MemberBankModel;
 ...
 */
@Controller("assistantMemberBankController")
@RequestMapping("/assistant/member/bank")
public class BankController extends BaseController {
	...
	@ResponseBody
	public DataBlock bankInfo(HttpServletRequest request) {
	...
	@ResponseBody
	public DataBlock list(HttpServletRequest request) {
	...
	public DataBlock save(MemberBank memberBank,Long bankInfoId,String captcha,String idCardNo,HttpServletRequest request) {
		...
		if (memberBank.getDepositUser().compareTo(member.getName()==null?"":member.getName())!=0) {
			return DataBlock.error("银行卡开户名与实名认证名不符");
		}
//		if(idCardNo!=null&&idCardNo.compareTo(member.getIdcard().getNo())!=0){
//			return DataBlock.error("证件号与实名认证不一致");
//		}
