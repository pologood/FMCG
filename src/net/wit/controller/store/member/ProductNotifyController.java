 ...
 * @version 3.0
 */
@Controller("storeMemberProductNotifyController")
@RequestMapping("/store/member/product_notify")
public class ProductNotifyController extends net.wit.controller.store.BaseController {
	...
	public String list(Integer pageNumber, Model model) {
		...
		return "/store/member/product_notify/list";
	}
	...
	public String manager(Boolean isMarketable, Boolean isOutOfStock, Boolean hasSent, Pageable pageable, ModelMap model) {
		...
		model.addAttribute("pageActive",2);
		return "/store/member/product_notify/manager";
	}
