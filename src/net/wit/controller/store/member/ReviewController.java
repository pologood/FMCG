 ...
 * @version 3.0
 */
@Controller("storeMemberReviewController")
@RequestMapping("/store/member/review")
public class ReviewController extends BaseController {
	...
	public String list(Integer pageNumber, ModelMap model) {
		...
		model.addAttribute("menu","review_management");
		return "/store/member/review/list";
	}
	...
	public String edit(Long id, ModelMap model) {
		...
		model.addAttribute("menu","review_management");
		return "/store/member/review/edit";
	}
	...
	public String list(String searchValue,Type type, Pageable pageable, ModelMap model) {
		...
		model.addAttribute("member",member);
		model.addAttribute("menu","review_management");
		return "/store/member/review/manager";
	}
