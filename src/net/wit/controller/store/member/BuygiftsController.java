 ...
 * @version 3.0
 */
@Controller("storeMemberBuygiftsController")
@RequestMapping("/store/member/buygifts")
public class BuygiftsController extends BaseController {
    ...
    public String listBuygift(Pageable pageable,  ModelMap model) {
        ...
        model.addAttribute("menu","buy_gift");
        return "/store/member/buygifts/listbuygift";
    }
    ...
    public String listproduct(Long productCategoryId, Long productCategoryTenantId, Long brandId, String searchValue, Long promotionId,
        ...
        model.addAttribute("menu","buy_gift");
        return "/store/member/buygifts/listproduct";
    }
    ...
    public String listGifts(Pageable pageable, ModelMap model) {
        ...
        model.addAttribute("page", page);
        model.addAttribute("menu","buy_gift");
        return "/store/member/buygifts/listgift";
    }
...
//        Page<Product> page = productService.findMyPage(member.getTenant(), null, null, null, null, null, null, null, null, null,null, true, null, true, null, null, OrderType.dateDesc, pageable);
        List<Product> products=productService.findMyList(tenant, null, null, null, null, null, null, null, null, null, true, null, true, null, null, null, OrderType.dateDesc);
//        model.addAttribute("page", page);
        model.addAttribute("products",products);
        model.addAttribute("product", product);
        model.addAttribute("menu","buy_gift");
        return "/store/member/buygifts/edit";
    }
