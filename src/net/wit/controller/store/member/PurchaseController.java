 ...
 */
@Controller("storeMemberPurchaseController")
@RequestMapping("/store/member/purchase")
public class PurchaseController extends BaseController {
    ...
    public String list(Pageable pageable, ModelMap model,String begin_date, String end_date,String keywords) {
        ...
        model.addAttribute("menu","purchase");
        return "/store/member/purchase/list";
    }
    ...
    public String add(ModelMap model) {
        ...
        model.addAttribute("menu","purchase");
        return "/store/member/purchase/add";
    }
    ...
    public String edit(@PathVariable Long id, Type type,ModelMap model) {
        ...
        model.addAttribute("menu","purchase");
        return "/store/member/purchase/edit";
    }
    ...
    public String print(Long id,ModelMap model) {
        ...
        model.addAttribute("menu","purchase");
        return "/store/member/purchase/print_purchase";
    }
    ...
    public DataBlock update(@PathVariable Long id, Long[] sns, Integer[] quartitys ) {
        ...
        purchase.setType(Type.inStorage);
    ...
    public String supplierList(Long id, String keywords, Pageable pageable,ModelMap model) {
        ...
        model.addAttribute("keywords",keywords);
        model.addAttribute("menu","purchase");
        return "/store/member/purchase/supplier_list";
    }
