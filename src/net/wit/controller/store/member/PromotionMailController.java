 ...
 * @version 3.0
 */
@Controller("storeMemberPromotionMailController")
@RequestMapping("/store/member/promotion/mail")
public class PromotionMailController extends net.wit.controller.store.BaseController {
	...
	public String recharge(ModelMap model) {
		...
		return "store/member/deposit/view";
	}
