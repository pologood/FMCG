 ...
 */
@Controller("storeMembertfreightController")
@RequestMapping("/store/member/freight")
...
//		Freight freight=tenant.getFreight();
		...
		return "/store/member/freight/edit";
	}
	...
	public String update(Freight freight,RedirectAttributes redirectAttributes) {
		...
		return "redirect:/store/member/freight/edit.jhtml";
