...
@Controller("storeMemberTenantController")
@RequestMapping("/store/member/tenant")
public class TenantController extends BaseController {
    ...
    public String add(Long pageActive, ModelMap model) {
        ...
        return "/store/member/tenant/add";
    }
    ...
    public String edit(HttpServletRequest request, ModelMap model) {
        ...
        model.addAttribute("tenantCategorys", tenantCategoryService.findAll());
        model.addAttribute("member", member);
        model.addAttribute("menu","tenant_management");
        return "/store/member/tenant/edit";
    }
...
//        tenantService.save(saveTenant, member, null);
    ...
    public String addImage(Tenant tenant, HttpServletRequest request, RedirectAttributes redirectAttributes) {
        ...
        return "redirect:/store/member/ad/list.jhtml?";
    }
    ...
    public String status(ModelMap model) {
        ...
        model.addAttribute("pageActive", 2);
        return "/store/member/tenant/status";
    }
    ...
    public String index(ModelMap model) {
        ...
        model.addAttribute("pageActive", 2);
        model.addAttribute("member", member);
        return "/store/member/tenant/index";
    }
    ...
    public String memberList(Integer pageNumber, ModelMap model) {
        ...
        return "/store/member/constomer/list";
    }
    ...
    public String memberRegister(HttpServletRequest request, HttpServletResponse response, ModelMap model, RedirectAttributes redirectAttributes) {
        ...
        model.addAttribute("member", agent);
        return "/store/member/constomer/add";
    }
    ...
    public String list(ModelMap model, Pageable pageable, String keyWord) {
        ...
        Tenant tenant = member.getTenant();
        if (tenant == null) {
            return "redirect:/store/register/add.jhtml";
        }
        ...
        model.addAttribute("menu","tenant_employee");
        return "/store/member/tenant/employee/list";
    }
    ...
    public String add(ModelMap model) {
        ...
        model.addAttribute("menu","tenant_employee");
        return "/store/member/tenant/employee/add";
    }
    ...
    @ResponseBody
    public DataBlock add(String usernumber,String newPassword,String mobile, Long deliveryCenterId, Long[] roles, String username, Gender gender, String address, String captcha, HttpServletRequest request, HttpServletResponse response) {
        Member member = memberService.getCurrent();
        if (member == null) {
        ...
        if (mobile!=null){
            isExists= memberService.usernameExists(mobile);
            _mobileTemp=mobile;
...
//        }
    ...
    public String edit(Long id, ModelMap model) {
        ...
        model.addAttribute("types", TenantRules.Type.values());
        model.addAttribute("menu","tenant_employee");
        return "store/member/tenant/employee/edit";
    }
    /**
	 * 员工编辑提交
	 */
