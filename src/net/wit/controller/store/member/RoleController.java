...
import net.wit.controller.store.model.TenantRulesRoleModel;
...
@Controller("storeMemberRoleController")
@RequestMapping("/store/member/role")
public class RoleController extends BaseController {
    ...
    public String save(Role role,
        ...
        try {
            ...
            return "redirect:/store/member/role/list.jhtml";
        } catch (Exception e) {
            e.printStackTrace();
            addFlashMessage(redirectAttributes, ERROR_MESSAGE);
            return "redirect:/store/member/role/add.jhtml";
        }
...
//            role.setTenant(memberService.getCurrent().getTenant());
            ...
            e.printStackTrace();
            addFlashMessage(redirectAttributes, ERROR_MESSAGE);
            return "redirect:/store/member/role/edit.jhtml?id=" + role.getId();
        }
