...
@Controller("storeMemberArticleController")
@RequestMapping("/store/member/article")
public class ArticleController extends BaseController {
	...
	public String articleList(Pageable pageable, ModelMap model) {
		...
		return "/store/member/article/list";
	}
	...
	public String articleAdd(ModelMap model) {
		...
		model.addAttribute("member", member);
		model.addAttribute("menu", "tenant_management");
		return "/store/member/article/add";
	}
	...
	public String articleEdit(Long id, ModelMap model) {
		...
		model.addAttribute("pageActive",2);
		model.addAttribute("menu", "tenant_management");
		return "/store/member/article/edit";
	}
