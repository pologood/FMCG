 ...
 * @version 3.0
 */
@Controller("storeMemberProductController")
@RequestMapping("/store/member/product")
public class ProductController extends BaseController {
    ...
    public String add(ModelMap model, Long productCategoryId) {
        ...
        model.addAttribute("menu", "add_proudct");
        return "/store/member/product/add";
    }
    ...
    public String addProductCategory(ModelMap model, Long productCategoryId) {
        ...
        model.addAttribute("member", member);
        model.addAttribute("productCategoryMembers", productCategoryMembers);
        model.addAttribute("menu","add_product");
        return "/store/member/product/addProductCategory";
    }
...
//		product.setIsMarketable(true);
    ...
    public String edit(Long id, ModelMap model) {
        ...
        return "/store/member/product/edit";
    }
...
//        Page<Product> page = productService.openPage(pageable,member.getTenant(),productCategories,isMarketable,isList,brand,promotion,tags,searchValue,null,null,null,null,null,OrderType.dateDesc);
        ...
        model.addAttribute("memberRanks",memberRankService.findAll());
        model.addAttribute("menu","product_list");
        return "/store/member/product/isMarketableList";
    }
    /**
     * 已上架列表
     */
...
//        filters.add(new Filter("isList",Operator.eq,isList));
        ...
        model.addAttribute("memberRanks",memberRankService.findAll());
        model.addAttribute("menu","product_list");
        return "/store/member/product/notMarketablelist";
    }
...
//        }
    ...
    public @ResponseBody
    DataBlock supplierProducts(Long id) {
    ...
    public @ResponseBody
    DataBlock spUpMarket(Long[] ids, HttpServletRequest request){
        Member member=memberService.getCurrent();
        if(member==null){
