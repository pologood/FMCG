 ...
 */
@Controller("storeMemberActivityController")
@RequestMapping("/store/member/activity")
public class ActivityController extends net.wit.controller.store.BaseController {
    ...
    public String list(ActivityRules.Type type, Pageable pageable, ModelMap model) {
        ...
        return "/store/member/activity/list";
    }
