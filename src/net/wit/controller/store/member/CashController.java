 ...
 * @version 3.0
 */
@Controller("storeMemberCashController")
@RequestMapping("/store/member/cash")
public class CashController extends net.wit.controller.store.BaseController {
...
//		}
        ...
        try {
            ...
            if (member.getBalance().subtract(member.getFreezeCashBalance()).compareTo(credit.getEffectiveAmount()) < 0) {
                ...
                return "redirect:/store/member/cash/index.jhtml";
            }
    ...
    public String notify(ModelMap model) {
        return "redirect:store/member/cash/notify";
    }
    ...
    public String index(ModelMap model, RedirectAttributes redirectAttributes) {
        ...
        return "store/member/cash/index";
    }
    ...
    public String list(String startDate, String status, String endDate, ModelMap model, Pageable pageable) throws ParseException {
        ...
        model.addAttribute("page", creditService.findPage(member, start_time, end_time, Type.cash, pageable));
        model.addAttribute("member", member);
