 ...
 * @version 3.0
 */
@Controller("b2b/memberProductCategoryController")
@RequestMapping("/b2b/member/product_category")
public class ProductCategoryTenantController extends BaseController {
	...
	public String add(ModelMap model) {
		...
		return "/b2b/member/product_category/add";
	}
	...
	public String edit(Long id, ModelMap model) {
		...
		model.addAttribute("tags", tagService.findList(Type.productCategory));
		return "/b2b/member/product_category/edit";
	}
	...
	public String list(ModelMap model) {
		...
		model.addAttribute("member", member);
		model.addAttribute("productCategoryTree", productCategoryTenantService.findTree(tenant));
		return "/b2b/member/product_category/list";
	}
