 ...
 * @version 3.0
 */
@Controller("b2bMemberDepositController")
@RequestMapping("/b2b/member/deposit")
public class DepositController extends BaseController {
	...
	public String recharge(ModelMap model) {
		...
		return "b2b/member/deposit/recharge";
	}
	...
	public String list(Integer pageNumber, ModelMap model) {
		...
		return "b2b/member/deposit/list";
	}
	...
	public String rechargeList(Integer pageNumber, ModelMap model) {
		...
		return "b2b/member/deposit/recharge/list";
	}
