 ...
 * @version 3.0
 */
@Controller("b2bMemberProductNotifyController")
@RequestMapping("/b2b/member/product_notify")
public class ProductNotifyController extends BaseController {
	...
	public String list(Integer pageNumber, Model model) {
		...
		return "/b2b/member/product_notify/list";
	}
	...
	public String manager(Boolean isMarketable, Boolean isOutOfStock, Boolean hasSent, Pageable pageable, ModelMap model) {
		...
		return "/b2b/member/product_notify/manager";
	}
