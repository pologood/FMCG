 ...
 * @version 3.0
 */
@Controller("b2bMemberAgentController")
@RequestMapping("/b2b/member/agent")
public class AgentController extends BaseController {
	...
	public String rebate(Integer pageNumber,ModelMap model) {
		...
		return "b2b/member/agent/rebate";
	}
	/**
	 * 注册提交
	 */
