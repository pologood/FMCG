 ...
 * @version 3.0
 */
@Controller("helperMemberDiscountController")
@RequestMapping("/helper/member/discount")
public class DiscountController extends BaseController {
	...
	public String list( Pageable pageable,ModelMap model) {
		...
		return "/helper/member/discount/list";
	...
	public String listproduct(Long productCategoryId, Long productCategoryTenantId, Long brandId,String searchValue,  Long promotionId,
		...
		model.addAttribute("tags", tagService.findList(net.wit.entity.Tag.Type.product));
		...
		return "/helper/member/discount/listproduct";
	}
	...
	public String edit(Long id, ModelMap model,RedirectAttributes redirectAttributes) {
		...
		for (Promotion p : promotions) {
			if(p!=null){
				addFlashMessage(redirectAttributes, net.wit.Message.error("此商品已有折扣方案，请不要重复添加。"));
		...
		model.addAttribute("pageActive", 2);
		model.addAttribute("member", member);
		return "/helper/member/discount/edit";
	}
