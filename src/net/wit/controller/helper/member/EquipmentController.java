 ...
 */
@Controller("helperMemberEquipmentController")
@RequestMapping("/helper/member/equipment")
public class EquipmentController extends BaseController {
    ...
    public String List(String type, String keyWord, Pageable pageable, ModelMap model) {
        ...
        return "helper/member/equipment/list";
    }
    ...
    public String Detail(String type, Long id, ModelMap model) {
        ...
        model.addAttribute("type",type);
        return "helper/member/equipment/detail";
    }
}
