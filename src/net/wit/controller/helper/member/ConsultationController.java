 ...
 * @version 3.0
 */
@Controller("helperMemberConsultationController")
@RequestMapping("/helper/member/consultation")
public class ConsultationController extends BaseController {
	...
	public String reply(Long id, ModelMap model) {
		...
		return "/helper/member/consultation/reply";
	}
	...
	public String edit(Long id, ModelMap model) {
		...
		model.addAttribute("pageActive",2);
		model.addAttribute("member",member);
		return "/helper/member/consultation/edit";
	}
	...
	public String manager(Pageable pageable, ModelMap model) {
		...
		model.addAttribute("pageActive",2);
		model.addAttribute("member",member);
		return "/helper/member/consultation/manager";
	}
