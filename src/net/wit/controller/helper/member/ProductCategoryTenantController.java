 ...
 * @version 3.0
 */
@Controller("helperMemberProductCategoryController")
@RequestMapping("/helper/member/product_category")
public class ProductCategoryTenantController extends BaseController {
	...
	public String add(ModelMap model) {
		...
		return "/helper/member/product_category/add";
	}
	...
	public String edit(Long id, ModelMap model) {
		...
		model.addAttribute("pageActive",2);
		model.addAttribute("member",member);
		return "/helper/member/product_category/edit";
	}
	...
	public String list(ModelMap model) {
		...
		model.addAttribute("pageActive",2);
		model.addAttribute("member",member);
		return "/helper/member/product_category/list";
	}
