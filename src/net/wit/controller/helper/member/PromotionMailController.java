 ...
 * @version 3.0
 */
@Controller("helperMemberPromotionMailController")
@RequestMapping("/helper/member/promotion/mail")
public class PromotionMailController extends BaseController {
	...
	public String recharge(ModelMap model) {
		...
		return "helper/member/deposit/view";
	}
