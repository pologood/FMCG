...
@Controller("helperMemberRelationController")
@RequestMapping("/helper/member/relation")
public class RelationController extends BaseController{
	...
	public String list(Status status,Long memberRankId,Pageable pageable, ModelMap model) {
		...
		model.addAttribute("relationStatuss", Status.values());
		...
		return "/helper/member/relation/list";
	}
	...
	public String editParent(Long id, ModelMap model) {
		...
		model.addAttribute("member", member);
		return "/helper/member/relation/edit_parent";
	}
	...
	public String edit(Long id, ModelMap model) {
		...
		model.addAttribute("pageActive",2);
		model.addAttribute("member", member);
		return "/helper/member/relation/edit";
	}
	...
	public String index(Long id, ModelMap model,Long sellerId,Pageable pageable) {
		...
		return "/helper/member/relation/settle_account";
	}
}
