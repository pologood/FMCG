 ...
 * @version 3.0
 */
@Controller("adminPromotionBuyfreeController")
@RequestMapping("/admin/promotion/buyfree")
public class PromotionBuyfreeController extends BaseController {
...
//		model.addAttribute("coupons", couponService.findAll());
		return "/admin/promotion/buyfree/add";
	}
	...
	public String save(Promotion promotion, Long[] memberRankIds, Long[] productCategoryIds, Long[] brandIds, Long[] couponIds,
			Long[] productIds, RedirectAttributes redirectAttributes,Boolean isDoublePoint) {
...
//		}
		...
		if (StringUtils.isNotEmpty(promotion.getPriceExpression())) {
			try {
				Map<String, Object> model = new HashMap<String, Object>();
				model.put("quantity", 111);
				model.put("price", new BigDecimal(10));
	...
	public String edit(Long id, ModelMap model) {
		...
		model.addAttribute("brands", brandService.findAll());
//		model.addAttribute("coupons", couponService.findAll());
		return "/admin/promotion/buyfree/edit";
	}
...
//		promotion.setCoupons(new HashSet<Coupon>(couponService.findList(couponIds)));
	...
	public String list(Pageable pageable, ModelMap model) {
		...
		return "/admin/promotion/buyfree/list";
	}
