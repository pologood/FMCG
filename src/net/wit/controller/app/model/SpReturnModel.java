...
public class SpReturnModel extends BaseModel {
	...
	public static List<SpReturnModel> bindData(List<Shipping> shippings) {
		List<SpReturnModel> models = new ArrayList<SpReturnModel>();
		for (Shipping shipping:shippings) {
			SpReturnModel model = new SpReturnModel();
