 ...
 * @version 3.0
 */
@Controller("appCommonCommonController")
...
//		if bundle.containsKey("company")
	...
	public @ResponseBody DataBlock Equipment(String uuid) {
		net.wit.entity.Equipment equipment = equipmentService.findByUUID(uuid);
		if (equipment==null) {
			equipment = new net.wit.entity.Equipment();
			equipment.setStatus(Status.none);
			equipment.setUuid(uuid);
			equipment.setOperatingSystem(OperatingSystem.andriod);
