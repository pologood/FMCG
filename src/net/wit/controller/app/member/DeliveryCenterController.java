 ...
 */
@Controller("appMemberDeliveryCenterController")
@RequestMapping("/app/member/delivery_center")
...
//	private ActivityRulesService activityRulesService;
	...
	public DataBlock list(Location location,Pageable pageable,HttpServletRequest request) {
	    ...
	    Page<DeliveryCenter> page = deliveryCenterService.findPage(member, location, pageable);
	...
	public @ResponseBody DataBlock save(DeliveryCenter deliveryCenter,BigDecimal lat,BigDecimal lng,String [] images,Long areaId, HttpServletRequest request) {
	    Member member = memberService.getCurrent();
	    if (member==null) {
	    	return DataBlock.error(DataBlock.SESSION_INVAILD);
	    }
