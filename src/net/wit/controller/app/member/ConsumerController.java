 ...
 */
@Controller("appMemberConsumerController")
@RequestMapping("/app/member/consumer")
public class ConsumerController extends BaseController {
	...
	public DataBlock qrcodeJson(Long id,HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			// 第三方用户唯一凭证
			String url = bundle.getString("WeiXinSiteUrl") + "/wap/share/index.jhtml?extension=" + (member != null ? member.getUsername() : "");
	...
	public @ResponseBody DataBlock share(Long id,String type) {
		...
		String url = "";
	    if (!"app".equals(type)) {
	    	url = MenuManager.codeUrlO2(URLEncoder.encode(bundle.getString("WeiXinSiteUrl") + "/wap/share/index.jhtml?extension=" + (member != null ? member.getUsername() : "")));
	    } else {
	    	url = bundle.getString("WeiXinSiteUrl") + "/wap/share/index.jhtml?extension=" + (member != null ? member.getUsername() : "");
	    }
