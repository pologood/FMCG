 ...
 * @version 3.0
 */
@Controller("b2cProductController")
...
public class ProductController extends BaseController {
    ...
    public String content(@PathVariable Long id, HttpServletRequest request, ModelMap model,RedirectAttributes redirectAttributes) {
        ...
        if(product==null){
        	...
        	return "redirect:/b2c/product/list/0.jhtml";
        }
    ...
    public String productOne(Long parentId, ModelMap model) {
        ...
        return "/b2c/product/oneCategory";
    }
    ...
    public String list(@PathVariable Long productCategoryId, Long brandId, Long areaId, Long productCategoryTagId, OrderType orderType, Integer pageNumber, Integer pageSize,String keyword,
