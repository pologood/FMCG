 ...
 * @version 3.0
 */
@Controller("b2cMemberConsultationController")
@RequestMapping("/b2c/member/consultation")
public class ConsultationController extends BaseController {
	...
	public String list(Integer pageNumber, ModelMap model) {
		...
		return "b2c/member/consultation/list";
	}
	...
	public String reply(Long id, ModelMap model) {
		...
		return "b2c/member/consultation/reply";
	}
	...
	public String edit(Long id, ModelMap model) {
		...
		model.addAttribute("member", member);
		model.addAttribute("consultation", consultationService.find(id));
		return "b2c/member/consultation/edit";
	}
	...
	public String list(Pageable pageable, ModelMap model) {
		...
		return "b2c/member/consultation/manager";
	}
