 ...
 * @version 3.0
 */
@Controller("b2cMemberReviewController")
@RequestMapping("/b2c/member/review")
public class ReviewController extends BaseController {
	...
	public String list(Type type, Pageable pageable, ModelMap model) {
		...
		return "b2c/member/review/manager";
	}
	...
	public @ResponseBody Message save(Long tradeId, Review review, HttpServletRequest request) {
		...
		reviewService.reviewTrade("b2c", member, trade, null,review);
