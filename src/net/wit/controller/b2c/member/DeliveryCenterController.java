 ...
 * @version 3.0
 */
@Controller("b2cMemberDeliveryCenterController")
@RequestMapping("/b2c/member/delivery_center")
public class DeliveryCenterController extends BaseController {
	...
	public String add(Model model) {
		...
		return "b2c/member/delivery_center/add";
	}
	...
	public String edit(Long id, Model model) {
		...
		return "b2c/member/delivery_center/edit";
	}
	...
	public String list(Model model, Pageable pageable) {
		...
		return "b2c/member/delivery_center/list";
	}
