 ...
 * @version 3.0
 */
@Controller("b2cMemberCashController")
@RequestMapping("/b2c/member/cash")
public class CashController extends BaseController {
	...
	public String submit(String bank, String bankname,String mobile, String payer, String account,Method method,BigDecimal amount, HttpServletRequest request, HttpServletResponse response, ModelMap model,RedirectAttributes redirectAttributes) {
		Member member = memberService.getCurrent();
		if (member == null) {
			return ERROR_VIEW;
		}
		...
		try {
			if (member.getBalance().compareTo(credit.getEffectiveAmount())<0) {
				...
				return "redirect:/b2c/member/cash/index.jhtml";
			}
...
//	}
	...
	public String index(ModelMap model,RedirectAttributes redirectAttributes,Pageable pageable) {
		...
		if(tenantRelations!=null&&tenantRelations.getContent().size()>0){
			...
			return "redirect:/b2c/member/supplier/index.jhtml";
		}
		...
		return "b2c/member/cash/withdraw_index";
	}
	
	@RequestMapping(value = "/notify", method = RequestMethod.GET)
	public String notify(ModelMap model) {
		
 		return "redirect:b2c/member/cash/notify";
	}
	/**
	 * 聚德惠商城用户的提现
	 */
	...
	public String infomation(ModelMap model) {
 		...
 		return "redirect:b2c/member/cash/infomation";
	}
	/**
	 * 供应商提现
	 * @param amount
