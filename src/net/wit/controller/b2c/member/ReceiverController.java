 ...
 * @version 3.0
 */
@Controller("b2cMemberReceiverController")
@RequestMapping("/b2c/member/receiver")
public class ReceiverController extends BaseController {
	...
	public String list(Integer pageNumber, ModelMap model) {
		...
		return "b2c/member/receiver/list";
	}
	...
	public String add(ModelMap model,RedirectAttributes redirectAttributes) {
		...
		return "b2c/member/receiver/add";
	}
	...
	public String edit(Long id, ModelMap model, RedirectAttributes redirectAttributes) {
		...
		return "b2c/member/receiver/edit";
	}
