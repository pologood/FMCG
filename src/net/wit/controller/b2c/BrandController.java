 ...
 * @version 3.0
 */
@Controller("b2cBrandController")
@RequestMapping("/b2c/brand")
public class BrandController extends BaseController {
	...
	public String brand(HttpServletRequest request, ModelMap model) {
		...
		model.addAttribute("dayProducts", productService.openList(10,areaService.getCurrent(),null,null,null,tagService.findList(new Long[]{2l}),null,null,null,null,null,null,filters,null,OrderType.weight));
		...
		return "b2c/brand/recommend_brand";
	}
