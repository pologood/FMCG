 ...
 */
public class DeliveryComparatorByDistance implements Comparator<DeliveryCenter> {

	private Location location;

	private OrderType orderType;

	public DeliveryComparatorByDistance() {
	}

	public DeliveryComparatorByDistance(OrderType orderType) {
	...
	@Override
	public int compare(DeliveryCenter o1, DeliveryCenter o2) {
		int comp = 0;
