 ...
 *
 */
@Repository("subsidiesItemDaoImpl")
public class SubsidiesItemDaoImpl extends BaseDaoImpl<SubsidiesItem, Long> implements SubsidiesItemDao {
...
//		CriteriaQuery<Account> criteriaQuery = criteriaBuilder.createQuery(Acco unt.class);
