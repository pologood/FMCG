...
public class Setting implements Serializable {
	...
	/** 热门商家搜索 */
	private String hotTenantSearch;
	...
	/** 货款结算时间点 */
	private ClearingTime clearingTime;
	...
	/** 充值提现手续费 */
	private BigDecimal paymentWithdrawCashScale;

	/** 提现上浮比例 */
	private BigDecimal withdrawCashAddScale;

	/** 默认年费 */
	private BigDecimal functionFee;

	/** 最低价格 */
	private BigDecimal minInvitePrice;

	/** 推广分润比例 */
	private BigDecimal sharePercent;
	/** 推广店主分润比例 */
	private BigDecimal shareOwnerPercent;
	/** 导购分润比例 */
	private BigDecimal guidePercent;
	/** 导购店主分润比例 */
	private BigDecimal guideOwnerPercent;
	/** 默认消费返现比例 */
	...
	/** 订单提醒时间间隔 */
	private Integer orderReminderTime;

	/** 红包过期提醒时间间隔 */
	private Integer bonusReminderTime;
	...
	public void setWebSite(String webSite) {
		this.webSite = StringUtils.removeEnd(webSite, "/");
	}
	...
	public ClearingTime getClearingTime() {
		return clearingTime;
	}

	public void setClearingTime(ClearingTime clearingTime) {
	 ...
	 * @return 热门搜索关键词
	 */
	public String[] getHotTenantSearches() {
		return StringUtils.split(hotTenantSearch, SEPARATOR);
	}
	...
	public BigDecimal getPaymentWithdrawCashScale() {
		return paymentWithdrawCashScale;
	}

	public void setPaymentWithdrawCashScale(BigDecimal paymentWithdrawCashScale) {
		this.paymentWithdrawCashScale = paymentWithdrawCashScale;
	}

	public BigDecimal getWithdrawCashAddScale() {
		return withdrawCashAddScale;
	}

	public void setWithdrawCashAddScale(BigDecimal withdrawCashAddScale) {
		this.withdrawCashAddScale = withdrawCashAddScale;
	}
	...
	public BigDecimal getFunctionFee() {
		return functionFee;
	}

	public void setFunctionFee(BigDecimal functionFee) {
		this.functionFee = functionFee;
	}

	public BigDecimal getMinInvitePrice() {
		return minInvitePrice;
	}

	public void setMinInvitePrice(BigDecimal minInvitePrice) {
		this.minInvitePrice = minInvitePrice;
	}
	...
	public BigDecimal getShareOwnerPercent() {
		return shareOwnerPercent;
	}

	public void setShareOwnerPercent(BigDecimal shareOwnerPercent) {
		this.shareOwnerPercent = shareOwnerPercent;
	}

	public BigDecimal getGuidePercent() {
		return guidePercent;
	}

	public void setGuidePercent(BigDecimal guidePercent) {
		this.guidePercent = guidePercent;
	}

	public BigDecimal getGuideOwnerPercent() {
		return guideOwnerPercent;
	}

	public void setGuideOwnerPercent(BigDecimal guideOwnerPercent) {
		this.guideOwnerPercent = guideOwnerPercent;
	}
	...
	public Integer getOrderReminderTime() {
		return orderReminderTime;
	}

	public void setOrderReminderTime(Integer orderReminderTime) {
		this.orderReminderTime = orderReminderTime;
	}

	public Integer getBonusReminderTime() {
		return bonusReminderTime;
	}

	public void setBonusReminderTime(Integer bonusReminderTime) {
		this.bonusReminderTime = bonusReminderTime;
	}

	/**
	 * @return the hotTenantSearch
	 */
	@Length(max = 200)
	public String getHotTenantSearch() {
		return hotTenantSearch;
	}

	/**
	 * @param hotTenantSearch the hotTenantSearch to set
	 */
	public void setHotTenantSearch(String hotTenantSearch) {
		if (hotTenantSearch != null) {
			hotTenantSearch = hotTenantSearch.replaceAll("[,\\s]*,[,\\s]*", ",").replaceAll("^,|,$", "");
		}
		this.hotTenantSearch = hotTenantSearch;
	}
