...
var messages = {
	"b2b.message.success": "操作成功",
	"b2b.message.error": "操作错误",
	"b2b.dialog.ok": "确&nbsp;&nbsp;定",
	"b2b.dialog.cancel": "取&nbsp;&nbsp;消",
	"b2b.dialog.deleteConfirm": "您确定要删除吗？",
	"b2b.dialog.clearConfirm": "您确定要清空吗？",
	"b2b.browser.title": "选择文件",
	"b2b.browser.upload": "本地上传",
	"b2b.browser.parent": "上级目录",
	"b2b.browser.orderType": "排序方式",
	"b2b.browser.name": "名称",
	"b2b.browser.size": "大小",
	"b2b.browser.type": "类型",
	"b2b.browser.select": "选择文件",
	"b2b.upload.sizeInvalid": "上传文件大小超出限制",
	"b2b.upload.typeInvalid": "上传文件格式不正确",
	"b2b.upload.invalid": "上传文件格式或大小不正确",
	"b2b.validate.required": "必填",
	"b2b.validate.email": "E-mail格式错误",
	"b2b.validate.url": "网址格式错误",
	"b2b.validate.date": "日期格式错误",
	"b2b.validate.dateISO": "日期格式错误",
	"b2b.validate.pointcard": "信用卡格式错误",
	"b2b.validate.number": "只允许输入数字",
	"b2b.validate.digits": "只允许输入零或正整数",
	"b2b.validate.minlength": "长度不允许小于{0}",
	"b2b.validate.maxlength": "长度不允许大于{0}",
	"b2b.validate.rangelength": "长度必须在{0}-{1}之间",
	"b2b.validate.min": "不允许小于{0}",
	"b2b.validate.max": "不允许大于{0}",
	"b2b.validate.range": "必须在{0}-{1}之间",
	"b2b.validate.accept": "输入后缀错误",
	"b2b.validate.equalTo": "两次输入不一致",
	"b2b.validate.remote": "输入错误",
	"b2b.validate.integer": "只允许输入整数",
	"b2b.validate.positive": "只允许输入正数",
	"b2b.validate.negative": "只允许输入负数",
	"b2b.validate.decimal": "数值超出了允许范围",
	"b2b.validate.pattern": "格式错误",
	"b2b.validate.extension": "文件格式错误"
};
 ...
 (function($) {
	...
	$.fn.extend({
		browser: function(options) {
			var settings = {
				type: "image",
				title: message("b2b.browser.title"),
				isUpload: true,
			...
			return this.each(function() {
				...
				$browserButton.click(function() {
					...
					if (settings.isUpload) {
						...
						$browserUploadButton = $('<a href="javascript:;" class="browserUploadButton button">' + message("b2b.browser.upload") + '<\/a>').appendTo($browserForm);
            ...
            tempImg.src = img.attr('src');  
					...
					$browserUploadInput.change(function() {
						...
						if ($.trim(allowedUploadExtensions) == "" || !new RegExp("^\\S.*\\.(" + allowedUploadExtensions.replace(/,/g, "|") + ")$", "i").test($browserUploadInput.val())) {
							$.message("warn", message("b2b.upload.typeInvalid"));
							return false;
						}
						$browserLoadingIcon.show();
						$browserForm.submit();
