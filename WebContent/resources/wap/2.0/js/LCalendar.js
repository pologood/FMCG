    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                dateCtrlInit();
                //soga begin
                var ele_date_ctrl = _self.gearDate.querySelector(".date_ctrl");
                ele_date_ctrl.addEventListener('click',stopPopUp);
                //soga end
            ...
            function popupYM(e) {
                ...
                _self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
                    '<div class="date_btn_box">' +
                    '<div class="date_btn lcalendar_cancel">取消</div>' +
                    '<div class="date_btn lcalendar_finish" id="ym">确定</div>' +
                    '</div>' +
                    '<div class="date_roll_mask">' +
                    '<div class="ym_roll">' +
                    '<div>' +
                ...
                lcalendar_cancel.addEventListener('touchstart', closeMobileCalendar);
                var lcalendar_finish = _self.gearDate.querySelector(".lcalendar_finish");
                // var a=document.getElementById("ym");
                // a.onclick=function(){
                //     finishMobileYM();
                // }
