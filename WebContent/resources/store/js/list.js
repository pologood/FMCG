...
$().ready( function() {
	...
	var $deleteButtonAll = $("#deleteButtonAll");
	...
	var $productCategoryTenant = $("#productCategoryTenant");

	//商品筛选
	var $filterSelect = $("#filterSelect");
	var $filterOption = $("#filterOption li a");
	var $product_category_tenant = $("#product_category_tenant li a");
	...
	// 筛选选项
	$product_category_tenant.click(function() {
		var $this = $(this);
	...
	$deleteButton.click( function() {
		...
		$.dialog({
			type: "warn",
			content: message("helper.dialog.deleteConfirm"),
	...
	$deleteButtonAll.click( function() {
		var $this = $(this);
		if ($this.hasClass("disabled")) {
			return false;
		}
	...
	$productCategoryTenant.mouseover( function() {
		var $this = $(this);
		var offset = $this.offset();
		var $menuWrap = $this.closest("div.menuWrap");
		var $popupMenu = $menuWrap.children("div.popupMenu");
