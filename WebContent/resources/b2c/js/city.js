...
var words = 'ABCDEFGHJKLMNPQRSTWXYZ';
    var hot = ['全国','北京','上海','广州','深圳','成都','西安','天津','武汉','重庆','南京','合肥'];
    var data = [
        ['鞍山','安庆','安阳','安康'],
    ...
    jQuery (function ($)
    {
        var search = $(':text#search_city_input_header');
        search.focus(function () 
        {
            $(this).val('');
        });
        
        var box = $('div#header_city_bar_box');
        var choose = $('a.common-bg.selector');
        var menu = $('div#hide_city_menu_11');
        ...
        var hotcity = $(hot);
        var city = $('div#header_city_hot');
        var currentCity = $('#city_current_city'), siteName = $('span#DY_site_name');
        ...
        chars.each (function (i, dom)
        {
            ...
            { 
                var h = 0;
                var index = $(this).index ('div#header_city_char a');
            ...
            {
                var a = $('<a href="javascript:void(0);">' + eleDom + '</a>');
                a.click (function ()
                {
                    var txt = $(this).text();
                    currentCity.text (txt);
