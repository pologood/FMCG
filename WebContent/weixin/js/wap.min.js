...
var base = location.origin == "http://localhost:8080" ? "http://192.168.0.13:8080/" : location.origin + "/";
...
;(function () {
    ...
    var rNum;
    var tNum;
    var SilderProductCategory = function (el, jsons, identNum, remNum, thNum) {
        this.data = jsons;
        this.el = el;
        iNum = identNum;
        rNum = remNum;
    ...
    SilderProductCategory.prototype = {
        show: function () {
            var list = [];
            var str = '';
            for (var i = 0; i < this.data.length; i++) {
    ...
    $.fn.SilderProductCategory = function (jsons, iNum, rNum, tNum) {
        var sg = new SilderProductCategory(document.getElementById(this.attr("id")), jsons, iNum, rNum, tNum);
        return sg.show();
    }
    ...
    SilderNewProduct.prototype = {
        show: function () {
            ...
            for(var j=0;j<rNum;j++){
                ...
                for (var i = 0; i < this.data.length; i++) {
                    str += '<div class="product_item1">' ;
                    str += '<a href="../product/product-details.html?id=' + this.data[i].id + '" data-id="' + this.data[i].id + '"> ';
                    str += '<img src="' + this.data[i].thumbnail+ '">'
                    str += '<span class="pro_price f10">' + this.data[i].name + '</span>'
                    str += '<p class="lg_buy f12">'+'立即购买'+'</p>';
                    ;
                    str += '</a></div>';
                }
                str += '</div>';
    ...
    categoryBrands = [
        {
            ...
            name: "家居用品",
            tag: "0",
            image: "http://cdn.jdhone.com/upload/image/201605/1cc24329-3acf-4d4e-aa10-81923921cc19.png",
            childrens: [{
                childrens: [
                    {
                        id: "322",
                        name: "虎牌",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/8fa4acd2-fcdf-4621-9efa-3bb838a72d28.jpg",
                        childrens: []
                    }
                    , {
                        id: "342",
                        name: "双立人",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/e9864cb5-5c2d-4934-ba6b-6e4a4318981d.jpg",
                        childrens: []
                    }
                    , {
                        id: "330",
                        name: "天堂",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/c74e2813-0cfd-4a56-9a33-626540cb2c81.jpg",
                        childrens: []
                    }
                    , {
                        id: "708",
                        name: "九阳",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/14ec346a-3ca4-4f44-9fdc-4647415305ef.jpg",
                        childrens: []
                    }
                    , {
                        id: "707",
                        name: "美的",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/eb055e47-a099-4000-965e-9bd8704dc13a.jpg",
                        childrens: []
                    }
                    , {
                        id: "336",
                        name: "罗莱家纺",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/e22a636e-c1f7-4e52-92fe-f0247a03a9a5.jpg",
                        childrens: []
                    }
                    , {
                        id: "312",
                        name: "爱得利",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/4573486a-416d-4cb1-80c3-8a94ad6262b9.jpg",
                        childrens: []
                    }
                ]
            }]
        ...
        , {
            ...
            name: "日化用品",
            tag: "0",
            image: "http://cdn.jdhone.com/upload/image/201605/3cb1b63a-e3f9-4a0f-b22d-22f47e8b8434.png",
            childrens: [{
                childrens: [
                    {
                        id: "366",
                        name: "舒蕾",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/9d89df35-05c8-40f5-981e-b8fa7ba00f78.jpg",
                        childrens: []
                    }
                    , {
                        id: "646",
                        name: "多芬",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/226779a3-842e-49b3-b61a-3b291fb1a5f0.jpg",
                        childrens: []
                    }
                    , {
                        id: "647",
                        name: "夏士莲",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/13bd66e9-a3af-44b4-a8fc-e4ff400b5e5e.jpg",
                        childrens: []
                    }
                    , {
                        id: "651",
                        name: "力士",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/e0d4c419-f7a8-491f-9bd2-d6df3d980c24.png",
                        childrens: []
                    }
                    , {
                        id: "658",
                        name: "奥妙",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/c8be875f-0349-426d-a64a-3fb5afe18913.jpg",
                        childrens: []
                    }
                    , {
                        id: "687",
                        name: "飘柔",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/6460fe06-d33a-42df-a434-3686cc841109.jpg",
                        childrens: []
                    }
                    , {
                        id: "739",
                        name: "中华牙膏",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/16afb2df-2e95-487e-b16e-2b5d7e3f2667.jpg",
                        childrens: []
                    }
                    , {
                        id: "830", name: "沙宣", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "831", name: "潘婷", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "832", name: "完美", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "833", name: "CoCo", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "834", name: "恒妃", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "1379", name: "卫宝", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "1385", name: "春娟", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "1388", name: "氧净", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "365",
                        name: "屈臣氏",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/da462482-377e-4b5f-966b-58bf9ed6dac1.jpg",
                        childrens: []
                    }
                    , {
                        id: "734",
                        name: "自然堂",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/77479d93-4bcd-402d-8c9b-a6dbce73bcc7.jpg",
                        childrens: []
                    }
                    , {
                        id: "362",
                        name: "佰草集",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/2fe735aa-b57e-4758-b6ed-52a9dd356aea.jpg",
                        childrens: []
                    }
                    , {
                        id: "367",
                        name: "相宜本草",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/ab6765a2-f806-42c3-8ad0-5735a35191b4.jpg",
                        childrens: []
                    }
                    , {
                        id: "829",
                        name: "清扬",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/9792ed6c-afb5-4f98-a0d8-e61ec56f05f6.jpg",
                        childrens: []
                    }
                    , {
                        id: "1384",
                        name: "金纺",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/c6c97c3f-3567-4439-a000-afa76392a950.jpg",
                        childrens: []
                    }
                ]
            }]
        ...
        , {
            ...
            name: "酒水饮料",
            tag: "0",
            image: "http://cdn.jdhone.com/upload/image/201605/25cdb1ad-2218-48ce-9fd4-b457f5503db2.png",
            childrens: [{
                childrens: [
                    {
                        id: "266",
                        name: "汾酒",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/08118e70-48b2-4355-8457-878ddfe7e32c.jpg",
                        childrens: []
                    }
                    , {
                        id: "272",
                        name: "金六福",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/cb54685d-896e-4d06-b859-a9312c40da64.jpg",
                        childrens: []
                    }
                    , {
                        id: "273",
                        name: "金种子",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/8f286486-1837-41ea-878e-ac7f0193d718.jpg",
                        childrens: []
                    }
                    , {
                        id: "279",
                        name: "泸州老窖",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/62e35b4b-ec18-4760-9842-a195e0878c70.jpg",
                        childrens: []
                    }
                    , {
                        id: "285",
                        name: "五粮液",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/ba048873-e335-4a38-acaa-45bdc9a07071.jpg",
                        childrens: []
                    }
                    , {
                        id: "296",
                        name: "哈尔滨啤酒",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/df36a62f-1e8b-4ec9-beb9-68a59d9e9880.jpg",
                        childrens: []
                    }
                    , {
                        id: "395",
                        name: "可口可乐",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/39cb315d-75c9-4a85-adf8-e9d61e01b09d.png",
                        childrens: []
                    }
                    , {
                        id: "397",
                        name: "百事可乐",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/8aa4a434-dd2a-4d62-9931-7d3444a77a64.jpg",
                        childrens: []
                    }
                    , {
                        id: "742",
                        name: "长城葡萄酒",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/34bec98b-d8c1-441a-92d7-6c69b83ef931.jpg",
                        childrens: []
                    }
                    , {
                        id: "1381", name: "中粮长城", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "1",
                        name: "娃哈哈",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/2ee8cfd2-2ac9-4a1e-bfe2-f11aef3c5366.jpg",
                        childrens: []
                    }
                    , {
                        id: "2",
                        name: "农夫山泉",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/ca885a74-a178-4eba-9e8b-3a6c77ec0999.jpg",
                        childrens: []
                    }
                    , {
                        id: "4",
                        name: "剑南春",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/a868d5fd-67dc-4df7-b78c-4e05ad0a4271.jpg",
                        childrens: []
                    }
                    , {
                        id: "294",
                        name: "百威",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/17fef730-b7ee-4eee-be05-5d138a9f3bb7.jpg",
                        childrens: []
                    }
                    , {
                        id: "417",
                        name: "统一",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/4ad0b207-e5ba-4d5d-9f15-c3248f0c2ade.jpg",
                        childrens: []
                    }
                    , {
                        id: "393",
                        name: "康师傅",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/73dcf7ba-c185-4606-89b4-03d02039ec35.jpg",
                        childrens: []
                    }
                    , {
                        id: "384",
                        name: "伊利",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/0cf2f3aa-5703-412f-ac26-e4978a2a7bea.jpg",
                        childrens: []
                    }
                ]
            }]
        ...
        , {
            ...
            name: "休闲食品",
            tag: "0",
            image: "http://cdn.jdhone.com/upload/image/201605/cb74612c-5da8-40a0-9af9-d6a23f48e02c.png",
            childrens: [{
                childrens: [
                    {
                        id: "421",
                        name: "旺旺",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/a54ba72d-0c10-42b2-85f7-b766cab7b885.jpg",
                        childrens: []
                    }
                    , {
                        id: "442",
                        name: "上好佳",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/c18ae291-60a7-40c9-a413-dfedbb875c8d.jpg",
                        childrens: []
                    }
                    , {
                        id: "453",
                        name: "稻香村",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/08db0b36-86e1-48d1-87a8-df8f84113315.jpg",
                        childrens: []
                    }
                    , {
                        id: "477",
                        name: "良品铺子",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/fa747eea-0447-41c8-befa-e00c4879ec7e.jpg",
                        childrens: []
                    }
                    , {
                        id: "715",
                        name: "大白兔",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/9577038c-77ef-4248-a0d2-3176b9b541d7.jpg",
                        childrens: []
                    }
                    , {
                        id: "720",
                        name: "亿滋",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/b8a21109-978b-40f0-a1f5-0affefdf2c52.jpg",
                        childrens: []
                    }
                    , {
                        id: "800",
                        name: "波力",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/517a789d-cbe9-4bb5-8156-66f6673b4123.jpg",
                        childrens: []
                    }
                    , {
                        id: "922", name: "真巧", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "1321", name: "不二家", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "1324", name: "BE＆CHEERY/百草味", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "1336", name: "咪咪", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "1337", name: "友臣", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "5",
                        name: "盼盼",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/4d9ea51c-8d3b-4677-8eed-c3e13b24c147.jpg",
                        childrens: []
                    }
                    , {
                        id: "411",
                        name: "今麦郎",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/2a1d321f-b828-40a4-afe6-56118227658d.jpg",
                        childrens: []
                    }
                    , {
                        id: "449",
                        name: "白象",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/1868b347-567f-4781-82f3-4594f4c410ff.jpg",
                        childrens: []
                    }
                    , {
                        id: "470",
                        name: "金锣",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/e481eb95-c9ba-424d-bd08-29153dfaa515.jpg",
                        childrens: []
                    }
                    , {
                        id: "393",
                    ...
                    , {
                        ...
                        name: "乐事",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/6acd2cf8-9070-4efc-b388-d41c899c3c0d.png",
                        childrens: []
                    }
                    , {
                        id: "444",
                        name: "好丽友",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/0416aaad-a3d8-4c26-818f-b58410f7e4f2.jpg",
                        childrens: []
                    }
                ]
            }]
        ...
        , {
            ...
            name: "粮油干货",
            tag: "0",
            image: "http://cdn.jdhone.com/upload/image/201605/072a60a0-8c8c-49e2-91c2-a40eed44d0bf.png",
            childrens: [{
                childrens: [
                    {
                        id: "597",
                        name: "中粮",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/ee3cc246-5746-4b7e-9ba6-0d1cf889c134.jpg",
                        childrens: []
                    }
                    , {
                        id: "556",
                        name: "福临门",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/0de0705c-d8a6-45ed-a89d-e96a7cca0052.jpg",
                        childrens: []
                    }
                    , {
                        id: "486",
                        name: "农心",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/09b2877e-ca7b-4e0b-bf2c-9545fde227e4.jpg",
                        childrens: []
                    }
                    , {
                        id: "573",
                        name: "金龙鱼",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/afa58c58-7a1d-4f15-8de3-0cb62ee853ac.jpg",
                        childrens: []
                    }
                    , {
                        id: "265",
                        name: "稻花香",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/14d236a4-0008-4567-bda7-8bcd2ad409ed.jpg",
                        childrens: []
                    }
                    , {
                        id: "555",
                        name: "方家铺子",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/b1072856-d58b-4b85-b1ca-5aabc31005d3.jpg",
                        childrens: []
                    }
                    , {
                        id: "572",
                        name: "金健",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/7c7d1f8f-f261-41b3-b8c3-749765d83022.jpg",
                        childrens: []
                    }
                ]
            }]
        ...
        , {
            ...
            name: "生鲜食品",
            tag: "0",
            image: "http://cdn.jdhone.com/upload/image/201605/2cdaa493-580e-44b9-9c52-c43144df698f.png",
            childrens: [{
                childrens: [
                    {
                        id: "6",
                        name: "双汇",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/1928911c-4234-4362-9a4d-f6d71005dab0.jpg",
                        childrens: []
                    }
                    , {
                        id: "470",
                    ...
                    , {
                        ...
                        name: "雨润",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/991bb444-ed28-4136-94bb-e2aa8c7275f9.jpg",
                        childrens: []
                    }
                    , {
                        id: "454",
                        name: "得利斯",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/ef7a17ac-1006-4e4d-90fd-8a34a87094e2.jpg",
                        childrens: []
                    }
                    , {
                        id: "786",
                        name: "三全",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/bc785163-024b-4aba-adef-64bfdab23082.jpg",
                        childrens: []
                    }
                ]
            }]
        ...
        , {
            ...
            name: "调味酱料",
            tag: "0",
            image: "http://cdn.jdhone.com/upload/image/201605/ca66da13-8fc5-4cc9-a9bf-88a519ae96d9.png",
            childrens: [{
                childrens: [
                    {
                        id: "534",
                        name: "加加",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/c2561ecf-78db-43ca-b2f7-02fb89906e7c.jpg",
                        childrens: []
                    }
                    , {
                        id: "1373", name: "自家厨房", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "1372",
                        name: "致美斋",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/d8d26af9-0bc2-43aa-b8c7-3c6b9979a388.jpg",
                        childrens: []
                    }
                    , {
                        id: "797",
                        name: "李锦记",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/fc97b985-9759-4e2d-bcff-ae3a8c1893a4.jpg",
                        childrens: []
                    }
                    , {
                        id: "1371",
                        name: "好餐得",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/eba5f6c2-8db5-4d36-a914-0f30a4f12b9f.jpg",
                        childrens: []
                    }
                    , {
                        id: "529",
                        name: "海天",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/ef6fafa4-a893-4f27-9240-a2b0b5b58573.jpg",
                        childrens: []
                    }
                ]
            }]
        ...
        , {
            ...
            name: "母婴用品",
            tag: "0",
            image: "http://cdn.jdhone.com/upload/image/201605/8318a3c6-595a-4444-b525-5941a72e0270.png",
            childrens: [{
                childrens: [
                    {
                        id: "1365", name: "邦可士", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "1380", name: "唯尔福", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "312",
                        name: "爱得利",
                    ...
                    , {
                        ...
                        name: "彩婴房",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/65ee9de5-17b3-481f-9ae7-40e16b165890.jpg",
                        childrens: []
                    }
                    , {
                        id: "1364",
                        name: "安琪娃",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/019ed8de-2376-4721-8501-182b90d72e81.jpg",
                        childrens: []
                    }
                    , {
                        id: "1363",
                        name: "贝适邦",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201605/42d39d0f-4645-4120-8170-cb68f093950b.jpg",
                        childrens: []
                    }
                ]
            }]
        ...
        , {
            ...
            name: "户外文具",
            tag: "0",
            image: "http://cdn.jdhone.com/upload/image/201605/9c9f712a-2043-4931-a414-50a912444dcf.png",
            childrens: [{
                childrens: [
                    {
                        id: "861", name: "得力", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "1367", name: "三年二班", tag: "0", image: "", childrens: []
                    }
                ]
            }]
        }
        , {
            ...
            name: "进口食品",
            tag: "0",
            image: "http://cdn.jdhone.com/upload/image/201605/7fa1199b-543b-4195-a762-16871679dfe2.png",
            childrens: [{
                childrens: []
            }]
        }
        , {
            ...
            name: "其他用品",
            tag: "0",
            image: "http://cdn.jdhone.com/upload/image/201605/1b94546b-45f1-4f6e-9338-dd8b8fac1a4a.png",
            childrens: [{
                childrens: [
                    {
                        id: "347",
                        name: "榄菊",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/ba6bf667-c3cd-4344-95de-98d3bf69a90e.jpg",
                        childrens: []
                    }
                    , {
                        id: "670",
                        name: "超威",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/8ab38920-772b-417d-a3ca-2b402839f8fa.jpg",
                        childrens: []
                    }
                    , {
                        id: "710",
                        name: "南孚",
                        tag: "0",
                        image: "http://cdn.jdhone.com/upload/image/201604/3f027038-5468-4fd0-8aef-afd71982b39d.jpg",
                        childrens: []
                    }
                    , {
                        id: "819", name: "松下", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "998", name: "三星", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "1000", name: "华太电池", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "1374", name: "索尼", tag: "0", image: "", childrens: []
                    }
                    , {
                        id: "1376", name: "全无敌", tag: "0", image: "", childrens: []
                    }
                ]
            }]
        }
