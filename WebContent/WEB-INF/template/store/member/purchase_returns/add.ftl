	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>采购管理<small>完善我的采购管理</small>	</h1>
				<ol class="breadcrumb">
					...
					<div class="col-md-12">
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs pull-right">
								<li class="pull-left header"><i class="fa fa-file-text-o"></i>采购管理</li>
							</ul>
		...
		$().ready(function () {
			...
			$("select[name='supplierId']").change(function () {
				...
				if(supplierId==""){
					...
					$("#iframe_id").attr("src","${base}/store/member/purchase/returns/supplier.jhtml?id="+supplierId);
			...
			$("#confirm").click(function(){
				...
				$.ajax({
					url: "${base}/helper/member/purchase/returns/save.jhtml",
					data: {
						sn:sn,
