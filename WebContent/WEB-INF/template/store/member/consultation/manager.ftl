...
<div class="page-nav page-nav-app vip-guide-nav" id="app_head_nav">
    <div class="js-app-header title-wrap" id="app_0000000844">
        <img class="js-app_logo app-img" src="${base}/resources/store/images/message-manage3.png"/>
        <dl class="app-info">
    ...
    <div class="list" style="border-top: 0;">
        ...
        [#list page.content as consultation]
            <tr>
                ...
                <td>
                    <a href="${base}/store/product/content/${consultation.product.id}.jhtml" title="${consultation.product.name}" target="_blank">${abbreviate(consultation.product.name, 50, "...")}</a>
                </td>
                <td>
