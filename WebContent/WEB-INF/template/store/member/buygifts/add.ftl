...
<div class="page-nav page-nav-app vip-guide-nav" id="app_head_nav">
    ...
    <ul class="links" id="mod_menus">
        <li><a class="on" hideFocus="" href="${base}/store/member/buygifts/add.jhtml?type=seckill">所有商品</a></li>
        <li><a hideFocus="" href="${base}/store/member/buygifts/list.jhtml?type=seckill">商品分类</a></li>
    </ul>
