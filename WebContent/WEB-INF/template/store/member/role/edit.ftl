					...
					<div class="col-md-12">
						<div class="nav-tabs-custom">
							...
							<div class="tab-content">
								<form class="form-horizontal" role="form" id="inputForm" action="${base}/store/member/role/update.jhtml" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" name="name" value="[#if role??]${role.name}[/#if]" [#if role.isSystem]readonly[/#if]>
										</div>
									</div>
									<div class="form-group">
											...
											<div role="tabpanel" class="tab-pane [#if rules_index=0]active[/#if]" id="${rules_index}">
												<div class="box-header">
													<h3 class="box-title">
														...
														[#list types as type]
														[#if operation==type]
														<input type="checkbox" id="${operation}RulesIds${rules.id}" name="${operation}RulesIds" level='1' value="${rules.id}"
																...
																<td>
																	...
																	<div class="form-group checkbox-list">
																		...
																		<div class="checkbox" style="margin-top: -10px;">
																			<label>
																			<input type="checkbox" name="${operation}RulesIds" level='2' value="${crules.id}"
