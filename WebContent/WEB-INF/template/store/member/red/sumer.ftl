                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs pull-right">
                        <li class="[#if type ='used']active[/#if]">
                            <a href="${base}/store/member/red/sumer.jhtml?id=${id}&type=used&status=${status}">使用详情</a>
                        </li>
                        <li class="[#if type=="send"]active[/#if]">
                            <a href="${base}/store/member/red/sumer.jhtml?id=${id}&type=send&status=${status}">领用详情</a>
                        </li>
                        <li class="pull-left header"><i class="fa fa-money" ></i>红包</li>
                    </ul>
