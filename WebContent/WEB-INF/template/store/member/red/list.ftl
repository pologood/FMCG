                    ...
                    <div class="nav-tabs-custom" style="box-shadow: none;margin-bottom: 0;">
                        <ul class="nav nav-tabs pull-right">
                            <li class="[#if processStatus=='Expired']active[/#if]">
                                <a href="${base}/store/member/red/list.jhtml?type=tenantBonus&processStatus=Expired">已过期</a>
                            </li>
                            <li class="[#if processStatus=='unUsed']active[/#if]">
                                <a href="${base}/store/member/red/list.jhtml?type=tenantBonus&processStatus=unUsed">已领完</a>
                            </li>
                            <li class="[#if processStatus=='unBegin']active[/#if]">
                                <a href="${base}/store/member/red/list.jhtml?type=tenantBonus&processStatus=unBegin">未开始</a>
                            </li>
                            <li class="[#if processStatus=='canUse']active[/#if]">
                                <a href="${base}/store/member/red/list.jhtml?type=tenantBonus&processStatus=canUse">可领用</a>
                            </li>
                            <li class="pull-left header"><i class="fa fa-th"></i>红包</li>
                        </ul>
                    </div>
                    <div class="row mtb10">
                        <div class="col-sm-3">
                            <div class="btn-group">
                            [#--[@helperRole url="store/member/coupon/list.jhtml" type="add"]--]
                            ...
                            [#--[/@helperRole]--]
                                ...
                                <div class="dropdown fl ml5">
                                    <button class="btn btn-default btn-sm dropdown-toggle" type="button"
                                            id="typeSelect"
                                            data-toggle="dropdown">类型<span class="caret"></span></button>
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" id="type">
                                    [#list statusValues as statusValue]
                                        <li>
                                            <a href="list.jhtml?type=${type}&status=${statusValue}"
                                               class="[#if statusValue==status]active[/#if]">${message("Coupon.Status."+statusValue)}</a>
                                        </li>
                                    [/#list]
                                    </ul>
                                </div>
                    ...
                    <div class="box-body">
                        ...
                        [#list page.content as coupon]
                            <tr>
                                ...
                                <td>
                                    [@helperRole url="store/member/red/list.jhtml" type="statistics"]
                                        [#if helperRole.retOper!="0"]
                                            <a href="sumer.jhtml?id=${coupon.id}&type=send&status=${status}">统计</a>
                                        [/#if]
                                    [/@helperRole]

                                    [@helperRole url="store/member/red/list.jhtml" type="share"]
                                        [#if helperRole.retOper!="0"]
