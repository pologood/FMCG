...
[/@seo]
    ...
    <link href="${base}/resources/store/css/tenant.css" type="text/css" rel="stylesheet">
    ...
    <script type="text/javascript" src="${base}/resources/store/js/search.js"></script>
        ...
        <div class="wrapper" id="wrapper">
            ...
            <div class="page-nav page-nav-app vip-guide-nav" id="app_head_nav">
                ...
                <ul class="links" id="mod_menus">
                    <li><a class="" hideFocus="" href="${base}/store/member/tenant/edit.jhtml?type=0">基本信息</a></li>
                    <li><a class="" hideFocus="" href="${base}/store/member/ad/list.jhtml">店铺装修</a></li>
                    <li><a class="" hideFocus="" href="${base}/store/member/article/list.jhtml">店铺公告</a></li>
                    [#--<li><a class="on" hideFocus="" href="${base}/store/member/authen/index.jhtml">店铺认证</a></li>--]
                </ul>
            ...
            <div class="box_con_right">
                <div id="authenIndex" class="authen_div">
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="0">
                        ...
                        [#--<tr>--]
                            [#--<td>企业认证</td>--]
                            [#--<td class="txt_td">上传您企业真实的营业执照副本的照片，并等待后台的审核通过。<b>企业认证</b>是${setting.sitestore}平台上开店的必要环节，方便买家关注您以及提高您店铺的信任感！--]
                            [#--</td>--]
                ...
                <div id="enterpriseCertification" class="authen_busi_div" class="authen_busi_div">
                    ...
                    <form id="enterpriseAutForm" action="${base}/store/member/authen/enterpriseCertification.jhtml"
                          method="post">
                ...
                <div id="certifiedStores" class="authen_busi_div" class="authen_busi_div">
                    ...
                    <form id="storesAutForm" action="${base}/store/member/authen/certifiedStores.jhtml" method="post">
                        <input type="hidden" name="id" value="${(tenant.id)!}">
                ...
                <div id="manufacturersCertification" class="authen_busi_div" class="authen_busi_div">
                    ...
                    <form id="manufacturersAutForm"
                          action="${base}/store/member/authen/manufacturersCertification.jhtml" method="post">
                        <input type="hidden" name="id" value="${(tenant.id)!}">
