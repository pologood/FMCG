        ...
        <div class="wrapper" id="wrapper">
            ...
            <div class="page-nav page-nav-app vip-guide-nav" id="app_head_nav">
                <div class="js-app-header title-wrap" id="app_0000000844">
                    <img class="js-app_logo app-img" src="${base}/resources/store/images/discount.png"/>
                    <dl class="app-info">
                ...
                <ul class="links" id="mod_menus">
                    <li><a class="on" hideFocus="" href="${base}/store/member/relation/settle_account.jhtml">往来结算</a></li>
                </ul>
            ...
            <form id="listForm" action="settle_account.jhtml" method="get">
                ...
                <div class="bar">
                    <div class="buttonWrap">
                        <!-- <a href="${base}/store/member/discount/listproduct.jhtml" class="iconButton">
                            <span class="addIcon">&nbsp;</span>${message("admin.common.add")}
                        </a>
                        <a href="javascript:;" id="deleteButton" class="iconButton disabled">
                            <span class="deleteIcon">&nbsp;</span>${message("admin.common.delete")}
                        </a> -->
                        <a href="${base}/store/member/relation/settle_account.jhtml" class="iconButton">
