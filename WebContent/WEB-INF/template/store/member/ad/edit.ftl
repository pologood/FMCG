        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <form class="form-horizontal" id="inputForm" role="form" action="update.jhtml" method="post" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" name="path" value="${ad.path}">
                  </div>
                  <div class="col-sm-2">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content" style="border-radius: 5px;">
                          ...
                          <div class="modal-body" style="text-align: center;">
                            <img src="${ad.path}" alt="" width="400" height="400"/>
                          </div>                                  
                        </div>
                      </div>
                    </div>
                ...
                <div class="form-group">
                  ...
                  <!-- <div class="col-sm-2"> -->
                    <input type="text" class="form-control"  name="url" id="productUrl" value="${ad.url}" style="display:none;">
                  <!-- </div> -->
                  <div class="col-sm-8">
                    <select class="form-control" name="linkId" onchange="get_product_id(this)">
                      ...
                      [#if products??]
                          [#list products as product]
                              <option value='${product.id}' title="${product.name}" [#if ad.linkId==product.id] selected[/#if]>
                                ${product.name}
                              </option>
                          [/#list]
                      [/#if]
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control"  name="order" value="${ad.order}">
                  </div>
                </div>
                <div class="form-group">
