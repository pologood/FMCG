    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="${base}/store/member/statistics/return_total.jhtml">数据统计</a></li>
          ...
          <div class="col-md-12">
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs pull-right">
                <li><a href="${base}/store/member/statistics/return_product_total.jhtml">退货产品统计</a></li>
                <li  class="active"><a href="${base}/store/member/statistics/return_total.jhtml">退货统计</a></li>
                <li class="pull-left header"><i class="fa fa-pie-chart"></i>退货统计</li>
              </ul>
                    ...
                    <div class="col-sm-5">
                      <div class="box-tools fr">
                        <div class="input-group input-group-sm" style="width: 150px;">
                          <input type="text"id="keyword" name="keywords" value="${keywords}" maxlength="200" class="form-control pull-right" placeholder="订单/退货号">
                      ...
                      <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>${(returns.completedDate)!}</td>
                            <td>
                              <a href="${base}/store/member/trade/view.jhtml?id=${returns.trade.id}">
                                ${(returns.trade.order.sn)!}
                              </a>
                            </td>
                            <td>
                              <a href="${base}/store/member/trade/return/view.jhtml?spReturnsId=${returns.id}">
                                ${(returns.sn)!}
                              </a>
                            </td>
                            ...
                            <td>${(returns.shippedQuantity)!}</td>
                            <td>${(returns.returnQuantity)!}</td>
  ...
  <script type="text/javascript">
    $().ready(function () {
      ...
      $("#export_ss").click(function(){
        ...
        $.ajax({
          url:"${base}/store/member/statistics/return_total_export.jhtml",
          type:"get",
          data:{
