  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>数据统计<small>查询店内产品统计</small>	</h1>
        <ol class="breadcrumb">
          <li><a href="${base}/store/member/index.jhtml"><i class="fa fa-tv"></i>首页</a></li>
          <li><a href="${base}/store/member/statistics/product_total.jhtml">数据统计</a></li>
          <li class="active">产品统计</li>
        </ol>
      </section>
      <!-- Main content -->
          ...
          <div class="col-md-12">
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs pull-right">
                <li class="active"><a href="${base}/store/member/statistics/product_total.jhtml">产品统计</a></li>
                <li><a href="${base}/store/member/statistics/sale_total.jhtml">订单统计</a></li>
                <li class="pull-left header"><i class="fa fa-pie-chart"></i>产品统计</li>
              </ul>
                    ...
                    <div class="col-sm-4">
                      <div class="box-tools fr">
                        <div class="input-group input-group-sm" style="width: 150px;">
                          <input type="text" id="keyword" name="keywords" value="${keywords}" maxlength="200" class="form-control pull-right" placeholder="商品名称/单号">
                      ...
                      <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td title="${(orderItem.name)!}">${abbreviate(orderItem.name, 10, "...")}</td>
                            <td>[#if orderItem.barcode??]${(orderItem.barcode)!}[#else]--[/#if]</td>
                            <td>${(orderItem.sn)!}</td>
                            <td>[#if orderItem.supplier??]${abbreviate(orderItem.supplier,10,"...")}[#else]--[/#if]
                            </td>
                            <td>[#if orderItem.isGift=="true"]是[#else]否[/#if]</td>
                            ...
                            <td>${(orderItem.totalPrice-orderItem.totalCost)!}</td>
                            <td>
  ...
  <script type="text/javascript">
    $().ready(function () {
      ...
      $("#export_ss").click(function(){
        ...
        $.ajax({
          url:"${base}/store/member/statistics/product_total_export.jhtml",
          type:"get",
          data:{
