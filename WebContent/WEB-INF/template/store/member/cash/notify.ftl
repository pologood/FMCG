...
<head>
    ...
    <link href="${base}/resources/store/css/credit.css" rel="stylesheet" type="text/css"/>
...
<div class="page-nav page-nav-app vip-guide-nav" id="app_head_nav">
    <div class="js-app-header title-wrap" id="app_0000000844">
        <img class="js-app_logo app-img" src="${base}/resources/store/images/app_cash.png"/>
        <dl class="app-info">
    ...
    <ul class="links" id="mod_menus">
        <li><a class="on" hideFocus="" href="${base}/store/member/cash/index.jhtml">银行汇款</a></li>
    </ul>
</div>
<div class="title">
...
<a href="${base}/store/member/cash/index.jhtml"><span id="jumpTo">10</span>秒后系统会自动跳转</a>
<script type="text/javascript">
    countDown(10, '${base}/store/member/cash/index.jhtml');
</script>
<table class="info">
[#if status.type != "error"]
    <tr>
...
<div class="bottom">
    <a href="${base}/store/member/cash/index.jhtml">继续汇款</a>
</div>
</body>
</html>
