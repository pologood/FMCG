                ...
                <div class="col-md-12">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs pull-right">
                            <li class="pull-left header"><i class="fa fa-th"></i>申请入驻</li>
                        </ul>
                                    ...
                                    <div class="box-body">
                                        <table id="listTable" class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="btn btn-info" type="button" value="查看店铺" onclick="location.href='equipment_tenant_list.jhtml?unionId=${union.id}'" ></td>
                                            </tr>
                                            [/#list]
                                            </tbody>
                                        </table>
