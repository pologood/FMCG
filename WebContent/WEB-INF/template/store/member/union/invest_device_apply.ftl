                ...
                <div class="col-md-12">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs pull-right">
                            <li class=""><a href="${base}/store/member/union/my_device_apply.jhtml">投放我的</a></li>
                            <li class="active"><a href="${base}/store/member/union/invest_device_apply.jhtml">我投放的</a></li>
                            <li class="pull-left header"><i class="fa fa-th"></i>我投放的申请</li>
                        </ul>
                        <div class="tab-content" style="padding:15px 0 0 0;">
                            <form class="form-horizontal" id="listForm" action="invest_device_apply.jhtml" method="get"
                                  role="form">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    [#if status=="unconfirmed"]
                                                        <input class="btn btn-info" type="button" value="待同意" >
                                                        <input class="btn btn-info" type="button" value="撤销" onclick="cancelApply(${tenant.id})" >
                                                        [#elseif status=="freezed"]
                                                            <input class="btn btn-info" type="button" value="已被拒" " >
...
<script type="text/javascript">
    ...
    function cancelApply(uTenantId){
        $.ajax({
            url: '${base}/store/member/union/cancel_apply.jhtml',
            data:{
                uTenantId:uTenantId
            },
            type:'post',
