                ...
                <div class="col-md-12">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs pull-right">
                            <li class="active"><a href="${base}/store/member/union/all_union.jhtml">投放我的</a></li>
                            <li class=""><a href="${base}/store/member/union/my_union.jhtml">我投放的</a></li>
                            <li class="pull-left header"><i class="fa fa-th"></i>申请记录</li>
                        </ul>
                                ...
                                <div class="box" style="border-top:0px;">
                                    <div class="box-body">
                                        <table id="listTable" class="table table-bordered table-hover">
                                            ...
                                            [#--<tr>--]
                                                [#--<td>${union.tenant.name}</td>--]
                                                [#--<td>${union.union.name}</td>--]
                                                [#--<td>${union.union.brokerage}</td>--]
                                                [#--<td>${union.volume}</td>--]
                                                [#--<td>${union.pay}</td>--]
                                            [#--</tr>--]
                                            [#--[/#list]--]
