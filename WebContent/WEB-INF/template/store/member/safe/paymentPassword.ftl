                    ...
                    <div class="col-md-12">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs pull-right">                                    
                                <li class="pull-left header"><i class="fa fa-users"></i>修改支付密码</li>
                            </ul>
                                ...
                                <div class="account-table1" id="account-table1">
                                    <form class="form-horizontal" id="inputForm" action="password.jhtml" method="post" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" id="phone_captcha" class="form-control">
                                            </div>
                                            <div class="col-sm-2">
                ...
                if(message.type=="success"){
                    $.ajax({
                      ...
                      success: function (data) {
                        ...
                        $.ajax({
                          url: "${base}/store/member/safe/reset_payment_password.jhtml",
                          type: "POST",
                          data: {
