                    ...
                    success: function (data) {
                        if (data.message.type == "success") {
                            ...
                            $.each(data.data, function (i, products) {
                                $.each(products, function (index, product) {
                                    if (index == 0) {
                                        arr.push('<tr><td><input type="checkbox" value="' + product.id + '" name="ids" />' + product.fullName + '</td><td><input name="upMarketStock_' + product.id + '" /></td></tr>');
                                    } else {
                                        arr.push('<tr><td style="padding-left: 25px;"><input type="checkbox" value="' + product.id + '" name="ids" />' + product.fullName + '</td><td><input name="upMarketStock_' + product.id + '" /></td></tr>');
                                    }
                                });
                            });
                ...
                <div class="nav-tabs-custom">
                    ...
                    <form id="listForm" action="isMarketableList.jhtml" method="get">
                        ...
                        <div class="row mtb10">
                            <div class="col-sm-7">
                                <div class="btn-group">
                                    <button type="button" id="downMarketButton" class="btn btn-default btn-sm"><i
                                            class="fa fa-close mr5"
                                            aria-hidden="true"></i>下架
                                    </button>
                                    <button type="button" id="deleteButtonProduct" class="btn btn-default btn-sm"><i
                                            class="fa fa-close mr5"
                                    ...
                                    <button type="button" id="multiUpMarketButton" class="btn btn-default btn-sm">批量下架</button>
                            ...
                            <div class="col-sm-5">
                                <div class="box-tools fr">
                                    <div class="input-group input-group-sm" style="width: 150px;">
                                        <input type="text" id="" name="searchValue" value="${page.searchValue}" class="form-control pull-right"
                                               placeholder="名称/编号/条码">
                ...
                <div class="box-body">
                    <table id="listTable" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                [@helperRole url="store/member/product/isMarketableList.jhtml" type="downMarket"]
                                ...
                                [@helperRole url="store/member/product/isMarketableList.jhtml" type="update"]
                                    [#if helperRole.retOper!="0"]
                                        <a href="${base}/store/member/product/edit.jhtml?id=${product.id}">[${message("shop.common.edit")}]</a>
                                    [/#if]
                                [/@helperRole]
                                [@helperRole url="store/member/product/isMarketableList.jhtml" type="read"]
                                    [#if helperRole.retOper!="0"]
                                        <a target="_blank"
