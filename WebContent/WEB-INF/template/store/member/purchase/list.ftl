					...
					<div class="col-md-12">
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs pull-right">
								<li class="pull-left header"><i class="fa fa-shopping-cart"></i>我的采购单</li>
							</ul>
							<div class="tab-content" style="padding:15px 0 0 0;">
								<form id="listForm" action="list.jhtml" method="get">
									<div class="row mtb10">
										<div class="col-sm-5">
											<div class="btn-group">
												<button type="button" class="btn btn-primary btn-sm" onclick="add_purchase()">
											...
											<table id="listTable" class="table table-bordered table-striped">
												...
												<tbody>
													...
													<tr>
														...
														<td title="${purchase.purchaseDate?string("yyyy-MM-dd HH:mm:ss")}">${purchase.purchaseDate?string("yyyy-MM-dd HH:mm:ss")}</td>
														<td>
															[#if purchase.type=='applied']
															<a href="${base}/store/member/purchase/edit/${purchase.id}.jhtml?type=${purchase.type}"
															style="color: red;">[审核]</a>
															[#else]
															<a href="${base}/store/member/purchase/edit/${purchase.id}.jhtml?type=${purchase.type}">[查看]</a>
															[/#if]
														</td>
													</tr>
													[/#list]
