...
$().ready(function() {
	...
	$getCode.on('click',function(e){
		...
		//获取手机验证码
		$.ajax({
			url :"${base}/store/password/send.jhtml",
	...
	$confirm.on('click',function(){
		...
		$.ajax({
			url:"${base}/store/password/check.jhtml",
			data:{username:$username.val(),securityCode:$checkCode.val()},
			dataType:'json',
			type:'POST',
			success:function(data){
				if(data.type=='success'){
					location.href="${base}/store/password/reset.jhtml?username="+$username.val()+"&securityCode="+$checkCode.val();
					return false;
				}else{
					$.message(data);
				}
...
<body class="pc-bg">
    <div class="am-g header-bg">
        <div class="am-container am-center">
            <div class="am-fl">
                <img src="${base}/resources/store/img/PC-login_00.png" alt="${setting.siteName}-login" class="header-login">
            </div>
    ...
    <div class="am-g">
        <div class="am-container">
            <ul class="th-convenient">
                <li>
                    <img src="${base}/resources/store/img/PC-login_08.png" alt="${setting.siteName}">
                    <h2>门店体验</h2>
                    <p>地理位置精准匹配</p>
                    <p>商家活动一览无余</p>
                </li>
                ...
                <li>
                    <img src="${base}/resources/store/img/PC-login_10.png" alt="${setting.siteName}">
                    <h2>消费体验</h2>
                    <p>便捷开放消费体验</p>
                    <p>多样支付不用排队</p>
                </li>
                <div class="th-convenient-bg"></div>
                <li>
                    <img src="${base}/resources/store/img/PC-login_11.png" alt="${setting.siteName}">
                    <h2>社交体验</h2>
                    <p>促销活动及时分享</p>
                    <p>完美对接社区商圈</p>
                </li>
                <div class="th-convenient-bg"></div>
                <li>
                    <img src="${base}/resources/store/img/PC-login_12.png" alt="">
                    <h2>服务体验</h2>
                    <p>售前售后卓越享受</p>
                    <p>精致营销提升粘性</p>
                </li>
            ...
            <div class="am-container">
                <div class="am-fl Contact-us">
                    ...
                    <h3><img src="${base}/resources/store/img/PC-login_31.png" alt="">0551-6769-8098</h3>
                </div>
                <ul class="am-fr Contact-us-fr">
                    <li>
                        <a href="#">
                            <img src="${base}/resources/store/img/PC-login_25.png" alt=""> </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="${base}/resources/store/img/PC-login_24.png" alt=""> </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="${base}/resources/store/img/PC-login_23.png" alt=""> </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="${base}/resources/store/img/PC-login_26.png" alt=""> </a>
                    </li>
                </ul>
            </div>
        </div>
