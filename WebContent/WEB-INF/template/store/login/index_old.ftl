...
<head>
    ...
    <script type="text/javascript" src="${base}/resources/store/js/banner.js"></script>
        ...
        $().ready(function () {
            ...
            $loginForm.validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "${base}/store/login/check_usertype.jhtml",
    ...
    <script type="text/javascript">
        ...
        [@flash_message /]
            ...
            $getCode.on('click', function (e) {
                ...
                $.ajax({
                    url: "${base}/store/register/check_username.jhtml",
                    ...
                    success: function (message) {
                        if (message) {
                            $.ajax({
                                url: "${base}/store/register/getCheckCode.jhtml",
                                data: {
                                    mobile: $mobile.val(),
                                    captchaId: "${captchaId}",
                                    captcha: $("#captcha").val()
        ...
        function protocolDialog() {
            ...
            [/@compress]
                width: 650,
                ok: "同意协议",
                cancel: "${message("store.dialog.cancel")}"
            });
            $(".dialogwarnIcon").css({
                background: "none",
                padding: "0",
...
<div class="am-g banner">
    ...
    <div class="am-container" style="width:1106px;min-height:430px;">
        ...
        <div class="px am-fr" id="_signin">
            ...
            <form id="loginForm" action="${base}/store/login/submit.jhtml" method="post">
        ...
        <div class="px am-fr hidden" id="_register">
            ...
            <form id="registerForm" action="${base}/store/register/submit.jhtml" method="post">
                <div class="normalInput">
                    <div class="normalInput-bg1 bg"></div>
