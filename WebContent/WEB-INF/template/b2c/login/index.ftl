...
<div class="pc-g header-bg">
    <div class="container">
        <div class="f-left">
            <a href="${base}/b2c/index.html">
       <!--         <img class="header-login" src="${base}/resources/b2c/images/logo_01.png" alt="${setting.siteName}-登录"> -->
                <img class="header-login" src="${base}/upload/images/b2c-logo.png" alt="${setting.siteName}-登录">
            </a>
        </div>
    </div>
</div>
                    ...
                    <div class="mt">
                        ...
                        <div class="extra-r">
                            <div class="regist-link">
                                还没有账号？
                                <a href="[#if versionType==1]${base}/b2c/register/register_company.jhtml[#else]javascript:Login('register');[/#if]">立即注册</a>
                            </div>
                        </div>
                    </div>
                    <div class="msg-wrap">
...
<script type="text/javascript">
    ...
    function getCode(type) {
        ...
        $.ajax({
            url: "${base}/b2c/login/getCheckCode.jhtml",
            data: {
                mobile: _mobile,
                captchaId:"${captchaId}",
                captcha:_captcha
    ...
    function submit() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.ajax({
                    url: "${base}/b2c/login/submit.jhtml",
                    type: "POST",
                    data: {
    ...
    function register_modify_password(type) {
        ...
        if (type == 'pass') {
            $.ajax({
                url: '${base}/b2c/login/check_mobile.jhtml',
                data: {
                    mobile: _mobile,
                    securityCode: _code
                },
        ...
        if (type == 'code') {
            $.ajax({
                url: '${base}/b2c/login/register.jhtml',
                data: {
                    mobile: _mobile,
                    securityCode: _code
                },
                ...
                success: function (message) {
                    $.message(message.type, message.content);
                    if (message.type == 'success') {
                        location.href = "${base}/b2c/member/safe/index.jhtml";
                    }
                }
            });
        }
    ...
    function resetPassword() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.ajax({
                    url: "${base}/b2c/login/reset.jhtml",
                    type: "POST",
                    data: {
                        mobile: _mobile,
