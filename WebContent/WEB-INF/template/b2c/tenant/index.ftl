...
<head>
    ...
    <link href="${base}/resources/b2c/css/brands.css" type="text/css" rel="stylesheet"/>
    <link href="${base}/resources/b2c/css/merchantHomepage.css" type="text/css" rel="stylesheet"/>
    <link href="${base}/resources/b2c/css/coupon_popup.css" type="text/css" rel="stylesheet">
    <script type="text/javascript">
        ...
        function searchProduct(tenantId){
            ...
            location.href="${base}/b2c/tenant/search.jhtml?tenantId="+tenantId+"&keyWord="+keyWord;
        }
...
<body>
<!-- 头部start -->
[#include "/b2c/include/tenant_header.ftl"]
<!--头部end-->
        ...
        <div class="container">
            ...
            <div class="recommend-content">
                <ul>
                    ...
                    <li>
                        <a href="${base}/b2c/product/detail/${recommendProduct.id}.jhtml" target="_blank">
                            <div class="item-img">
        ...
        [#list tenant.productCategoryTenants as productCategoryTenant]
            ...
            <div class="container">
                ...
                <div class="items-wrap">
                    <div class="items-nav">
                        <a href="${base}/b2c/tenant/search.jhtml?tenantId=${tenant.id}&productCategoryTenantId=${productCategoryTenant.id}">更多>></a>
                    </div>
                    <div class="items">
                        <ul>
                            [#assign count=0/]
                            [#list productCategoryTenant.products as product]
                                [#if product.isList==true]
                                    <li class="item">
                                        <a class="img" href="${base}/b2c/product/detail/${product.id}.jhtml">
                                            <img src="${product.thumbnail}" width="255" height="255">
                                        </a>
                                        <h2>
                                            <a href="${base}/b2c/product/detail/${product.id}.jhtml" title="【${(product.tenant.name)!}】${product.fullName!}">【${(product.tenant.name)!}】${product.fullName!}</a>
                                        </h2>
                                        <div class="shopping-info">
                                            <span>￥${product.price}</span>
                                            <a href="${base}/b2c/product/detail/${product.id}.jhtml">立即购买</a>
                                        </div>
                                    </li>
