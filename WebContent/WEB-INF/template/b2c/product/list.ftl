...
<script type="text/javascript">
    ...
    function clearbrand_price(id) {
        ...
        location.href = "${base}/b2c/product/list/${(productCategory.id)!}.jhtml" + _src;
    }

</script>
<!--主页内容区start-->
<div class="paper">
    <form id="listForm" action="${base}/b2c/product/list/${(productCategory.id)!}.jhtml" method="get">
        ...
        <div class="pc-bg twoCategory-h">
            <div class="container">
                <div class="span16">
                    <a href="${base}/b2c/product/list/0.jhtml">所有类目</a>
                ...
                [#if productCategory??]
                    ...
                    [#if productCategory.parent??]
                        ...
                        <span> ></span>
                    [/#if]
                    <a href="${base}/b2c/product/list/${(productCategory.id)!}.jhtml"
                ...
                [#if brand??||productCategoryTagId??]
                    <a href="${base}/b2c/product/list/${(productCategory.id)!}.jhtml">清空筛选</a>
                [/#if]
                </div>
                <div class="f-right">
            ...
            <div class="list-show">
                ...
                [#if page??&&page.content?has_content]
                    [#list page.content as products]
                        <li>
                            <a href="${base}/b2c/product/detail/${products.id}.jhtml"><img src="${products.thumbnail}"/></a>
                            <h2>
