...
<head>
    ...
    <link href="${base}/resources/b2c/css/jqzoom.css" type="text/css" rel="stylesheet"/>
    <link href="${base}/resources/b2c/css/common.css" type="text/css" rel="stylesheet"/>
    <link href="${base}/resources/b2c/css/products.css" type="text/css" rel="stylesheet"/>
    ...
    <style type="text/css">
        .save_product {
            background: url(${base}/resources/b2c/images/icon02.png) -40px -6px no-repeat;
            position: absolute;
            width: 16px;
            height: 16px;
            cursor: pointer;
...
<script type="text/javascript">
    ...
    [/#if]
        ...
        //二维码
        $.ajax({
            url: "http://api.wwei.cn/wwei.html?apikey=20160806215020&data=${base}/b2c/product/detail/${product.id}.jhtml",
            type: 'post',
            dataType: "jsonp",
            jsonp: "callback",
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    $("#history").append(
                            "<li>" +
                            "<div class='img'>" +
                            "<a href='${base}/b2c/product/detail/" + data[i].id + ".jhtml' title=''>" +
        ...
        $specificationValue.click(function () {
            ...
            $.each(productMap, function (i, product) {
                if (product.specificationValues.length == selectedIds.length && contains(product.specificationValues, selectedIds)) {
                    if (product.id != null) {
                        location.href = "${base}/b2c/product/detail/" + product.id + ".jhtml";
                        locked = false;
                    }
                    return false;
                }
            ...
            $.ajax({
                ...
                success: function (message) {
                    if (message.type == "success") {
                        ...
                        location.href = "${base}/b2c/member/order/order_submit.jhtml";
                    } else {
                        if (message.content == "请先登录") {
                            location.href = "${base}/b2c/login.jhtml?redirectUrl=${base}/b2c/product/detail/${product.id}.jhtml";
                        }
                        $.message(message);
                    }
                }
...
<div class="paper pc-bg">
    <div class="container">
        <div class="breadcrumb">
            <h2><a href="${base}/b2c/index.jhtml">首页</a></h2>
            <span>
                &nbsp;&gt;&nbsp;
            [#if product.productCategory??]
                [#if product.productCategory.parent??]
                    [#if product.productCategory.parent.parent??]
                        <a href="${base}/b2c/product/list/${(productCategory.parent.parent.id)!}.jhtml">${productCategory.parent.parent.name}</a>
                            &nbsp;&gt;&nbsp;
                    [/#if]
                    <a href="${base}/b2c/product/list/${(productCategory.parent.id)!}.jhtml">${productCategory.parent.name}</a>
                        &nbsp;&gt;&nbsp;
                [/#if]
                <a href="${base}/b2c/product/list/${(productCategory.id)!}.jhtml" class="on">${productCategory.name}</a>
                &nbsp;&gt;&nbsp;
            [/#if]
    ...
    <div class="container">
        <div class="product-intro f-left clearfix">
            ...
            [#else]
                <div class="spec-n1">
                    <a href="javascript:" rel="gallery">
                        <img width="350" height="350" src="${base}/resources/b2c/img/AccountBitmap-product.png" alt="">
                    </a>
                </div>
            [/#if]
                <div class="spec-list">
                    ...
                    <div class="spec-items" id="scrollable">
                        ...
                        [#else]
                            <li>
                                <img alt="" src="${base}/resources/b2c/img/AccountBitmap-product.png" width="50"
                                     height="50">
                            </li>
                        [/#if]
                        </ul>
            ...
            <div class="item-inner">
                <div class="item-info">
                    ...
                    [#--[/#if]--]
                        <div>
                            <span style="color: #de0010;font-weight: bold;font-size: 18px">￥${product.price}</span> <em
                                style="color:#989898;text-decoration: line-through;font-size: 14px;font-weight: none">原价：￥${product.marketPrice}</em>
                        </div>
                            ...
                            [#if tenant.toPay=="true"]
                                <div class="item">
                                    <a href="javascript:;" title="消费者保障服务，卖家承诺货到付款">
                                        <img src="${base}/resources/b2c/images/Hdfk-16x16.png" width="16"
                                             height="16" alt="货到付款">
                                        <span>货到付款</span>
                                    </a>
                                </div>
        ...
        <div class="f-right merchant-info">
            <h1><a href="${base}/b2c/tenant/index.jhtml?id=${(tenant.id)!}">${tenant.name}</a></h1>
            <div class="wire"></div>
            <span>综合评分</span>
        [#if tenant.score=="0"]
        ...
        [#if versionType==0]
            <div class="in_conllect">
                ...
                <a href="${base}/b2c/tenant/index.jhtml?id=${(tenant.id)!}">进入店铺</a>
                    </span>
                <span class="line-right">
        ...
        [#if tenant.qrcodes??&&tenant.qrcodes.size()>0]
            <div style="text-align: center;font-size: 16px;">
                <span>
                    <img style="width:105px;height:105px;margin-top:5px;"
                         src="https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=${tenant.qrcodes[0].ticket}">
                </span>
                <span>
                    <em>微信扫一扫,购物更便捷</em>
                </span>
            ...
            <div class="sales-rankings">
                ...
                [@product_list tenantId=product.tenant.id count = 3 orderBy="sales desc"]
                    [#list products as product]
                        <a class="li" href="${base}/b2c/product/detail/${product.id}.jhtml">
                ...
                <div class="guess-scroll">
                    ...
                    [@product_list tenantId=product.tenant.id count = 6 tagid= 4]
                        [#list products as product]
                            <li>
                                <div class="img">
                                    <a href="${base}/b2c/product/detail/${product.id}.jhtml"
