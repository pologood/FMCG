                                    ...
                                    <div class="li">
                                        <div class="left">
                                            ...
                                            <div class="collect-info">
                                                <h2><a href="${base}/b2c/tenant/index.jhtml?id=${(tenant.id)!}">${tenant.name}</a></h2>
                            ...
                            <div class="my-collect-products">
                                <ul>
                                    [#list page.content as product]
                                        <li>
                                            <a class="img" href="${base}/b2c/product/detail/${product.id}.jhtml" target="_blank">
                                                <img src="${product.thumbnail}"/>
                                            </a>
                                            <div class="depict">
                                                <a href="javascript:;" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;</a>
                                                <a href="${base}/b2c/product/list/0.jhtml?keyword=${product.name}" target="_blank">找相似</a>
                                            </div>
                                            <div class="delete" onclick="" productId="${product.id}"><i></i></div>
                                            <a class="title" href="${base}/b2c/product/detail/${product.id}.jhtml" target="_blank"
