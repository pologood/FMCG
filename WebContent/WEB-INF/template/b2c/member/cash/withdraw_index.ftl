...
<div class="f-left rt">
    ...
    <div class="imenu">
        <div class="mainbox apply portal_rpm_apply">
            ...
            <div>
                <form id="inputForm" action="${base}/b2c/member/cash/submit.jhtml" method="post">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.type == "success") {
                    setTimeout(function() {
                        location.href="${base}/b2c/member/supplier/withdraw_cash_settle_account.jhtml";
                    }, 1000);
                } 
            }
        });
