        ...
        <div class="container">
            ...
            <div class="content">
                <div class="mainbox apply portal_rpm_apply">
		            ...
		            <div>
		                [#--<form id="inputForm" action="${base}/b2c/member/cash/enchashment_submit.jhtml" method="post">--]
		                           ...
		                           [#--<div class="col-main" id="credit_showcase_wrapper">--]
		                                [#--<div class="main-wrap credit-other" id="credit_showcase">--]
		                                    [#--<span id="credit_showcase_other" style="display: block;">--]
		                                        [#--<div class="hd"><h5 style="font-size:20px;">余额提现</h5></div>--]
		                                    ...
		                                    [#--<div class="repayment-amount" id="credit_amount" style="display: block;">--]
		                                        [#--<div class="repayment-padding" id="repayment-padding">--]
		                                            [#--<div class="clearfix">--]
		                                                [#--<label class="label" for="repayment_amount">转入金额：</label>--]
		                                                    [#--<div class="element">--]
		                                                ...
		                                                [#--<p class="indent btn-area" id="pn_btn_repay">--]
		                                                    [#--<span class="btn-blue"> <button id="btn_repay" type="submit" id="submit">立即转入</button> </span>--]
		                                                [#--</p>--]
		                                            [#--</div>--]
		                                        [#--</div>--]
		                                    [#--</div>--]
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="memberBankId" name="memberBankId" style="width:190px">
                                            ...
                                            <option value="${base}/b2c/member/wallet/bank/list.jhtml">--添加银行卡--</option>
