...
<head>
    ...
    <script type="text/javascript">
        ...
        function confirm_btn(){
            ...
            $("#confirm-btn").on("click",function(){
                if (!re.test($("#phone").val())){
                    $("#number1").html("请填写正确的联系号码");
                    return;
                }
                $.ajax({
                    url:"${base}/b2c/member/receiver/update.jhtml",
                    type:"POST",
                    data:{
                    ...
                    success:function(data){
                        ...
                        if(data.type=="success"){
                            $("#addr_dailog_update").hide();
                            location.reload("${base}/b2c/member/order/order_submit.jhtml");
                        }
                    },
                    error:function(e){
                        alert(e);
        ...
        function add_addr(){
            ...
            $("#confirm-btn2").on("click",function(){
                if (!re.test($("#phone2").val())){
                    $("#number").html("请填写正确的联系号码");
                    return;
                }
                $.ajax({
                    url:"${base}/b2c/member/receiver/save.jhtml",
                    type:"POST",
                    dataType:"JSON",
                    data:{
                        areaId: $("#areaId2").val(),
        ...
        function addr_delete(id){
            ...
            if(a){
                $.ajax({
                    url:"${base}/b2c/member/receiver/delete.jhtml",
                    type:"POST",
                    data:{id:id},
                    dataType:"JSON",
        ...
        function addr_setDefault(id){
            $.ajax({
                url:"${base}/b2c/member/receiver/setDefault.jhtml",
                type:"POST",
                data:{id:id},
                dataType:"JSON",
                success:function(message){
        ...
        function calculate(){
            $.ajax({
                url:"${base}/b2c/member/order/calculate.jhtml",
                type:"POST",
                data:{
        ...
        function confirm_order(){
            ...
            $.ajax({
                url:"${base}/b2c/member/order/create.jhtml",
                type:"POST",
                data:{
                    cartToken:"${cartToken}",
                ...
                success:function(data){
                    if(data.type=="success"){
                        if (paymentMthodName == "offline") {//7:线下付款的id
                            location.href="${base}/b2c/payment/payment_success.jhtml?sn="+data.content;
                        }else{
                        	$.ajax({
				                ...
				                success:function(dataBlock){
				                	if(dataBlock.message.type = "success"){
										location.href=
										"${base}/b2c/payment/payment_index.jhtml?sn="+dataBlock.data;
				                	}else{
    ...
    <div class="submitOrder">
        ...
        <div class="order-form">
                ...
                <div class="order-list">
                    <div class="clearfix order-body">
                        <div class="order-body-th clearfix">
                            ...
                            <span>店铺：</span>
                            <a href="${base}/b2c/tenant/index.jhtml?id=${trades.tenant.id}" target="_blank" title="hape旗舰">${trades.tenant.name}</a>
                            ...
                            <!-- <div style="display:inline;float:right;">
                                ...
                                <select name="code" tenant="${trades.tenant.id}" onchange="getCode(this)" >
                                    ...
                                    [#if trades.tenant.id==couponcode.coupon.tenant.id&&couponcode.coupon.status=="canUse"]
            ...
            <div>
                <div class="note">
                    <label for="">备注：</label>
                    <input type="text" name="mome" id="memo" placeholder="补充填写其他信息，如有快递不到也请留言备注">
                </div>
                <div class="discount">
                   <!--  <label for="">优惠劵：</label>
                ...
                <script type="text/javascript">
                    $(function(){
                        // $.ajax({
                        //     url:"${base}/b2c/member/order/coupons.jhtml",
                        //     type:"POST",
                        //     data:{},
                        //     dataType:"JSON",
                        //     success:function(message){
        ...
        <div>
            <div class="order-paybar">
                <a class="order_surebtn" href="javascript:confirm_order();">提交订单&gt;</a>
                ...
                <a href="${base}/b2c/cart/list.jhtml" class="cart_back">返回购物车</a>
            </div>
        </div>
    </div>
</div>
