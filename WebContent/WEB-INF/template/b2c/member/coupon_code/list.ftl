...
<div class="paper">
    ...
    <div class="member-content">
        <div class="container">
            ...
            <div class="content">
                <!--我的优惠券-->
                <link href="${base}/resources/b2c/css/coupon.css" type="text/css" rel="stylesheet">
                <div class="my-coupon">
                    <div id="main">
                            ...
                            <div class="coupon-items">
                                ...
                                <div class="coupon-item coupon-item-d [#if couponCode.coupon.status=='Expired'||couponCode.coupon.status=='unBegin'||couponCode.isUsed==true]coupon-item-dgray[/#if]">
                                    ...
                                    <div class="c-msg">
                                        <div class="c-range">
                                            ...
                                            <div class="range-item">
                                                ...
                                                <span class="txt" title="全平台">
                                                    <a href="${base}/b2c/tenant/index.jhtml?id=${couponCode.coupon.tenant.id}">${couponCode.coupon.tenant.name}</a>
                                                </span>
                                            </div>
                                            <div class="range-item">
                                        ...
                                        <div class="op-btns">
                                            <a href="${base}/b2c/tenant/index.jhtml?id=${couponCode.coupon.tenant.id}" class="btn" target="_blank">
