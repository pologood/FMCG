...
<form id="listForm" action="${base}/b2c/member/supplier/purchase/returns/list.jhtml" method="get">
    ...
    [#include "/b2c/include/supplier_date.ftl"]
                ...
                <tr>
                    ...
                    <th>
                        [#--[#if purchase.type=='applied']--]
                            [#--<a href="${base}/b2c/member/purchase/edit/${purchase.id}.jhtml?type=${purchase.type}"--]
                               [#--style="color: red;">[审核]</a>--]
                        [#--[#else]--]
                            <a href="${base}/b2c/member/supplier/purchase/returns/edit/${purchase.id}.jhtml?type=${purchase.type}">[查看]</a>
                        [#--[/#if]--]
                    </th>
                </tr>
            [/#list]
