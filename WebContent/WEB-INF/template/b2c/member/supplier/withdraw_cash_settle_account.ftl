...
[#include "/b2c/include/supplier_top.ftl"]
    ...
    <form id="listForm" action="${base}/b2c/member/supplier/withdraw_cash_settle_account.jhtml" method="get">
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#export_ss").click(function(){
                ...
                $.ajax({
                    url:"${base}/b2c/member/supplier/withdraw_cash_settle_account_export.jhtml",
                    type:"get",
                    data:{
