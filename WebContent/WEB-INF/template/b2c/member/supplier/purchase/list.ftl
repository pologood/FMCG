...
<form id="listForm" action="${base}/b2c/member/supplier/purchase/list.jhtml" method="get">
            ...
            [#list page.content as purchase]
                <tr>
                    ...
                    <th>
                        ...
                        [#--[#else]--]
                            <a href="${base}/b2c/member/supplier/purchase/edit/${purchase.id}.jhtml?type=${purchase.type}">[查看]</a>
                        [#--[/#if]--]
                    </th>
                </tr>
            [/#list]
