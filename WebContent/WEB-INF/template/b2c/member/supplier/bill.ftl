        ...
        <div class="tb-container">
            ...
            <div id="statistics" class="hidden">
                <ul class="info-item">
                    <li>
                        <div class="left">
                            <img src="${base}/resources/b2c/images/info-1.png" alt=""/>
                        </div>
                        <div class="right">
                            <div class="title">
                    ...
                    <li>
                        <div class="left">
                            <img src="${base}/resources/b2c/images/info-2.png" alt=""/>
                        </div>
                        <div class="right">
                            <div class="title">
                                <p>分润收入&nbsp;&nbsp;[#if profit==0]
                    ...
                    <li>
                        <div class="left">
                            <img src="${base}/resources/b2c/images/info-3.png" alt=""/>
                        </div>
                        <div class="right">
                            <div class="title">
                                <p>交易佣金&nbsp;&nbsp;[#if rebate==0]
                ...
                <ul class="info-item">
                    <li>
                        <div class="left">
                            <img src="${base}/resources/b2c/images/info-4.png" alt=""/>
                        </div>
                        <div class="right">
                            <div class="title">
                                <p>购物支出&nbsp;&nbsp;[#if payment==0]
                    ...
                    <li>
                        <div class="left">
                            <img src="${base}/resources/b2c/images/info-5.png" alt=""/>
                        </div>
                        <div class="right">
                            <div class="title">
                                <p>线下收款&nbsp;&nbsp;[#if cashier==0]
                    ...
                    <li>
                        <div class="left">
                            <img src="${base}/resources/b2c/images/info-6.png" alt=""/>
                        </div>
                        <div class="right">
                            <div class="title">
                                <p>其他支出&nbsp;&nbsp;[#if outcome==0]
                    ...
                    <li>
                        <div class="left">
                            <img src="${base}/resources/b2c/images/info-7.png" alt=""/>
                        </div>
                        <div class="right">
                            <div class="title">
                                <p>其他收款&nbsp;&nbsp;[#if income==0]
                ...
                <ul class="info-item">
                    <li>
                        <div class="left">
                            <img src="${base}/resources/b2c/images/info-8.png" alt=""/>
                        </div>
                        <div class="right">
                            <div class="title">
                                <p>充值&nbsp;&nbsp;[#if recharge==0]
                    ...
                    <li>
                        <div class="left">
                            <img src="${base}/resources/b2c/images/info-9.png" alt=""/>
                        </div>
                        <div class="right">
                            <div class="title">
                                <p>提现&nbsp;&nbsp;[#if withdraw==0]
...
//    }
    $(function(){
        ...
        $("#export_ss").click(function(){
            ...
            $.ajax({
                url:"${base}/b2c/member/supplier/bill_detail.jhtml",
                type:"get",
                data:{
