    ...
    <div class="tb-container" style="border:none;">
        ...
        <div class="my-settings">
            ...
            <div class="basic-info">
                <form id="basicInfoForm" action="${base}/b2c/member/safe/save.jhtml" method="post">
            ...
            <div class="security">
                ...
                <div class="li" id="identity">
                    ...
                    <div class="li-main display-n">
                        <form id="identityForm" action="${base}/b2c/member/safe/identity.jhtml" method="post">
...
<script type="text/javascript">
        ...
        submitHandler: function (form) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '${base}/b2c/member/safe/passwordUpdate.jhtml',
                        data: {
    ...
    $emailForm.validate({
        ...
        submitHandler: function (form) {
            $.ajax({
                type: 'post',
                url: '${base}/b2c/member/safe/send_email.jhtml',
    ...
    $bindMobileForm.validate({
        ...
        submitHandler: function (form) {
            $.ajax({
                type: 'post',
                url: '${base}/b2c/member/safe/mobileupdate.jhtml',
    ...
    function sendSecurityCode() {
        $.ajax({
            type: 'post',
            url: '${base}/b2c/member/safe/send_security_code.jhtml',
