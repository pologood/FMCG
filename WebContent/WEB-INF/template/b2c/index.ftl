        ...
        <div class="content">
            ...
            <div class="wrapper">
                ...
                <div class="topWrapper">
                    ...
                    [@ad_position id=96 areaId=area.id count=5/]
                    </ul>
                    <div>
                ...
                <div class="bottomWrapper">
                    ...
                    <div>
                        ...
                        [#list dayProducts as products]
                            <li>
                                <a href="${base}/b2c/product/detail/${products.id}.jhtml">
                                    <img src="[#if products.image??]${products.image}[#else]${base}/resources/wap/image/NoPicture.jpg[/#if]"
                                         alt="" style="width:150px;height:150px;"/>
                                    <p>${abbreviate(products.name,16,'...')}</p>
        							<span>
                                            ￥${products.price}
        						</span> <em style="color:#989898;text-decoration: line-through;font-size: 14px;font-weight: none">原价：￥${products.marketPrice}</em>
                                </a>
                            </li>
                        [/#list]
                        </ul>
            ...
            <div class="notice">
                <div class="userinfor">
                    ...
                    [#if member??]
                        <a href="${base}/b2c/member/order/list.jhtml">
                            <img src="[#if member.headImg??&&member.headImg?has_content]${member.headImg!}[#else]${base}/resources/b2c/img/AccountBitmap-head.png[/#if]"
                                 style="width: 100%;height: 100%;">
                        </a>
                    [#else ]
                        <img src="${base}/resources/b2c/img/AccountBitmap-head.png" style="width: 100%;">
                    [/#if]
                    </div>
                    <div>
                        <span>
                ...
                [#else ]
                    <a href="${base}/b2c/login.jhtml?type=signin">登录</a>
                    <a href="${base}/b2c/login.jhtml?type=register">注册</a>
                [/#if]
                </div>
    ...
    <div class="hotProducts container">
        ...
        <div class="hotProductsShow">
            ...
            [#list newProducts as products]
                <li>
                    <a class="img-btn" href="${base}/b2c/product/detail/${products.id}.jhtml">
                        <div class="img-con">
                    ...
                    <h2>
                        <a href="${base}/b2c/product/detail/${products.id}.jhtml">${products.name}</a>
                    </h2>
                    <dl>
                       <dd>
                           <span>
            ...
            [#if promotions_started??&&promotions_started?has_content]
                <ul class="display">
                    [#list promotions_started as promotions]
                        <li>
                            <a class="img-btn" href="${base}/b2c/product/detail/${promotions.productId}.jhtml">
                                <div class="img-con">
                                    <div class="img-mask"></div>
                            ...
                            <h2>
                                <a href="${base}/b2c/product/detail/${promotions.productId}.jhtml">${promotions.fullName}</a>
                            </h2>
                            <dl>
                                <dd>
                                ...
                                <dd>
                                    ...
                                    <input name="number" type="text" id="number" value="1"/>
                                    <div onclick="set_number(this)" id="plus">+</div>
                                    <a href="${base}/b2c/product/detail/${promotions.productId}.jhtml"
            ...
            [#if promotions_unstart??&&promotions_unstart?has_content]
                <ul>
                    [#list promotions_unstart as promotions]
                        <li>
                            <a href="${base}/b2c/product/detail/${promotions.productId}.jhtml"><img
...
[/#if]
    ...
    [#--[@product_list productChannelId=productChannel.id count = 4 areaId=area.id tagIds=21]--]
    [#--[#if products?size gt 0]--]
        [@productchannel_list]
            [#list productChannels as productChannel]

        <div id="${productChannel_index+1}F" class="allFloor" [#if c=="false"]style="display:none;"[/#if]>
            <div class="allFloorNav">
                <div class="left">
                    <h2 style="">${number}F<span>${productChannel.name}</span></h2>
                    [#assign number=number+1]
                </div>
                <div class="content"><a href="${base}/b2c/product/list/${productChannel.id}.jhtml">更多>></a></div>
            </div>
            <div class="allFloorShow">
                    <div>
                        [@ad_position id=position[productChannel_index] areaId=area.id  count=1/]
                        <dl style="height:115px;">
                            <dt>分类</dt>
                            [#list productChannel.productCategorys as category_children]
                                [#if category_children_index > 5]
                                    [#break/]
                                [/#if]
                                [#list category_children.tags as tag]
                                    [#if tag.id==12]
                                        <dd>
                                            <a href="${base}/b2c/product/list/${category_children.id}.jhtml">${category_children.name}</a>
                                        </dd>
                                    [/#if]
                                [/#list]
                            [/#list]
                    ...
                    <ul>
                    [@product_list productChannelId=productChannel.id count=4  areaId=area.id ]
                    [#--[#list products as products]--]
                        [#list products as product]
                                    ...
                                    <li>
                                        <a class="img-btn"
                                           href="${base}/b2c/product/detail/${product.id}.jhtml">
                                            <div class="img-con">
                                                <div class="img-mask"></div>
                                        ...
                                        <h2>
                                            <p  style="width:210px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;"><a href="${base}/b2c/product/detail/${product.id}.jhtml">${product.name}</a></p>
                                        </h2>
                                        <dl>
                                           <dd>
                                               <span style="color: #de0010;font-weight: bold;font-size: 18px">￥${product.price}</span>
                                               <em style="color:#989898;text-decoration: line-through;font-size: 14px;font-weight: none">原价：￥${product.marketPrice}</em>
                                           </dd>
                                            <dd>
                                                <b>已售：${product.sales}</b>
                                                <span style="margin-left: 10px">
                                                    [#if member??&&member.favoriteProducts?has_content]
                                                        ...
                                                        [/#list]
                                                    [/#if]收 藏：
                                            <i onclick="addFavorite(${product.id},this)"
                                                [#if member??&&member.favoriteProducts?has_content]
                                                    [#list member.favoriteProducts as favoriteProduct]
                                               [#if favoriteProduct.id==product.id]class="save_product"[/#if]
                                                    [/#list]
                                                [/#if]>
                                            </i>
                                                </span>
                ...
                [#if versionType==0]
                    <dl>
                        <dt>热销商家</dt>
                        [@tenant_list productChannelId=productChannel.id count=4  areaId=area.id]
                            [#list tenants as tenant]
                                <dd>
                                    <p  style="width:210px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;"><a href="${base}/b2c/tenant/index.jhtml?id=${(tenant.id)!}">${tenant.name}</a></p>
                                    <div style="width:260px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">
                                        [#--[#if tenant.productCategoryTenants??&&tenant.productCategoryTenants?has_content]--]
                                            <span>主营类目</span>
                                            [#--[#list tenant.productCategoryTenants as productCategoryTenant]--]
                                                [#--[#if  productCategoryTenant_index >0]--]
                                                    [#--[#break/]--]
                                                [#--[/#if]--]
                                                [#--<a href="${base}/b2c/tenant/search.jhtml?tenantId=${(tenant.id)!}&productCategoryTenantId=${productCategoryTenant.id}">
                                                </a>--]
                                           <a href="${base}/b2c/tenant/search.jhtml?tenantId=${(tenant.id)!}">
                                        ${tenant.tenantCategory.name}
                                        </a>
                                            [#--[/#list]--]
                                        [#--[/#if]--]
                                    </div>
                                    <span style="display: block">满意度：${tenant.score}</span>
                                    <span>月销量：${tenant.monthSales}</span>
                                </dd>
                            [/#list]
                        [/@tenant_list]
                    [#--[#if productChannel.tenantCategorys?has_content]--]
                    [#--[#list productChannel.tenantCategorys as tenantCategory]--]
                    [#--[#list tenantCategory.tenants as tenate]--]
                    [#--[#list tenate.tags as tag]--]
                    [#--[#if tag.id==6]--]
                    [#--<dd>--]
                    [#--<p>11</p>${tenate.name}--]
                    [#--</dd>--]
                                    ...
                                    [#--[#if category.brands?has_content]--]
                                        [#--[#list category.brands as brand]--]
                                            [#--[#list brand.tags as tag]--]
                                                [#--[#if tag.id==24]--]
                                                    [#--<li>--]
                                                        [#--<a href="${base}/b2c/product/list/0.jhtml?brandId=${brand.id}">--]
    ...
    <!--楼层end-->
    <div>
    [#list productChannel as productchannel]
            [#list productchannel.productCategorys as category]
    ${category.name}
    [/#list]
        [/#list]
