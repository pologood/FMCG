...
<div class="container">
    <div class="logo span5 none-logo">
        <a href="${base}/b2c/index.html">
            [#if versionType==0]
       		 	<img src="${base}/upload/images/b2c-logo.png" />  
          		<!--  <img src="${base}/update/b2c-logo.png" /> -->
            [/#if]
        </a>
    </div>
    ...
    <div class="search span12" style="float: right;">
        <div class="span12">
            <input id="keyword" value="${keyword}" placeholder="请输入您要搜索的货品关键字" autocomplete="off" accesskey="s" type="text"/>
        ...
        [#if setting.hotSearch?exists]
            [#list setting.hotSearch?split(",") as fileName]
                <a href="${base}/b2c/product/list/0.jhtml?keyword=${fileName}">${fileName}</a>
            [/#list]
        [/#if]
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function get_city(id,obj){
        ...
        if($(".tog_button").attr("switch")=="true"){
            toggle_city();
             ...
             $.ajax({
                url:"${base}/b2c/area/getbyid.jhtml",
                type:"get",
                data:{id:id},
                dataType:"json",
    ...
    function toggle_city(){
        ...
        $.ajax({
            url:"${base}/b2c/area/update_current.jhtml",
            type:"get",
            data:{id:city_id},
            dataType:"json",
