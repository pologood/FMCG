    ...
    <div class="container">
        ...
        [#if member??]
            <div class="loggedOn" style="display: block;">
                <span>您好, <a href="${base}/b2c/member/order/list.jhtml">${member.username}</a></span>
                ...
                <div class="dropdown">
                    <!--<p>
                            消息 (
                            <a  href="${base}/b2c/member/message/list.jhtml"> ${messageCount}</a>
                            )
                        </p>-->
                    <a href="${base}/b2c/member/message/list.jhtml" class="message_btn">
                    ...
                    <div class="dropdown-menu">
                        ...
                        [#if messageCount!=0]
                            ...
                            <div class="view-message view-cart" style="margin-bottom:8px;padding-top:5px">
                                <a href="${base}/b2c/member/message/list.jhtml">查看消息</a>
                            </div>
                        [#else]
                ...
                <span><a class="loggedOnA" href="${base}/b2c/logout.jhtml">退出</a></span>
            </div>
        [#else]
            <div class="loggedOut">
                <span>欢迎来到${setting.siteName}</span>
                <a href="${base}/b2c/login.jhtml?type=signin" style="color: red">请登录</a>
                <i>|</i>
                <a href="[#if versionType==1]${base}/b2c/register/register_company.jhtml[#else]${base}/b2c/login.jhtml?type=register[/#if]" style="color: red">免费注册</a>
            </div>
        [/#if]
        </div>
        <!--right-->
        <div class="span16">
            <ul>
                <li>
                    <a href="${base}/b2c/index.jhtml"><i class="icon06"></i>首页</a>
                </li>
                <li>
                    <a href="${base}/b2c/member/order/list.jhtml"><i class="icon01"></i>我的订单</a>
                </li>

                <li class="personal_center" style="padding-left: 0px;">
                    <div class="dropdown">
                        <a class="message_btn" href="${base}/b2c/cart/list.jhtml" style="padding-left: 25px;">
                            <i class="icon02"></i>
                            购物车（
                ...
                <li>
                    <a href="${base}/b2c/member/favorite/list.jhtml"><i class="icon03"></i>我的收藏</a>
                </li>
...
<script type="text/javascript">
    ...
    var del = function (id) {
        if (window.confirm("确认删除吗？")) {
            $.ajax({
                url: "${base}/b2c/member/message/delete.jhtml",
                type: "post",
                data: {id: id},
                dataType: "json",
    ...
    function refreshCartCount() {
        ...
        function getCartCount() {
            ...
            $.ajax({
                url: "${base}/b2c/cart/get_cart_count.jhtml",
                type: "post",
                dataType: "json",
                success: function (data) {
