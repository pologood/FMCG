...
<script type="text/javascript">
    ...
    for (var i = 0; i < categorys.length; i++) {
        ...
        $("#first_list").append("<li><h1><a href='${base}/b2c/product/list/" + first_list.id + ".jhtml'><span><img src='"+first_list.image+"'></span>" + first_list.name + "</a></h1><div class='menuNavList'><div  class='menuNavListCont' id='secend_list" + first_list.id + "'></div><div class='menuNavListImg'><a href='javascript:;'><img src='" + _src + "'/></a></div></div></li>");
        for (var n = 0; n < first_list.childrens.length; n++) {
            var secend_list = first_list.childrens[n];
            var _dl = "<dl><dt><a href='${base}/b2c/product/list/" + secend_list.id + ".jhtml'>";
            if (first_list.childrens.length <= 4) {
                _dl = "<dl style='width: 100%'><dt><a href='${base}/b2c/product/list/" + secend_list.id + ".jhtml'>";
            }
            ...
            for (var t = 0; t < secend_list.childrens.length; t++) {
                ...
                $("#third_list" + secend_list.id).append("<a href='${base}/b2c/product/list/" + third_list.id + ".jhtml'>" + third_list.name + "</a>");
            }
        }
    }
</script>
