<div class="mainNav">
    <div class="container ">
        <div class="left allCategorys">
            ...
            [#include "/b2c/include/category.ftl"]
            </div>
        </div>
        <div class="content navItems">
            <ul>
                [#--<li [#if type =='index']class="on"[/#if]>--]
                    [#--<a href="${base}/b2c/index.jhtml">首页</a>--]
                [#--</li>--]
                [#--<li [#if type =='flash_sale']class="on"[/#if]>--]
                    [#--<a href="${base}/b2c/product/flash_sale.jhtml">限时抢购</a>--]
                [#--</li>--]
                [#--<li [#if type =='recommend_brand']class="on"[/#if]>--]
                    [#--<a href="${base}/b2c/brand/recommend_brand.jhtml">品牌推荐</a>--]
                [#--</li>--]
            [@navigation_list position = "middle"]
                [#list navigations as navigation]
                    [#if navigation.type=="b2c"]
                        <li>
