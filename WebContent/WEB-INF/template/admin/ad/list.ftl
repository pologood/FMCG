...
<body>
<div class="path">
    <a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.ad.list")}
...
<form id="listForm" action="list.jhtml" method="get">
        ...
        <div class="menuWrap">
            ...
            [#--<div class="popupMenu">--]
                [#--<ul id="searchPropertyOption">--]
                    [#--<li>--]
                        [#--<a href="javascript:;"[#if page.searchProperty == "title"] class="current"[/#if]--]
                           [#--val="title">${message("Ad.title")}</a>--]
                    [#--</li>--]
                [#--</ul>--]
            [#--</div>--]
        </div>
    ...
    [#list page.content as ad]
        <tr>
            ...
            <td>
            [#if ad.area??&&ad.area?has_content]${(ad.area.name)!}[#else]-[/#if]
            </td>
            <td>
            ${message("Ad.Type." + ad.type)}
            </td>
            <td>
            <img src="${ad.path}" style="width: 200px;height: 100px">
            </td>
            <td>
                [#if ad.beginDate??]
