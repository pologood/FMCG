...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 编辑秒杀
	</div>
	<form id="inputForm" action="update.jhtml" method="post">
		<input type="hidden" name="id" value="${promotion.id}" />
		<input type="hidden" name="type" value="seckill" />
		<ul id="tab" class="tab">
			<li>
		...
		<div class="tabContent">
			<table class="input">
				...
				<tr>
					...
					<td colspan="2">
						<input type="text" name="priceExpression" class="text" value="${promotion.priceExpression}" maxlength="255" title="如“5折”，则输入0.5" />
					</td>
				</tr>
				<tr>
					<th>
