...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 添加秒杀
	</div>
		...
		<div class="tabContent">
			<table class="input">
				...
				<tr>
					...
					<td colspan="2">
						<input type="text" name="priceExpression" class="text" maxlength="255" title="如“5折”，则输入0.5" />
					</td>
				</tr>
				<tr>
					<th>
				...
				<tr>
					...
					<td colspan="2">
						...
						<label>
							<input type="checkbox" name="isDoublePoint" value="true" checked="checked" />是否双倍积分
						</label>
					</td>
				</tr>
			</table>
