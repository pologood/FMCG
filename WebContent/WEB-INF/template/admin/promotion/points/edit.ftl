	...
	<form id="inputForm" action="update.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="name" class="text" readOnly="readOnly" value="${product.name}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="sn" class="text" disabled="disabled" value="${product.sn}" maxlength="100" title="${message("admin.product.snTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="price" class="text" disabled="disabled" value="${product.price}" maxlength="16" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="wholePrice" disabled="disabled" class="text" value="${product.wholePrice}" maxlength="16" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<label>
						<input type="checkbox" id="isMemberPrice"  disabled="disabled"  name="isMemberPrice" value="true"[#if product.memberPrice?has_content] checked="checked"[/#if] />${message("admin.product.isMemberPrice")}
					</label>
				</td>
			</tr>
			<tr id="memberPriceTr"[#if !product.memberPrice?has_content] class="hidden"[/#if]>
				...
				<td>
					[#list memberRanks as memberRank]
						${memberRank.name}: <input type="text"  disabled="disabled"  name="memberPrice_${memberRank.id}" class="text memberPrice" value="${product.memberPrice.get(memberRank)}" maxlength="16" style="width: 60px; margin-right: 6px;"[#if !product.memberPrice?has_content] disabled="disabled"[/#if] />
					[/#list]
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="text" name="cost" class="text" disabled="disabled" value="${product.cost}" maxlength="16" title="${message("admin.product.costTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="marketPrice" class="text" disabled="disabled" value="${product.marketPrice}" maxlength="16" title="${message("admin.product.marketPriceTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="unit" class="text valueRequired" disabled="disabled" maxlength="200" value="${product.unit}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="minReserve" class="text"  disabled="disabled" value="${product.minReserve}" maxlength="9" title="最低起订单" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="weight" class="text"  disabled="disabled" value="${product.weight}" maxlength="9" title="${message("admin.product.weightTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="barcode" class="text" disabled="disabled" value="${product.barcode}" maxlength="128" title="条形码" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="stock" disabled="disabled" class="text" value="${product.stock}" maxlength="9" title="${message("admin.product.stockTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" disabled="disabled" name="stockMemo" class="text" value="${product.stockMemo}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" disabled="disabled" name="point" class="text" value="${product.point}" maxlength="9" title="${message("admin.product.pointTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="memo" disabled="disabled" class="text" value="${product.memo}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" disabled="disabled" name="seoDescription" class="text" value="${product.seoDescription}" maxlength="200" />
				</td>
			</tr>
		</table>
		<table class="input tabContent">
			<tr>
				...
				-->
					<textarea disabled="disabled" style="width: 100%;" class="editor" >${product.introduction?html}</textarea>
				</td>
			</tr>
		</table>
			...
			[#list product.productImages as productImage]
				<tr>
					<td>
						...
						<input type="file" disabled="disabled" name="productImages[${productImage_index}].file" class="productImageFile ignore" />
						<a href="${productImage.large}" target="_blank">${message("admin.common.view")}</a>
					</td>
					<td>
						<input type="text" name="productImages[${productImage_index}].title" disabled="disabled" class="text" maxlength="200" value="${productImage.title}" />
					</td>
					<td>
						<input type="text" name="productImages[${productImage_index}].order" disabled="disabled" class="text productImageOrder" value="${productImage.order}" maxlength="9" style="width: 50px;" />
					</td>
					<td>
						<!--
			...
			[#list product.productCategory.parameterGroups as parameterGroup]
				...
				[#list parameterGroup.parameters as parameter]
					<tr>
						<th>${parameter.name}:</th>
						<td>
							<input type="text" name="parameter_${parameter.id}" disabled="disabled" class="text" value="${product.parameterValue.get(parameter)}" maxlength="200" />
						</td>
					</tr>
				[/#list]
			[/#list]
					...
					<div id="specificationSelect" class="specificationSelect">
						<ul>
							[#list specifications as specification]
								<li>
									<label>
										<input type="checkbox" name="specificationIds" disabled="disabled" value="${specification.id}"[#if product.specifications?seq_contains(specification)] checked="checked"[/#if] />${specification.name}
				...
				<td>
					<table id="specificationProductTable" class="input">
						...
						<tr class="hidden">
							...
							[#list specifications as specification]
								<td class="specification_${specification.id}[#if !product.specifications?seq_contains(specification)] hidden[/#if]">
									<select name="specification_${specification.id}"[#if !product.specifications?seq_contains(specification)] disabled="disabled"[/#if] disabled="disabled">
							...
							<tr>
								...
								[#list specifications as specification]
									<td class="specification_${specification.id}[#if !specificationProduct.specifications?seq_contains(specification)] hidden[/#if]">
										<select name="specification_${specification.id}"[#if !specificationProduct.specifications?seq_contains(specification)] disabled="disabled"[/#if] disabled="disabled">
											[#list specification.specificationValues as specificationValue]
		...
		<table id="productBonusTable" class="input tabContent">
			...
			<tr>
				<td>
					<input type="hidden" name="bonuses[${bonuses_index}].id" class="text" maxlength="200" value="${bonuses.id}" />
				...
				<td>
					<input type="text" name="bonuses[${bonuses_index}].expression" class="text perexpression valueRequired" value="${bonuses.expression}" title="提成计算：数字(例如:0.4 固定金额)/百分数(例如: 4% 销售价百分比)"/>
				</td>
				<td>
				<!--
					<a href="javascript:;" class="deleteProductBonus">[${message("admin.common.delete")}]</a>
		...
		<table id="productPackagUnitTable" class="input tabContent">
			...
			[#list product.packagUnits as packagUnits]
				<tr>
					<td>
						<input type="hidden" name="packagUnits[${packagUnits_index}].id" class="text" maxlength="200" value="${packagUnits.id}" />
						<input type="text" disabled="disabled" name="packagUnits[${packagUnits_index}].name" class="text valueRequired" maxlength="200" value="${packagUnits.name}" />
					</td>
					<td>
						<input type="text" disabled="disabled" name="packagUnits[${packagUnits_index}].coefficient" class="text memberPrice valueRequired" value="${packagUnits.coefficient}" />
					</td>
					<td>
						<input type="text" disabled="disabled" name="packagUnits[${packagUnits_index}].wholePrice" class="text memberPrice" value="${packagUnits.wholePrice}" />
					</td>
					<td>
						<input type="text" disabled="disabled" name="packagUnits[${packagUnits_index}].price" class="text memberPrice" value="${packagUnits.price}" />
					</td>
					<td>
						<input type="text" disabled="disabled" name="packagUnits[${packagUnits_index}].barcode" class="text" value="${packagUnits.barcode}" />
					</td>
					<td>
					<!--
						<a href="javascript:;" class="deleteProductBonus">[${message("admin.common.delete")}]</a>
