		...
		<table id="listTable" class="list">
			...
			[#if consultation.product??]
				<tr>
					...
					<td>
						<a href="${base}/helper/consultation/content/${consultation.product.id}.jhtml" title="${consultation.product.name}" target="_blank">${abbreviate(consultation.product.name, 50, "...")}</a>
					</td>
					<td>
					...
					<td>
						...
						<a href="${base}/helper/member/consultation/content/${consultation.product.id}.jhtml" target="_blank">[${message("admin.common.view")}]</a>
