...
<form id="inputForm" action="updatePosition.jhtml" method="post" enctype="multipart/form-data">
    ...
    <table class="input tabContent">
        <tr>
            ...
            <td>
                <input type="text" name="title" class="text" value="${ad.title}"/>
            </td>
        </tr>
        <tr>
            <th>
        ...
        <tr>
            ...
            <td>
                ...
                [#list linkTypes as linkType]
                    <option value="${linkType}"[#if linkType == ad.linkType] selected="selected"[/#if]>
        ...
        <tr>
            ...
            <td>
	            <span class="fieldSet">
                    <input type="text" name="path" class="text" readonly="true" value="${ad.path}"/>
        ...
        <tr>
            <th>链接地址：</th>
            <td>
                <input type="text" class="text" name="url" id="productUrl" readonly="true" value="${ad.url}"/>
                <select class="form-control" name="linkId" onchange="get_product_id(this)">
                    <option value=''>请选择商品</option>
                [#if products??]
                    [#list products as product]
                        <option value='${product.id}' title="${product.name}" [#if ad.linkId==product.id]
                                selected[/#if]>${product.name}</option>
                    [/#list]
                [/#if]
                </select>
            </td>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="order" class="text" value="${ad.order}"/>
            </td>
        </tr>
        <tr>
            <th>&nbsp;</th>
