				...
				<div class="menuWrap">
					...
					<div class="popupMenu">
						<ul id="filterOption" class="check">
							<li>
								<a href="javascript:;" name="status" val="none"[#if status == "none"] class="checked"[/#if]>${message("Tenant.Status.none")}</a>
							</li>
							<li>
								<a href="javascript:;" name="status" val="wait"[#if status == "wait"] class="checked"[/#if]>${message("Tenant.Status.wait")}</a>
							</li>
							<li>
								<a href="javascript:;" name="status" val="success"[#if status == "success"] class="checked"[/#if]>${message("Tenant.Status.success")}</a>
							</li>
							<li>
								<a href="javascript:;" name="status" val="fail"[#if status == "fail"] class="checked"[/#if]>${message("Tenant.Status.fail")}</a>
							</li>
						</ul>
					</div>
				</div>
