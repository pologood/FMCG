...
<title>添加门店 - Powered By rsico</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 添加门店 <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="deliveryCenter_add.jhtml" method="get">
		<input type="hidden" name="communityId" value="${communityId}">
		<div class="bar">
			<div class="buttonWrap">
				<a href="javascript:;" id="addButton" class="iconButton disabled" onclick="add_delivery_center()">
					<span class="addIcon">&nbsp;</span>添加到社区
				</a>
...
<script type="text/javascript">
    ...
    function add_delivery_center(){
    	if($("#listTable input[name='ids']:checked").size()>0){
    		...
    		$.ajax({
	            url: "${base}/admin/community/deliveryCenter_save.jhtml",
	            type: "post",
	            data: {
	            	ids:ids,
