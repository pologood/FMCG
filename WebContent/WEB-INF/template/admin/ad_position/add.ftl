    ...
    <table class="input">
        ...
        <tr>
            ...
            <td>
                <select name="type">
                [#list types as type]
                    <option [#if type==add_type]selected="selected" [/#if]
                            value="${type}">${message("AdPosition.Type." + type)}</option>
                [/#list]
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" name="width" class="text" maxlength="9"
                       title="${message("admin.adPosition.widthTitle")}"/>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="height" class="text" maxlength="9"
                       title="${message("admin.adPosition.heightTitle")}"/>
            </td>
        </tr>
        <tr>
            <th>
