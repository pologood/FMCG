...
<title>${message("admin.expertCategory.add")} - Powered By rsico</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.expertCategory.add")}
	</div>
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" id="memo" name="memo" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
