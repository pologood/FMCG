...
<body>
<div class="path">
    <a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.tag.list")}
            ...
            <div class="menuWrap">
                ...
                <div class="popupMenu">
                    <ul id="type">
                        [#list types as type]
                        <li>
                            <a href="list.jhtml?type=${type}" [#if ownType==type]class="current"[/#if]>${(message("Tag.Type."+type))!}</a>
                        </li>
                        [/#list]
                    </ul>
                </div>
