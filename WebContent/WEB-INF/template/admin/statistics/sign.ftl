...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 自动签收
	</div>
	<form id="inputForm" action="sign.jhtml" method="post">
		<table class="input">
			<tr>
				<th>
					<span class="requiredField">*</span>每次生成数:
				</th>
				<td>
