		...
		<table class="input">
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:productChannel"[#if role.authorities?seq_contains("admin:productChannel")] checked="checked"[/#if] />分类频道
						</label>
						<label>
						...
						<label>
                            <input type="checkbox" name="authorities" value="admin:barcode"[#if role.authorities?seq_contains("admin:barcode")] checked="checked"[/#if] />条码库
                        </label>
						<label>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:credit"[#if role.authorities?seq_contains("admin:credit")] checked="checked"[/#if] />付款管理
						</label>
						<label>
						...
						<label>
                            <input type="checkbox" name="authorities" value="admin:orderPayment"[#if role.authorities?seq_contains("admin:orderPayment")] checked="checked"[/#if] />${message("admin.order.payment")}
                        </label>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:tenantCategory"[#if role.authorities?seq_contains("admin:tenantCategory")] checked="checked"[/#if] />商家分类
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:tenant"[#if role.authorities?seq_contains("admin:tenant")] checked="checked"[/#if] />商家档案
						</label>
						<label>
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:memberRealname"[#if role.authorities?seq_contains("admin:memberRealname")] checked="checked"[/#if] />${message("admin.role.memberRealname")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:tenantCheck"[#if role.authorities?seq_contains("admin:tenantCheck")] checked="checked"[/#if] />${message("admin.main.tenantCheck")}
						</label>
						<!-- label>
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:expertCategory"[#if role.authorities?seq_contains("admin:expertCategory")] checked="checked"[/#if] />专家小组
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:expert"[#if role.authorities?seq_contains("admin:expert")] checked="checked"[/#if] />专家档案
						</label -->
					</span>
				</td>
			</tr>
			...
			<!-- tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:union"[#if role.authorities?seq_contains("admin:union")] checked="checked"[/#if] />联盟管理
						</label>
						<label>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:IWReport"[#if role.authorities?seq_contains("admin:IWReport")] checked="checked"[/#if] />报表上传
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:community"[#if role.authorities?seq_contains("admin:community")] checked="checked"[/#if] />社区维护
						</label>
						<label>
                            <input type="checkbox" name="authorities" value="admin:application"[#if role.authorities?seq_contains("admin:application")] checked="checked"[/#if] />应用管理
                        </label>
						<!-- label>
							<input type="checkbox" name="authorities" value="admin:mobilePrice"[#if role.authorities?seq_contains("admin:mobilePrice")] checked="checked"[/#if] />快充价格表
						</label -->
						<label>
						...
						<label>
                            <input type="checkbox" name="authorities" value="admin:tenantRules"[#if role.authorities?seq_contains("admin:tenantRules")] checked="checked"[/#if] />${message("admin.main.tenantRules")}
                        </label>

							<input type="checkbox" name="authorities" value="admin:member" />${message("admin.role.member")}
						<!-- label>
							<input type="checkbox" name="authorities" value="admin:enterPrise"[#if role.authorities?seq_contains("admin:enterPrise")] checked="checked"[/#if] />合作伙伴管理
						</label>
						<label>
