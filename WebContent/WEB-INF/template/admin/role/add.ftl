		...
		<table class="input">
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:productChannel" />分类频道
						</label>
						<label>
						...
						<label>
                            <input type="checkbox" name="authorities" value="admin:barcode"/>条码库
                        </label>
						<label>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:credit" />付款管理
						</label>
						<label>
						...
						<label>
                            <input type="checkbox" name="authorities" value="admin:orderPayment"/>${message("admin.order.payment")}
                        </label>
						<!--label>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:tenantCategory />商家分类
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:tenant" />商家档案
						</label>
						<label>
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:memberRealname" />${message("admin.role.memberRealname")}
						</label>
						<!--label>
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:expertCategory" />专家小组
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:expert" />专家档案
						</label-->
			...
			<!-- tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:union" />联盟管理
						</label>
						<label>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
                            <input type="checkbox" name="authorities" value="admin:IWReport"/>报表上传
                        </label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:community" />社区维护
						</label>
						<label>
                            <input type="checkbox" name="authorities" value="admin:application"/>应用管理
                        </label>
						<label>
							<input type="checkbox" name="authorities" value="admin:paymentMethod" />${message("admin.role.paymentMethod")}
						</label>
						<!--label>
							<input type="checkbox" name="authorities" value="admin:mobilePrice" />价格表
						</label -->
						<label>
						...
						<label>
                            <input type="checkbox" name="authorities" value="admin:tenantRules"/>${message("admin.main.tenantRules")}
                        </label>
						<!--label>
