...
<form id="inputForm" action="save.jhtml" method="post">
    <table class="input">
        ...
        <tr>
            ...
            <td>
                ...
                [#list positions as position]
                    <option value="${position}"[#if position == "middle"]
                            selected="selected"[/#if]>${message("Navigation.Position." + position)}</option>
                [/#list]
                </select>
            </td>
        </tr>
        ...
        <tr>
            <th>标签：</th>
            <td>
                <label><input type="radio" name="type" class="radio" id="b2b" value="b2b"/>B2B导航</label>
                <label><input type="radio" name="type" class="radio" id="b2c" value="b2c" />B2C导航</label>
            </td>
        </tr>
        <tr>
            <th>
