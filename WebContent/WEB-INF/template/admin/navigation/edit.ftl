	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
            ...
            <tr>
                <th>标签：</th>
                <td>
                    <label><input type="radio" name="type" class="radio" id="b2b" value="b2b" [#if navigation.type??][#if  navigation.type.equals("b2b")] checked="checked "[/#if] [/#if]/>B2B导航</label>
                    <label><input type="radio" name="type" class="radio" id="b2c" value="b2c" [#if navigation.type??][#if  navigation.type.equals("b2c")] checked="checked "[/#if][/#if]/>B2C导航</label>
                </td>
            </tr>
			<tr>
				<th>
