...
<title>登记数量列表 - Powered By rsico</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo;登记数量列表 <span>(${message("admin.page.total", page.total)})</span>
	</div>
