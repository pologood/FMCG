		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					...
					[#if member.isLocked=='locked']
						<label>
							<input type="checkbox" name="isLocked" value="locked" checked="checked" />是否${message("Member.LockType.locked")}
							<input type="hidden" name="_isLocked" value="none" />
						</label>
					[/#if]
					[#if member.isLocked=='freezed']
						<label>
							<input type="checkbox" name="isLocked" value="freezed" checked="checked" />是否${message("Member.LockType.freezed")}
							<input type="hidden" name="_isLocked" value="none" />
						</label>
					[/#if]
				</td>
