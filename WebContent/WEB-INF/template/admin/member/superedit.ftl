	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="member_profit" class="text" value="0.00" maxlength="6" />
				</td>
			</tr>		
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<select name="isLocked">
						<option value="none"[#if member.isLocked == "none"] selected="selected"[/#if]>${message("Member.LockType.none")}</option>
						<option value="locked"[#if member.isLocked == "locked"] selected="selected"[/#if]>${message("Member.LockType.locked")}</option>
						<option value="freezed"[#if member.isLocked == "freezed"] selected="selected"[/#if]>${message("Member.LockType.freezed")}</option>
					</select>
				</td>
			</tr>
			<tr>
