...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>${message("Setting.siteCompany")}:
                </th>
                <td>
                    <input type="text" name="siteCompany" class="text" value="${setting.siteCompany}" maxlength="200" />
                </td>
            </tr>
			<tr>
				<th>
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>${message("Setting.webSite")}:
                </th>
                <td>
                    <input type="text" name="webSite" class="text" value="${setting.webSite}" maxlength="200" />
                </td>
            </tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="hotTenantSearch" class="text" value="${setting.hotTenantSearch}" maxlength="200" title="${message("admin.setting.hotSearchTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="customservice" class="text" value="${setting.customservice}" maxlength="100" />
                </td>
            </tr>
			<tr>
				<th>
		...
		<table class="input tabContent">
			...
			<tr>
				<th>
					${message("Setting.clearingTime")}: 
				</th>
				<td>
					<select name="clearingTime">
						[#list clearingTimes as clearingTime]
							<option value="${clearingTime}"[#if clearingTime == setting.clearingTime] selected="selected"[/#if]>${message("Setting.ClearingTime." + clearingTime)}</option>
						[/#list]
					</select>
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>货款提现手续费:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>充值提现手续费: 
				</th>
				<td>
					<input type="text" name="paymentWithdrawCashScale" class="text" value="${setting.paymentWithdrawCashScale}" maxlength="7" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>导购分润比例: 
				</th>
				<td>
					<input type="text" name="guidePercent" class="text" value="${setting.guidePercent}" maxlength="7" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>导购店主分润比例:
				</th>
				<td>
					<input type="text" name="guideOwnerPercent" class="text" value="${setting.guideOwnerPercent}" maxlength="7" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>红包冻结佣金比例:
				</th>
				<td>
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>订单提醒时间间隔:
                </th>
                <td>
                    <input type="text" name="orderReminderTime" class="text" value="${setting.orderReminderTime}" maxlength="7" />
                </td>
            </tr>

            <tr>
                <th>
                    <span class="requiredField">*</span>红包过期提醒时间间隔:
                </th>
                <td>
                    <input type="text" name="bonusReminderTime" class="text" value="${setting.bonusReminderTime}" maxlength="7" />
                </td>
            </tr>

			<tr>
				<th>
					<span class="requiredField">*</span>功能开通费(年): 
				</th>
				<td>
					<input type="text" name="functionFee" class="text" value="${setting.functionFee}" maxlength="7" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>最低价格:
				</th>
				<td>
					<input type="text" name="minInvitePrice" class="text" value="${setting.minInvitePrice}" maxlength="7" />
				</td>
			</tr>
			<tr>
				<th>
