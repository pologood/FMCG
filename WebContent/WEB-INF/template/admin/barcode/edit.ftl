...
<head>
    ...
    <title>${message("admin.Barcode.edit")} - Powered By rsico</title>
...
//                    brandId: "required",
            ...
            var productImageIndex = [#if barcode??&&barcode.productImages??&&(barcode.productImages.size()>0)]${barcode.productImages.size()}[#else]1 [/#if];
            var settings = {
                isSubmit: true
...
<body>
<div class="path">
    <a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.Barcode.edit")}
</div>
    ...
    <table class="input">
        ...
        <tr>
            ...
            [#list expertTags as expertTag ]
                <input type="radio" name="tag.id" value="${expertTag.id}"
                    [#if barcode??&&barcode.tag??&&barcode.tag.id==expertTag.id] checked="checked"[/#if]/>${expertTag.name}
            [/#list]
            </td>
        </tr>
            ...
            <td>
                ...
                [#if barcode.productImages[0]??]
                    [#list barcode.productImages as productImage ]
                        <tr>
                            <td>
                                <img class="proImg" id="img${productImage_index}" src="${productImage.source}"
                                     width="100px" height="100px"/>
                                <input type="hidden" name="productImages[${productImage_index}].local"
                                       value="${productImage.source}" maxlength="200"/>
                            ...
                            <td>
                                <input type="text" name="productImages[${productImage_index}].title"
                                       value="${productImage.title}" class="text"
                                       maxlength="200"/>
                            </td>
                            <td>
