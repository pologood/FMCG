...
{{!单列}}
{{#compare column 1}}
<div class="ls_product ls_product_promotion col-1">
    {{#with datas}}
    {{#each this}}
    <div class="box_product">
        <a href="rzico://product?id={{id}}">
            {{!商品图片}}
            <div class="imgsymbol">
                <img class="lazy" src="${base}/resources/app/3.0/images/AccountBitmap-product.png" data-original="{{thumbnail}}">
            </div>
            {{!商品描述}}
...
{{#compare column 2}}
{{#unless addition}}
<div class="ls_product ls_product_promotion cf col-2">
    {{/unless}}
    {{#with datas}}
    {{#each this}}
