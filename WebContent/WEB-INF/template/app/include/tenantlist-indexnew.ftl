...
[#-- 该页面中使用的优惠图标颜色色值--]
<a class="weui_cells box_tenant col-1" href="rzico://tenant?id={{id}}">
    [#-- box_tenant-info--]
    <div class="weui_cell box_tenant-info">
        <div class="weui_cell_hd">
            <img class="lazy" src="${base}/resources/app/3.0/image/AccountBitmap-tenant.png"
    ...
    <div class="weui_cell box_tenant-promotions">
        ...
        <div class="weui_cell_bd weui_cell_primary ThumbIconLeft ">
            ...
            <p class="promdesc">
                ...
                {{/if}}
                <span class="ft-bs0 clr-grey02">{{name}}.</span>
