...
<body>
	<p>${username}:</p>
	<p> 您好，欢迎您加入${setting.siteName}，此邮件为系统发送邮件，请勿回复。</p>
	<p> 您正在使用${setting.siteName}账号绑定功能，请点击以下立即缴活绑定您的邮箱[#if safeKey.expire??](${message("shop.password.expire")}: ${safeKey.expire?string("yyyy-MM-dd HH:mm")})[/#if]</p>
	<p>
