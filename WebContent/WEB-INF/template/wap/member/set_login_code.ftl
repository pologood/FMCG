    ...
    <div class="page" style="background-color:#E9E9E9;">
        <div class="weui_cells weui_cells_form">
            ...
            <a class="weui_cell">
                <div class="weui_cell_hd">
                    <i class="iconfont color-warn2">&#xe64a;</i>
                </div>
                <div class="weui_cell_bd weui_cell_primary">
        ...
        <div class="weui_cells weui_cells_form">
            <div class="weui_cell">
                ...
                <div class="weui_cell_bd weui_cell_primary">
                    <input class="weui_input" type="password" placeholder="请输入新密码" maxlength="20"
                           style="font-family:Microsoft YaHei;" name="newPassword" id="newPassword">
                </div>
            </div>
            <div class="weui_cell ">
                <div class="weui_cell_hd"><label class="weui_label" style="width:70px;">确认密码</label></div>
                <div class="weui_cell_bd weui_cell_primary">
                    <input class="weui_input" type="password" placeholder="请输入确认密码" maxlength="20"
                           style="font-family:Microsoft YaHei;" name="reNewPassword" id="reNewPassword">
                </div>
            </div>
        </div>
    ...
    $(function () {
        ...
        $("#submit_code").on("click", function () {
            ...
            if (_newPassword.length < 6) {
                showToast2({content: "新密码长度不合法，应该在6-20之间！"});
                return;
            }

            if (_reNewPassword.length < 6) {
                showToast2({content: "确认密码长度不合法，应该在6-20之间！"});
                return;
            }
            ...
            $.ajax({
                ...
                success: function (data4) {
                    ...
                    ajaxPost({
                        url: "${base}/wap/member/updatePassword.jhtml",
                        data: {
                            newLoginPassword: hex2b64(rsaKey.encrypt(_newPassword)),
                            reNewLoginPassword: hex2b64(rsaKey.encrypt(_reNewPassword)),
