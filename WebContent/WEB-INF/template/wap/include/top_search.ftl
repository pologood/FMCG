        ...
        <div class="am-popup-bd" style="background:#fff;padding: 0px 10px 0px;">
        	<div data-am-widget="tabs" class="am-tabs am-tabs-d2" style="margin:0px;">
  				<ul class="am-tabs-nav am-cf" >
   					 <li class="am-active" >
      					<a style="line-height: 30px;" href="[data-tab-panel-0]">商品</a>
    				</li>
    				<li class="">
      					<a style="line-height: 30px;" href="[data-tab-panel-1]">商家</a>
    				</li>
  				</ul>
  				<div class="am-tabs-bd" style="border-left: none;border-right: none;">
    				<div data-tab-panel-0 class="am-tab-panel am-active">
   					...
   					<div data-tab-panel-1 class="am-tab-panel " style="border-left: none;border-right: none;">
