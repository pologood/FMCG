...
[#-- 高度占位元素--]
<div data-emptyfor="top"></div>
[#-- 顶部搜索框及购物车--]
<div class="weui_cell top bg-13 TT-IN" data-emptyto="top">
    <div class="weui_cell_bd weui_cell_primary">
        <a href="${base}/wap/tenant/search/${tenant.id}.jhtml" class="bg-00 clr-grey03"><i class="iconfont search">
            &#xe640;</i></a>
    </div>
    <a class="weui_cell_ft" href="${base}/wap/cart/list.jhtml">
        <span>
            <i class="iconfont clr-grey03">&#xe628;</i>
...
[#if id == 199]
    <a class="Videos" href="https://open.lechange.com/viewH5?uuid=b52315914c85418192a8df68cbb3be">
        <img src="${base}/resources/wap/3.0/image/tenant/videos.png"/>
    </a>
[/#if]
    <div id="silder" class="silder banner-bgs" style="position:relative;color:white;">
        <img src="${base}/resources/wap/3.0/image/blank/blank640x250.png" alt="" style="width:100%;">
        ...
        <div class="couponboothR bg-05 TT-IN">
            ...
            <div class="couponbooth TT-IN">
                [#list coupons as coupon]
                    <a href="${base}/wap/coupon/view.jhtml?id=${coupon.id}"
                       class="coupon TT-IN">
                        <div class="up">
                        [#-- 优惠数额--]
                            <div class="amount">
                ...
                [#if tag.id==5 && product.isMarketable==true&&product.isList==true]
                    [#if (tag_index < 5)]
                        <div class="box_product">
                            <a href="${base}/wap/product/content/${product.id}/product.jhtml">
                                <div class="imgsymbol">
                                    <img class="lazy" data-original="${product.thumbnail}"
                                         src="${base}/resources/wap/2.0/images/AccountBitmap-product.png" alt="">
                                </div>
                                <P>
                                    <span class="clr-red05 ft-bs15">¥${product.calcEffectivePrice(null)}</span>
                                    [#if product.marketPrice gt product.calcEffectivePrice(null)]
            ...
            [#list employeePage.content as employee]
                <div class="shopguide_box">
                    <div class="shopguide_img">
                        <img class="lazy" data-original="${employee.member.headImg}"
                             src="${base}/resources/wap/3.0/image/placeholder/user.png" alt="">
                    </div>
                    <div class="shopguide_description">
                        <p class="clr-red05 ft-bs0">${employee.member.name}<img
                                src="${base}/resources/wap/3.0/image/static/fruit/icon.png" alt=""></p>
                    ...
                    [#-- <a href="tel:${employee.member.mobile};" class="bg-07 clr-grey08 ft-bs09">联系导购</a>--]
                        <a href="${base}/wap/member/chat/index.jhtml?targetid=${employee.member.id}"
                        ...
                        [#-- new the following--]
                            <div class="box_product">
                                ...
                                [#-- 商品内容盒--]
                                    <div class="inforap">
                                    [#-- 商品描述--]
                                        <p class="description ft-bs15">${product.name}</p>
                                    [#-- 促销标签--]
                                        ...
                                        <p>
                                            <b class="ft-bs15 clr-red05 price">￥${product.calcEffectivePrice(null)}</b>
                                        ...
                                        <p class="clr-grey13 ft-bs0">人气 ${product.hits} /
                                            月销量 ${product.monthSales}</p>
                                    </div>
                                [#-- 立即购买按钮--]
                                [#-- <span class="buynow ft-bs0 bg-07">立即购买</span>--]
                                    <span class="buynow ft-bs1" data-productid="${product.id}">
                                        <i class="iconfont">&#xe651;</i>
...
[#-- 买单立减浮标链接--]
<a href="${base}/wap/pay/bill/buyreduce/${id}.jhtml" class="link_toBRRN">
    <img src="${base}/resources/wap/3.0/image/tenant/link_toBRRN.png" alt="">
</a>
[#-- 商家首页底部操作面板--]
[#include "/wap/tenant/bottom_operas.ftl"/]
<!-- TXT:联系店铺(门店)-->
...
<script type="text/x-handlebars-template" id="tpl_ls_promotion">
    [#include "/wap/include/productlist/promotion.ftl"/]
</script>
<!-- HBS:新品-->
<script type="text/x-handlebars-template" id="tpl_ls_new">
    [#include "/wap/include/productlist/new.ftl"/]
</script>
<!-- HBS:全部-->
<script type="text/x-handlebars-template" id="tpl_ls_allgoods">
    [#include "/wap/include/productlist/allgoods.ftl"/]
</script>
<!-- BOTTOM SCRIPT-->
<!-- JS:receiver-->
<script type="text/javascript">
    ...
    //店铺id
    _TH_.tenantid = "${id}";
    _TH_.tenantname = "${name}";
    [#-- 店铺是否已收藏标记--]
    _TH_.tenant_saveflag = "${flag}";
    [#-- 购物车数量--]
    _TH_.cartcount = "${cartcount}";
    [#-- 用户id--]
...
<script type="text/javascript" src="${base}/resources/wap/3.0/js/plugin/islider/iSlider.animate.min.js"></script>
<!-- JS:page-->
<script type="text/javascript" src="${base}/resources/wap/3.0/js/page/thw/tenant/index-v3.js"></script>
</body>
</html>
