...
$().ready(function(){
	...
	$adress.on("tap",function(){
		var $this = $(this);
		location.href="${base}/mobile/member/order/info.jhtml?receiverId="+$this.attr("receiverId"); return false;
	});
	var $qy1=$("#qy1");
	var $qy2=$("#qy2");
	var $qy3=$("#qy3");
...
<section class="m_section">
	...
	<div class="m_adddzc m_adddzc_dz">
		<form id="receiverForm" action="${base}/mobile/member/receiver/save.jhtml" method="post">
			...
			<div class="m_adddzcul">
				...
				<div class="m_adddzc_area">
					...
					<div class="m_adddzc_areali">
						<p class="m_arear_qy3" id="qy4"><span>商圈</span></p>
						<div class="m_arear m_arear_dz4" id="m_areascrooler_4">
							<ul>
							</ul>
						</div>
					</div>
				...
				<div class="m_h10"></div>
				<p><span><a id="submit" href="javascript:;">确定</a></span><span class="m_last m_tipsce"><a href="javascript:;">取消</a>  <!-- <span class="m_last" id="reset"><a href="javascript:;">重置</a> --></span></p>
			</div>
		</form>
	</div>
