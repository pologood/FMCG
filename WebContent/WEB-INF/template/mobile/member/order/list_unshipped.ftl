...
<section class="m_section">
  ...
  <div class="order_screen">
	     <ul>
		      ...
		      <li id="unshipped" class="[#if type=='unshipped']current_screen[/#if]"><img height="20px" src="${base}/resources/mobile/images/send.png" /><p>待发货</p></li>
  ...
  <article class="order_list" id="m_scrooler_0" style="display:block">
    <div class="order_content m_bodycont_1">
      ...
      [#else]
		      <div id="pullUp">
				    <span class="pullUpLabel">暂无待发货订单!</span>
			  </div>
      [/#if]
    </div>
  </article>
