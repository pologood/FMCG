...
<section class="m_section">
  ...
  <div class="order_screen">
	   <ul>
		      ...
		      <li id="unpaid" class="[#if type=='unpaid']current_screen[/#if]"><img height="20px" src="${base}/resources/mobile/images/pay.png" /><p>待付款</p></li>
  ...
  <article class="order_list" id="m_scrooler_0" style="display:block">
    <div class="order_content m_bodycont_1">
      ...
      [#else]
	      <div id="pullUp">
				<span class="pullUpLabel">暂无未付款订单!</span>
		  </div>
      [/#if]
    </div>
  </article>
