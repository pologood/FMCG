...
<section class="m_section">
	<header class="m_header">
		<div class="m_headercont_1">
			...
			<div class="m_title" alt="选择日期">商品咨询</div>
	...
	<article class="m_article m_article_1 m_article_writh" id="m_scrooler">
		<div class="m_bodycont">
						...
						[#if page.content?has_content]
							...
							<li>
								<div class="m_evaluate_text">
									<span>
									[#if consultation.member??&&consultation.member.username]
										${mosaic(consultation.member.username, 4)}
									[/#if] : </span>
								...
								<div class="m_evaluate_text_1">
										<span>
										[#if replyConsultation.member??&&replyConsultation.member.username]
											${mosaic(replyConsultation.member.username, 4)}
										[/#if]
										: </span>
			...
			<div class="m_btn"><a href="javascript:;" id="addConsultation">我要咨询</a></div>
		</div>
	</article>
