   ...
   <div class="page_box">
       <span>(${message("admin.page.total", page.total)})</span>
		<div class="pagination">
			...
			[/#if]
			<span class="pageSkip">
				${message("admin.page.totalPages", totalPages)} ${message("admin.page.pageNumber", '<input id="pageNumber" name="pageNumber" value="' + pageNumber + '" maxlength="9" onpaste="return false;" />')}<button type="submit" class="pag_cx">&nbsp;</button>
			</span>
		</div>
  </div>
[/#if]