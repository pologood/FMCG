        ...
        <div class="wrapper" id="wrapper">
            ...
            <div class="page-nav page-nav-app vip-guide-nav" id="app_head_nav">
                <div class="js-app-header title-wrap" id="app_0000000844">
                    ...
                    <dl class="app-info">
                        ...
                        <dd class="app-intro" id="app_desc">快去添加红包，对您的销量有很大的帮助。</dd>
                    </dl>
                </div>
                <ul class="links" id="mod_menus">
                    <li><a class="on" hideFocus=""
                           href="${base}/helper/member/red/list.jhtml?type=tenantCoupon&status=${status}">红包</a>
                    </li>
                </ul>
            </div>
            <form id="inputForm" action="add.jhtml" method="post">
                ...
                <table class="input">
                    <tr>
                        <th>
                            <span class="requiredField">*</span>红包的面额:
                        </th>
                        <td colspan="3">
                            <input type="text" id="amount" name="amount" class="text" placeholder="红包的金额"/>
                        </td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        <th>
                            <span class="requiredField">*</span>红包数量:
                        </th>
                        <td colspan="3">
                            <input type="text" id="count" name="count" class="text" placeholder="红包数量" />
                        </td>
                    </tr>
                    <tr>
                        <th>
                            <span class="requiredField">*</span>领红包限制:
                        </th>
                        <td colspan="3">
