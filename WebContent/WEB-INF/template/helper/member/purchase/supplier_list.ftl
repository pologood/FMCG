...
<body>
    <form id="listForm" action="supplier_list.jhtml" method="get">
        ...
        <table class="list">
            ...
            <tr>
                ...
                [#--<td>${products.sn}</td>--]
                <td>${products.unit}</td>
                <td><input type='text' name='stock${products.id}' value='' style='width: 80px;' stock="${products.availableStock}" onkeyup="compare_stock(this)"></td>
