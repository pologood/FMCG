        ...
        [@flash_message /]
            ...
            $("select[name='supplierId']").change(function () {
                ...
                if(supplierId==""){
                    ...
                    $("#iframe_id").attr("src","${base}/helper/member/purchase/supplier_list.jhtml?id="+supplierId);
            ...
            $("#search").click(function () {
                ...
                $("#iframe_id").attr("src","${base}/helper/member/purchase/supplier_list.jhtml?id="+supplierId+"&keywords="+keyword);
                $("#iframe_id").attr("height","800px;");
            ...
            //     $.ajax({
            //         url: "${base}/helper/member/purchase/supplier.jhtml",
            //         data: {
            //             id: supplierId,
            //             keyword: keyword
            //         },
            ...
            //                         "<th style='width: 260px; text-align: left; '>商品名称</th><th>规格</th><th>型号</th><th>商品编码</th><th>单位</th><th>采购数量</th><th>备注</th></tr>";
            //                 if (data.length > 0) {
            ...
            $("#confirm").click(function(){
                ...
                var supplierId = $("select[name='supplierId']").children('option:selected').val();
                var $checkedIds = $(document.getElementById("iframe_id").contentWindow.document.body).find(".list input[name='ids']:enabled").filter(":enabled:checked");
                ...
                for (var i = 0; i < obj.length; i++) {
                    if (obj[i].checked == true) {
                        checked_obj+="quartitys="+$(document.getElementById("iframe_id").contentWindow.document.body).find("input[name='stock"+obj[i].value+"']").val()+"&";
                        content_obj+="memos="+$(document.getElementById("iframe_id").contentWindow.document.body).find("input[name='content"+obj[i].value+"']").val()+"&";
                    }
                }
                ...
                $.ajax({
                    url: "${base}/helper/member/purchase/save.jhtml?"+checked_obj+content_obj+$checkedIds.serialize(),
                    data: {
                        sn:sn,
                ...
                <table class="input">
                    <tr>
                        ...
                        <td>
                            ...
                            [#--<a href="print.jhtml" class="iconButton">--]
                                [#--打印--]
                            [#--</a>--]
                        </td>
                    </tr>
