...
<div class="page-nav page-nav-app vip-guide-nav" id="app_head_nav">
    ...
    <ul class="links" id="mod_menus">
        <a class="on" hideFocus="" href="${base}/helper/member/discount/add.jhtml?type=seckill">所有商品</a>
        <a hideFocus="" href="${base}/helper/member/discount/list.jhtml?type=seckill">商品分类</a>
    </ul>
