            ...
            <div class="mainbox member" style="position:static;">
                <div class="page-nav page-nav-app vip-guide-nav" id="app_head_nav">
                    <div class="js-app-header title-wrap" id="app_0000000844">
                        ...
                        <dl class="app-info">
                            <dt class="app-title" id="app_name">修改密码</dt>
                            <dd class="app-status" id="app_add_status">
                            </dd>
                            <dd class="app-intro" id="app_desc">定期修改密码，如果忘记可以通过手机找回。</dd>
                        </dl>
                    </div>
                    <ul class="links" id="mod_menus">
                        <li><a class="on" hideFocus="" href="javascript:;">修改密码</a></li>
                    </ul>

                </div>
                <div class="account-table1" id="account-table1">
                    <form id="inputForm" action="password.jhtml" method="post">
                        <table class="input">
                            <tr>
                                <th>
                                ...
                                <td>
                                    <input type="password" id="currentPassword" name="currentPassword" class="text"
                                           maxlength="20"/>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="submit" class="h-button button"
                                           value="${message("box.password.submit")}"/>
                                    <input type="button" class="h-button button" value="${message("box.password.back")}"
