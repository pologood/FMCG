            ...
            <div class="page-nav page-nav-app vip-guide-nav" id="app_head_nav">
                <div class="js-app-header title-wrap" id="app_0000000844">
                    ...
                    <dl class="app-info">
                        ...
                        <dd class="app-intro" id="app_desc">管理我的店铺代金券。</dd>
                    </dl>
                </div>
                <ul class="links" id="mod_menus">
                    <li>
                        <a [#if processStatus=="canUse"]class="on"[/#if] hideFocus=""
                           href="${base}/helper/member/coupon/list.jhtml?type=tenantCoupon&processStatus=canUse">可领用</a>
                    </li>
                    <li>
                        <a [#if processStatus=="unBegin"]class="on"[/#if] hideFocus=""
                           href="${base}/helper/member/coupon/list.jhtml?type=tenantCoupon&processStatus=unBegin">未开始</a>
                    </li>
                    <li>
                        <a [#if processStatus=="unUsed"]class="on"[/#if] hideFocus=""
                           href="${base}/helper/member/coupon/list.jhtml?type=tenantCoupon&processStatus=unUsed">已领完</a>
                    </li>
                    <li>
                        <a [#if processStatus=="Expired"]class="on"[/#if] hideFocus=""
                           href="${base}/helper/member/coupon/list.jhtml?type=tenantCoupon&processStatus=Expired">已过期</a>
                    </li>
                </ul>
            ...
            <form id="listForm" action="list.jhtml" method="get">
                ...
                <div class="bar">
                    ...
                    [@helperRole url="helper/member/coupon/list.jhtml" type="add"]
                        ...
                        [/#if]
                    [/@helperRole]
                    [@helperRole url="helper/member/coupon/list.jhtml" type="del"]
                        [#if helperRole.retOper!="0"]
                    ...
                    <a href="${base}/helper/member/coupon/list.jhtml?type=tenantCoupon&status=${status}"
                       class="iconButton">
                    ...
                    <div class="menuWrap">
                        ...
                        [#--<span id="searchPropertySelect" class="arrow">&nbsp;</span>--]
                            <input placeholder="搜索代金券名称" type="text" id="searchValue" name="searchValue"
                ...
                <div class="list">
                    <table id="listTable" class="list">
                        <tr>
                            ...
                            <th>
                                <a href="javascript:;" class="sort" name="count">券的库存</a>
                            </th>
                            <th>
                                <a href="javascript:;" class="sort" name="receiveTimes">可领取次数</a>
                            </th>
                            <th>
                    ...
                    [#list page.content as coupon]
                        <tr>
                            ...
                            <td>
                                ...
                                [@helperRole url="helper/member/coupon/list.jhtml" type="share"]
                                    [#if helperRole.retOper!="0"]
