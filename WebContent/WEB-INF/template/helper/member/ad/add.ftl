                ...
                <form id="inputForm" action="save.jhtml" method="post" enctype="multipart/form-data">
                    ...
                    <table class="input">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="fieldSet">
                                    <input type="text" name="path" class="text" maxlength="200" title="${message("admin.product.imageTitle")}" readonly="true"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="url" id="productUrl" class="text" maxlength="200"
                                       readonly=true/>
