...
<div class="page-nav page-nav-app vip-guide-nav" id="app_head_nav">
    ...
    <ul class="links" id="mod_menus">
        <li><a class="on" hideFocus="" href="${base}/helper/member/buygifts/add.jhtml?type=seckill">所有商品</a></li>
        <li><a hideFocus="" href="${base}/helper/member/buygifts/list.jhtml?type=seckill">商品分类</a></li>
    </ul>
...
<form id="listForm" action="list.jhtml" method="get">
    ...
    <div class="bar">
        <div class="buttonWrap">
            ...
            <a style="cursor: pointer;" id="refreshButton" class="iconButton">
            ...
            <div class="menuWrap">
                ...
                <div class="popupMenu">
                    <ul id="pageSizeOption">
                        <li>
                            <a style="cursor: pointer;"[#if page.pageSize == 10] class="current"[/#if] val="10">10</a>
                        </li>
                        <li>
                            <a style="cursor: pointer;"[#if page.pageSize == 20] class="current"[/#if] val="20">20</a>
                        </li>
                        <li>
                            <a style="cursor: pointer;"[#if page.pageSize == 50] class="current"[/#if] val="50">50</a>
                        </li>
                        <li>
                            <a style="cursor: pointer;"[#if page.pageSize == 100] class="current"[/#if] val="100">100</a>
                        </li>
                    </ul>
                </div>
            </div>
