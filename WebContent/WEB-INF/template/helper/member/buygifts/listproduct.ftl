...
[/@seo]
    ...
    <script type="text/javascript">
        ...
        function addGift(id) {
            $.ajax({
                url: "${base}/helper/member/buygifts/add_gift.jhtml",
                type: "POST",
                dataType: "json",
                data: {
                    id: id
    ...
    [#include "/helper/member/include/menu.ftl" /]
        ...
        <div class="wrapper" id="wrapper">
            <div class="page-nav page-nav-app vip-guide-nav" id="app_head_nav">
                ...
                [#if type=='gift']
                    <li>
                        <a hideFocus="" href="${base}/helper/member/buygifts/listgift.jhtml">赠品管理</a>
                    </li>
                [/#if]
                    <li>
                        <a class="on" hideFocus="" href="${base}/helper/member/buygifts/listproduct.jhtml">所有商品</a>
                    </li>
                </ul>
            </div>
            <form id="listForm" action="listproduct.jhtml" method="get">
                ...
                <div class="bar">
                    <div class="buttonWrap">
                        <a href="${base}/helper/member/buygifts/listproduct.jhtml" class="iconButton">
                ...
                [#list page.content as product]
                    <tr>
                        ...
                        <td>
                            [#if type=='gift']
                                <a href="javascript:addGift('${product.id}')">[添加]</a>
                            [#else ]
                                <a href="${base}/helper/member/buygifts/edit.jhtml?id=${product.id}">[操作]</a>
                            [/#if]
                        </td>
                    </tr>
                [/#list]
