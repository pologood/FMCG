        ...
        <div class="wrapper" id="wrapper">
            ...
            <div class="page-nav page-nav-app vip-guide-nav" id="app_head_nav">
                ...
                <ul class="links" id="mod_menus">
                    <li><a class="on" hideFocus="" href="${base}/helper/member/role/list.jhtml">角色添加</a></li>
                </ul>
            </div>
            <form id="inputForm" action="${base}/helper/member/role/save.jhtml" method="post">
                ...
                <table class="input">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="name" value="[#if role??]${role.name}[/#if]">
                        </td>
