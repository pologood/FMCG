        ...
        <div class="wrapper" id="wrapper">
            ...
            <div class="page-nav page-nav-app vip-guide-nav" id="app_head_nav">
                <div class="js-app-header title-wrap" id="app_0000000844">
                    <img class="js-app_logo app-img" src="${base}/resources/helper/images/upload4.png"/>
                    <dl class="app-info">
                ...
                [@helperRole url="helper/member/product/isMarketableList.jhtml" ]
                    [#if helperRole.retUrl!="0"]
                        <li><a class="" hideFocus=""
                               href="${base}/helper/member/product/isMarketableList.jhtml">已上架商品</a>
                        </li>
                    [/#if]
                [/@helperRole]
                    <li><a class="on" hideFocus=""
                           href="${base}/helper/member/product/notMarketablelist.jhtml">已下架商品</a></li>
                </ul>
            ...
            [#--value="[#if isStockAlert??]${isStockAlert?string("true", "false")}[/#if]"/>--]
                <div class="bar">
                    ...
                    [@helperRole url="helper/member/product/notMarketablelist.jhtml" type="upMarket"]
                        [#if helperRole.retOper!="0"]

                            <a id="upMarketButton" href="javascript:;" class="iconButton disabled">
                                <span class="trueIcon">&nbsp;</span>上架
                            </a>
                        [/#if]
                    [/@helperRole]
                    [@helperRole url="helper/member/product/notMarketablelist.jhtml" type="del"]
                        [#if helperRole.retOper!="0"]
                        ...
                        [/#if]
                    [/@helperRole]
                    [#--<a href="javascript:;" id="upMarketableButton" class="iconButton disabled">--]
                    [#--<span class="deleteIcon">&nbsp;</span>上架--]
                    [#--</a>--]
                        <a href="${base}/helper/member/product/notMarketablelist.jhtml" class="iconButton">
                ...
                <table id="listTable" class="list">
                    <tr>
                        ...
                        [#if versionType=="1"]
                        <th>
                            <a href="javascript:;" class="sort" name="sn">条形码</a>
                        </th>
                        [/#if]
                        <th>
    ...
    ${abbreviate(product.fullName, 30, "..")}
        ...
        [/#if]
                        ...
                        <td>
                            ...
                            [@helperRole url="helper/member/product/notMarketablelist.jhtml" type="update"]
                                [#if helperRole.retOper!="0"]
