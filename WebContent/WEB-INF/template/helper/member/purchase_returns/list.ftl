    ...
    <script type="text/javascript">
        ...
        [@flash_message /]
            ...
            $("#exportBtn").click(function(){
                ...
                $.ajax({
                    url:"${base}/helper/member/purchase/returns/export_list.jhtml",
                    type:"get",
                    data:{
        ...
        <div class="wrapper" id="wrapper">
            ...
            <div class="page-nav page-nav-app vip-guide-nav" id="app_head_nav">
                <div class="js-app-header title-wrap" id="app_0000000844">
                    ...
                    <dl class="app-info">
                        <dt class="app-title" id="app_name">我的采购退货单</dt>
                        <dd class="app-status" id="app_add_status">
                        </dd>
                        <dd class="app-intro" id="app_desc">查询采购退货单明细。</dd>
                    </dl>
                </div>
                <ul class="links" id="mod_menus">
                    <li><a class="on" hideFocus="" href="javascript:;">我的采购退货单</a></li>
                </ul>
            </div>
            <form id="listForm" action="list.jhtml" method="get">
                <div class="bar">
                    <div class="buttonWrap">
                    [@helperRole url="helper/member/purchase/returns/list.jhtml" type="add"]
                    ...
                    <div class="menuWrap" style="">
                        <span style="">时间：</span><input type="text" class="text W120" id="beginDate" name="beginDate" value="${(beginDate?string('yyyy-MM-dd'))!}" onclick="WdatePicker({maxDate:'#F{$dp.$D(\'endDate\',{d:-1})}',onpicked:function(){endDate.focus();}})" readonly placeholder="开始时间"> 至 <input type="text" class="text W120" id="endDate" name="endDate" value="${(endDate?string('yyyy-MM-dd'))!}" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'beginDate\',{d:1})}'})" readonly placeholder="结束时间">
                        <!-- <input type="text" class="text W120" name="supplierName" value="${supplierName}" placeholder="搜索供应商"/> -->
                        <input type="text" class="text W120" name="keywords" value="${keywords}" placeholder="搜索....." style="margin-left:20px;"/>
                        <input type="submit" value="搜索" class="button"/>

                    [@helperRole url="helper/member/purchase/returns/list.jhtml" type="exp"]
                        [#if helperRole.retOper!="0"]
                    ...
                    <table class="list">
                        ...
                        [#list page.content as purchase]
                            <tr[#if !purchase_has_next] class="last"[/#if]>
                                ...
                                <td class="noExl">
                                    <a
                                        [@helperRole url="helper/member/purchase/returns/list.jhtml" type="applied"]
                                            [#if helperRole.retOper!="0"]
                                                    href="${base}/helper/member/purchase/returns/edit/${purchase.id}.jhtml?type=${purchase.type}"
                                            [/#if]
                                        [/@helperRole]
                                         >
                                        [#if purchase.type=='applied']
                                            [@helperRole url="helper/member/purchase/returns/list.jhtml" type="exp"]
                                                ...
                                                [#else ]
                                                    <span style="color: red;" >[无权审核]</span>
                                                [/#if]
                                            [/@helperRole]
                                        [#else]
                                            [查看]
