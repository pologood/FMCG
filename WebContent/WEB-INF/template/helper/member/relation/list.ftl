        ...
        <div class="wrapper" id="wrapper">
            ...
            <div class="page-nav page-nav-app vip-guide-nav" id="app_head_nav">
                <div class="js-app-header title-wrap" id="app_0000000844">
                    ...
                    <dl class="app-info">
                        ...
                        <dd class="app-intro" id="app_desc">管理关注我的买家，根据业务关系设置他们的vip等级，分级显示价格</dd>
                    </dl>
                </div>
            ...
            <form id="listForm" action="list.jhtml" method="get">
                ...
                <div class="bar">
                    ...
                    [@helperRole url="helper/member/relation/list.jhtml" type="del"]
                        ...
                        [/#if]
                    [/@helperRole]
                        <a href="${base}/helper/member/relation/list.jhtml" class="iconButton">
                    ...
                    <div class="menuWrap">
                        ...
                        [#--<span id="searchPropertySelect" class="arrow">&nbsp;</span>--]
                            <input placeholder="搜索客户名称" type="text" id="searchValue" name="searchValue"
