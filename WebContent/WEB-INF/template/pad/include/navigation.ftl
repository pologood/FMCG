...
<aside class="p_aside p_listaside">
	<div class="p_aside">
		<div class="p_navbody p_listnavbody" id="p_navscrooler">
					 ...
					 [#list productCategories as rootProductCategory]
					    <li>
							<div class="p_navli">
								...
								<div class="p_tag" ></div>
								<div class="p_listin flag p_listinRoot"  productCategoryId="${rootProductCategory.id}"></div>
							</div>
					    </li>
					  [/#list]
...
<div class="p_classf2 p_listclassf2" id="p_classf2scrooler">
<div class="bodycont p_tap2li">
	<ul id="p_tap2ul">
		</ul>
	</div>
</div>
<div class="p_classf3 p_listclassf3" id="p_classf3scrooler">
