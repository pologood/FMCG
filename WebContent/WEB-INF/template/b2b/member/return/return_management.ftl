...
<div class="paper">
                        ...
                        <div class="item-body clearfix" id="item_body">
                            ...
                            <ul class="item-content clearfix">
                                <li class="td-item">
                                    ...
                                    <div class="td-inner">
                                        <div class="item-pic">
                                            <a href="${base}/b2b/product/detail/${(orderItems.product.id)!}.jhtml" target="_blank">
                                                <img src="${orderitems.thumbnail}" style="width:82px;height:82px;">
                                            </a>
                                        </div>
                                        <div class="item-info">
                                            <div class="item-basic-info">
                                                <a href="${base}/b2b/product/detail/${(orderItems.product.id)!}.jhtml" title="${orderitems.fullName}" class="item-title">
                                                    ${orderitems.fullName}
                                                </a>
                                            </div>
                                            <div class="item-other-info">
    ...
    <!--我的收藏-->
    <!--start-->
    [#include "/b2b/include/recommond.ftl"]
    <!--end-->
