...
<div class="paper">
                                ...
                                <div class="order-list-info">
                                    <div class="tr">
                                        <div class="td">
                                            ...
                                            <a class="name" href="javascript:;" target="_blank" title="${trade.tenant.shortName}">${trade.tenant.shortName}</a>
                                            <span class="level">
                                        ...
                                        [#list trade.orderItems as orderItem]
                                            [#if orderItem_index==0&&orderItem?has_content]
                                                <ul class="item-content clearfix">
                                                    <li class="td-item" onclick="window.location.href='${base}/b2b/product/detail/${(orderItem.product.id)!}.jhtml'">
                                                        <div class="td-inner">
                                                            <div class="item-pic">
                                                    ...
                                                    <li class="td-status border-right">
                                                        <div class="td-inner">
                                                            ...
                                                            <a href="${base}/b2b/member/order/order_detail.jhtml?id=${trade.id}">订单详情</a>
                                                        </div>
                                                    </li>
                                                    <li class="td-op">
                                                        <div class="td-inner">
                                                        ...
                                                        [#if finalOrderStatu_index==0]
                                                            ...
                                                            [#elseif finalOrderStatu.status=='sign'
                                                                    ||finalOrderStatu.status=='partialShipment']
                                                                [#if trade.returnsStatus=="refused"||trade.returnsStatus=="null"]
                                                                <a href="javascript:waitReturn(${trade.order.sn},${trade.id},'${trade.shippingStatus}','${trade.orderStatus}');" style="background-color: white;color:black;border: 1px solid;">退货申请</a>
                                                                [/#if]
                                            ...
                                            [#else]
                                                <ul class="item-content clearfix">
                                                        <li class="td-item border-top">
                                                            <div class="td-inner">
                                                                <div class="item-pic">
                                                                    <a href="${base}/b2b/product/detail/${(orderItem.product.id)!}.jhtml" target="_blank">
    ...
    <!--可能感兴趣 -->
    <iframe id="interest" name="interest" src="${base}/b2b/product/interest.jhtml" scrolling="no" width="100%" height="auto">
    </iframe>
    <!--标语 -->
...
<script type="text/javascript">
    $(function(){
        ...
        $("#export_ss").click(function(){
            ...
            $.ajax({
                url:"${base}/b2b/member/order/all_list.jhtml",
                type:"get",
                data:{
        ...
        checkLock(sn,function(){
            if(window.confirm("您确定要申请退货吗?")) {
                if(shipStatus=="accept"&&orderStatus=="completed"){
                    location.href="${base}/b2b/member/order/return/return_management.jhtml?id="+id;
                }else{
                    $.ajax({
                        url: '${base}/b2b/member/order/return.jhtml',
                        data: {id: id},
                        type:'post',
                        dataType:'json',
                        success: function (data) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.message.type == "success") {
                            ...
                            window.setTimeout(function(){
                                location.href="${base}/b2b/member/order/evaluate/list.jhtml"
                            },600)
                        } else {
                            $.message(data.message);
                        }
            ...
            $.ajax({
                ...
                success:function(dataBlock){
                    if(dataBlock.message.type = "success"){
                        location.href="${base}/b2b/payment/payment_index.jhtml?sn="+dataBlock.data;
                    }else{
