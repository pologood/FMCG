                                        ...
                                        <div class="order-list-content">
                                            <div class="item-body clearfix">
                                                <ul class="item-content clearfix">
                                                    <li class="td-item" onclick="window.location.href='${base}/b2b/product/detail/${(returnitems.orderItem.product.id)!}.jhtml'">
                                                        <div class="td-inner">
                                                            <div class="item-pic">
                                                ...
                                                <li class="td-item" >
                                                    <div class="checkbox ">
                                                        <input type="checkbox" name="productId"
                                                               ...
                                                               shipq="${orderitems.shippedQuantity}"
...
<script type="text/javascript">
    ...
    function confirm_return() {
        ...
        $.ajax({
            url: '${base}/b2b/member/order/create_return.jhtml',
            ...
            success: function (data) {
                ...
                if (data.type == "success") {
                    location.href = "${base}/b2b/member/order/return/return_management.jhtml";
                }
            }
        });
    }
    ...
    function cancel_return(id) {
        if (confirm("确认要取消该退货吗")) {
            $.ajax({
                url: "${base}/b2b/member/order/cancel_return.jhtml",
                type: "post",
                data: {id: id},
                dataType: "json",
                success: function (data) {
