                            ...
                            <div class="li-main display-n">
                                ...
                                [#if idcard.authStatus=="none"||idcard.authStatus=="fail"||idcard.authStatus==null]
                                    <dl>
                                        ...
                                        <dt></dt>
                                        <dd>
                                            <a class="save-btn" href="javascript:;" onclick="$identityForm.submit();">提交</a>
                                        </dd>
                                    </dl>
                                [#else]
                                    <dl>
                            ...
                            <div class="li-main display-n bindmobile">
                                <form action="" method="post" id="payPasswordForm">
                                    ...
                                    <dl>
                                        <dt>登录密码：</dt>
                                        <dd>
                                            <input class="text" id="curPassword2" name="curPassword" type="password" value="" title=""/>
                                        </dd>
                                        <dt>支付密码：</dt>
                                        <dd>
                                            <input class="text" id="newPassword2" name="newPassword" type="password" value="" title=""/>
                                        </dd>
                                        <dt>确认支付密码：</dt>
                                        <dd>
                                            <input class="text" id="rePassword2" name="rePassword" type="password" value="" title=""/>
                                        </dd>
                                        <dt>验证码：</dt>
                                        <dd class="verify-code">
                                            <input id="captcha2" name="captcha" class="text" type="text" maxlength="4" autocomplete="off" title=""/>
                                            <img id="captchaImage2" class="captchaImage" src="${base}/common/captcha.jhtml?captchaId=${captchaId}" alt="验证码">
