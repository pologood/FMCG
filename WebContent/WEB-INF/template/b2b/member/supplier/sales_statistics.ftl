...
<head>
    ...
    <meta name="" content=""/>
    <title>${setting.siteName}-供应商-销售统计</title>
...
<form id="listForm" action="saleStatistics.jhtml" method="get">
...
//                return date.valueOf() < now.valueOf() ? 'disabled' : '';
        ...
        $("#export_ss").click(function(){
            ...
            $.ajax({
                url:"${base}/b2b/member/supplier/sale_total.jhtml",
                type:"get",
                data:{
                    begin_date:$("#dpd1").val(),
                    end_date:$("#dpd2").val(),
