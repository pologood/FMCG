...
<head>
    ...
    <meta name="" content=""/>
    <title>${setting.siteName}-供应商-提现结算</title>
...
[#include "/b2b/include/supplier_top.ftl"]
    ...
    <form id="listForm" action="${base}/b2b/member/supplier/withdraw_cash_settle_account.jhtml" method="get">
    ...
    <input type="hidden" name="menu" value="withdraw_cash_settle_account">
        ...
        <table class="product-items">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>[#if account.status=='success']已结算[#else]未结算[/#if]</td>
                    <td>
                        [#if account.tenant??]${account.tenant.name}(${account.tenant.telephone})[/#if]
                    </td>
                </tr>
                [/#list]
            </tbody>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#export_ss").click(function(){
                ...
                $.ajax({
                    url:"${base}/b2b/member/supplier/withdraw_cash_settle_account_export.jhtml",
                    type:"get",
                    data:{
