...
<form id="listForm" action="${base}/b2b/member/supplier/purchase/returns/list.jhtml" method="get">
            ...
            [#list page.content as purchase]
                <tr>
                    ...
                    <th>
                        ...
                        [#--[#else]--]
                            <a href="${base}/b2b/member/supplier/purchase/returns/edit/${purchase.id}.jhtml?type=${purchase.type}">[查看]</a>
                        [#--[/#if]--]
                    </th>
                </tr>
            [/#list]
