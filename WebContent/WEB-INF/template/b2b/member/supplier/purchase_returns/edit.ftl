                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="sn" class="text"
                            ...
                            <a href="${base}/b2b/member/supplier/purchase/returns/print.jhtml?id=${purchaseReturns.id}"
                               target="_blank"
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="modifyDate" class="text"
                               value="${(purchaseReturns.purchaseDate)!}" readonly/><span id="checkMsg"
                                                                                          style="color:red">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="modifyDate" class="text"
                               value="${(purchaseReturns.tenant.name)!}" readonly/><span id="checkMsg"
                                                                                         style="color:red">
                    </td>
                </tr>
                <tr>
