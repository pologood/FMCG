...
[#include "/b2b/include/supplier_top.ftl"]
    ...
    <form id="listForm" action="${base}/b2b/member/supplier/returnsManagement.jhtml" method="get">
        ...
        <div class="catalog-details">
            ...
            <ul class="item">
                <div class="details-order">
                    ...
                    <div class="subset">
                        ...
                        [#list 1..page.trade.tenant.score as s]
                            <img src="${base}/resources/b2b/images/shan.png" alt=""/>
                        [/#list]
                        [/#if]
                    </div>
                </div>
                ...
                <div class="sales-num">
                    ...
                    [/#if]
                    <div class="sales-item">退货价格：<span>￥${page.cost}</span></div>
