...
<div class="am-g header-bg">
    <div class="am-container am-center" style="width:1106px;">
        <div class="am-fl">
            <img src="${base}/resources/b2b/images/logo_01.png" alt="${setting.siteName}-登录" class="header-login">
        </div>
...
<div class="am-g banner">
    <div class="am-container" style="width:1106px;">
        ...
        <div class="px am-fr" id="_signin">
            ...
            <form action="${base}/b2b/supplier/login/submit.jhtml" method="post" id="loginForm">
                ...
                <a href="javascript:;" class="fullBtnBlue" onclick="$loginForm.submit();">登陆</a>
            </form>
        </div>
        <!-- 注册 -->
        ...
        <div class="px am-fr hidden" id="_resetPassword">
            ...
            <form action="${base}/b2b/supplier/resetPassword.jhtml" method="post" id="resetPwdForm">
                <div class="normalInput">
                    <div class="normalInput-bg1 bg"></div>
                        ...
                        $.ajax({
                            ...
                            success: function (message) {
                                if (message.type == "success") {
                                    ...
                                    [#else]
                                        location.href = "${base}/b2b/member/supplier/index.jhtml";
                                    [/#if]
                                    }, 1500);
                                } else {
