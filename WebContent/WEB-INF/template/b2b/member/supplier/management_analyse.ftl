...
<div class="f-left rt">
    ...
    <div class="breadcrumbs">
        <ul class="breadcrumb">
            <p>当前位置：</p>
            <li>供货商管理后台</li>
            <li><a href="${base}/b2b/member/supplier/index.jhtml">首页</a></li>
            <li>数据统计</li>
            <li>经营分析</li>
        </ul>
    </div>
   [#include "/b2b/include/supplier_top.ftl"]
    ...
    <form id="listForm" action="${base}/b2b/member/supplier/management_analyse.jhtml" method="get">
    ...
    <script>
        $(function(){
            ...
            $("#export_ss").click(function(){
                ...
                $.ajax({
                    url:"${base}/b2b/member/supplier/management_analyse_export.jhtml",
                    type:"get",
                    data:{
                        start_date:$("#dpd1").val(),
                        end_date:$("#dpd2").val(),
