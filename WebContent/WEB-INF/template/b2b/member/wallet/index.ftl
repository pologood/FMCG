                    ...
                    <div class="assets">
                        <div class="dl wire">
                            ...
                            <div class="dd">
                                ...
                                [#if versionType==1]
                                    <a href="${base}/b2b/member/cash/index.jhtml" style="margin-left: 20px;">提现</a>
                                [#else]
                        ...
                        <div class="cz_con">
                            <!-- <form id="inputForm" action="${base}/b2b/payment/submit.jhtml" method="post" target="_blank"> -->
                    ...
                    [#if versionType!=1]
                        <div class="dl">
                            ...
                            <div class="dd">
                                ...
                                <a href="${base}/b2b/member/cash/index.jhtml" >提现</a>
                                <div class="ul">
                                    <div class="li wire">
                    ...
                    <div class="default-card">
                        ...
                        <div class="default-card-item">
                            [#if memberBanks?size>0]
                                ...
                                <a class="control" href="${base}/b2b/member/wallet/bank/list.jhtml">管理银行卡</a>
                            [#else]
                                <a class="control" style="padding-left: 0;" href="[#if idcard.authStatus=='success']${base}/b2b/member/wallet/bank/list.jhtml[#else]javascript:$.message('error','您还未实名认证');[/#if]">添加银行卡</a>
                            [/#if]
                        </div>
                    </div>
                    <div class="bill-record">
                        <iframe id="billIframe" name="billIframe" frameborder="0" src="${base}/b2b/member/wallet/bill/list.jhtml" width="100%" scrolling="no">
                        </iframe>
                    </div>
                </div>
            </div>
