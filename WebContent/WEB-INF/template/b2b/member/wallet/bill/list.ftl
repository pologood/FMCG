...
<head>
    ...
    <script type="text/javascript">
        ...
        function getBill() {
            $("#dateType").val("1");
            $("#listForm").submit();
        [#--location.href = "${base}/b2b/member/wallet/bill/list.jhtml?date=" + $dp.cal.getNewDateStr();--]
        }
...
<body>
<form id="listForm" action="${base}/b2b/member/wallet/bill/list.jhtml" method="get">
        ...
        <div class="bill-detail">
            ...
            [#list page.content as deposit]
                ...
                [#--<span class="pay-num">订单支付&nbsp;单号：<em>201603079790456</em></span>--]
                    ...
                    <!-- a class="details" href="${base}/b2b/member/order/order_detail.jhtml?id=${deposit.id}">详情</a -->
                </div>
            [/#list]
            </div>
