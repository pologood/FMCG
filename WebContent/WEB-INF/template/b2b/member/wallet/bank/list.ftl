...
<head>
    ...
    <script type="text/javascript">
        ...
        function getCode() {
            ...
            console.log(count, "1");
            $.ajax({
                url: "${base}/b2b/member/send_mobile.jhtml",
                data: {mobile: _mobile},
                type: "POST",
                dataType: "json",
                cache: false,
            ...
            <div class="content">
                ...
                <div class="my-bank-card">
                    <div class="my-bank-card-hd">
                        ...
                        &nbsp;>
                        <a href="${base}/b2b/member/wallet/index.jhtml">我的钱包</a>
                        &nbsp;>
                    ...
                    <div class="account-pay">
                        <div class="input deposit">
                            <form id="inputForm" name="inputForm"
                                  action="${base}/b2b/member/wallet/bank/saveMemberBank.jhtml" method="post">
