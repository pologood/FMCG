            ...
            <div class="cart-main">
                                            ...
                                            <div style="position: relative; overflow-x: hidden; width: 340px; height: 195px; outline: medium none;"
                                                ...
                                                <ul style="position: absolute; top: 0px; left: 0px; width: 100%; height: auto; overflow: visible;">
                                                    [#list tenant.coupons as coupon]
                                                        [#if coupon.status=='confirmed'&&coupon.endDate gte .now?string("yyyy-MM-dd")]
                                                            [#assign isShow=true]
                            ...
                            <div class="clearfix cart-order-body">
                                <div class="cart-shop clearfix">
                                    <div class="cart-shop-info">
                                        ...
                                        [/#if]
                                        店铺：<a href="javascript:;" target="_blank" title="${tenant.name}">${(tenant.name)}</a>
                                            ...
                                            <div class="item-body clearfix">
                                                <ul class="item-content clearfix">
                                                    ...
                                                    <li class="td-item">
                                                        <div class="td-inner">
                                                            <div class="item-pic">
                                                                <a href="${base}/b2b/product/detail/${cartItem.product.id}.jhtml" target="_blank">
                                                                    <img src="${cartItem.product.thumbnail}">
                                                                </a>
                                                            </div>
                                                            <div class="item-info">
                                                                <div class="item-basic-info">
                                                                    <a href="${base}/b2b/product/detail/${cartItem.product.id}.jhtml"
                ...
                [#else]
                    <div style="text-align: center;padding: 50px 0;font-size: large;">
                        <div>购物车快饿瘪了, <a href="${base}/b2b/index.jhtml" style="color: rgb(255,68,0);">去逛逛</a></div>
                    </div>
                [/#if]
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function submit() {
        ...
        window.location.href = '${base}/b2b/member/order/order_submit.jhtml';
    }
</script>
<!--标语 -->
