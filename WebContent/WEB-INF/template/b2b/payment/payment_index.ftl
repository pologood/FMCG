...
<head>
    ...
    <link href="${base}/resources/b2b/css/pay.css" type="text/css" rel="stylesheet">
        ...
        $(function(){
            ...
            $("#confirm_pay").click(function(){
                if (paymentMthodName == "offline") {
                    $.ajax({
                        url: "${base}/b2b/payment/submit_payment.jhtml",
                        type:"POST",
                        data:{
                        ...
                        dataType:"JSON",
                        success:function(){
                            location.href = "${base}/b2b/payment/payment_success.jhtml?sn=" +${order.sn};
                        }
                    });
                }else {
                    if(flag=="true"){
            ...
            $("#union_pay").click(function(){
            	$.message("success","正在帮您处理，请稍后。。。");
            	$("#union_pay_form").submit();
            });
...
<form style="">
    <div style="display:none;">
        <div style="width:40%;height:30%;margin-left:30%;z-index:1000000;position:absolute;background-color:white;top:20%;">
            <div style="height:30%;width:100%;font-size:20px;text-align:center;border-bottom:1px solid #666666;line-height:50px;">余额支付</div>
            <div style="height:40%;width:100%;font-size:20px;padding-top:20px;">
                <div style="margin-left:20px;">请输入密码：
                    <input type="password" name="enPassword" style="width:60%;height:30px;margin-bottom:1px solid black;"/>
                </div>
            </div>
           <div style="height:30%;width:100%;font-size:20px;text-align:center;border-top:1px solid #666666;line-height:50px;margin-top:-20px;">提交支付</div>
        </div>
    </div>
</form>
<!--start-->
<div class="container">
    <div class="pay-order-head clearfix">
        <div class="tit" id="time_show" style="display:[#if order.paymentMethod.method=='offline']none;[/#if]">
        ...
        <div class="tit" id="time_hide" style="display:[#if order.paymentMethod.method=='online']none;[/#if]">
            <span id="">订单提交成功，订单账号：<span>${order.sn}</span></span>
        </div>
        <div class="mon">
            <span>应付金额：</span>
            <span class="mon-num">
            ...
            <div class="pay-tab-main clearfix" id="weixin_main_pay">
                ...
                <div class="bank-list-list clearfix">
                    ...
                    <div id="wechat" class="bank-list-item">
                        <span class="logo">
                            <img src="//s7.mogujie.com/pic/141016/fanxiang_ieygentdg5swkzlfmmytambqgyyde_130x40.jpg" width="130" height="40" alt="">
                        </span>
                    </div>
                    <div id="union_pay" class="bank-list-item" >
                        <span class="logo">
                            <img src="//s7.mogujie.com/pic/131219/o613k_kqzfct2ekrbewvsugfjeg5sckzsew_130x40.png" width="130" height="40" alt="">
                        </span>
                    </div>
                    <form id="union_pay_form" action="${base}/b2b/payment/submit.jhtml" method="post" target="_black">
                    	<input type="hidden" name="paymentPluginId" value="csiipayPlugin">
            ...
            <div class="pay-form fn-fastpay_1st-detail">
                <form>
                    <dl class="form pay-form-credit">
                        ...
                        <dd>
                            <div class="bank-info">
                                <img class="bank-icon" src="//www.mogujie.com/img/bank/0010.jpg" width="130" height="40" alt="">
                        ...
                        <dd>
                            ...
                            <p class="agree">
                                ...
                                <label for="agree-1stc">我已阅读并同意《<a href="javascript:;" target="_blank">快捷支付用户协议</a>》</label>
                            </p>
                    ...
                    <dl class="form">
                        ...
                        <dd>
                            ...
                            <p class="agree">
                                ...
                                <label for="agree-1std">我已阅读并同意《<a href="javascript:;" target="_blank">快捷支付用户协议</a>》</label>
                            </p>
