        ...
        <!-- <div class="flashSaleFloorNav">
            ...
            [#list page as page]
                ...
                <div class="flashSaleFloorShow">
                    ...
                    <a href="${base}/b2b/product/detail/${page.promotionProducts[0].product.id}.jhtml">
                        <img src="${page.promotionProducts[0].product.thumbnail}"/>
                    </a>
                    <h2><a href="${base}/b2b/product/detail/${page.promotionProducts[0].product.id}.jhtml">${page.promotionProducts[0].product.fullName}</a></h2>
                    <div>
                        <div>
                        ...
                        <h1>
                            <a href="${base}/b2b/product/detail/${page.promotionProducts[0].product.id}.jhtml">抢购</a>
                        </h1>
                    </div>
                </div>
                [/#if]
        ...
        function timer() {
            ...
            $.each($("[name='endDate']"), function () {
                ...
                if($(this).attr('endTime')!=null&&$(this).attr('endTime')!=""){
                    if(new Date($(this).attr('endTime')).getTime){
                        time_end = new Date($(this).attr('endTime')).getTime();//设定目标时间
                    }else{
                        time_end = new Date($(this).attr('endTime').replace(/\D+/g,"\/")).getTime(); //设定目标时间
                    }
                }
                // 计算时间差
