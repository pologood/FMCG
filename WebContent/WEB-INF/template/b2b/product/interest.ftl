                        ...
                        <ul>
                            [#list hot as product]
                                [#if product_index gte 0&&product_index lte 4]
                                    <li>
                                        <div class="show-img">
                                        <a href="${base}/b2b/product/detail/${product.id}.jhtml" target="_blank">
                                        ...
                                        <div class="title">
                                            <a title="${product.fullName}" href="${base}/b2b/product/detail/${product.id}.jhtml" target="_parent">${product.fullName}</a>
                                        </div>
                                        <div class="volume">
                                        <span>
