...
<head>
    ...
    <link href="${base}/resources/b2b/css/register.css" type="text/css" rel="stylesheet"/>
...
<div class="pc-g header-bg header_zc">
    <div class="container">
        <div class="logo-con clearfix">
            <a href="${base}/b2b/index.jhtml" class="logo">
                <img src="${base}/resources/b2b/images/logo_zc.png" alt="" />
            </a>
            <div class="logo-title">企 业 注 册</div>
            <div class="have-account">已有账号 <a href="${base}/b2b/login.jhtml?type=login">请登录</a></div>
        </div>
    </div>
</div>
...
<div class="container">
    ...
    <div class="main clearfix">
        ...
        <div class="reg-other company_reg_other">
            ...
            <div class="company-reg">
                <a href="${base}/b2b/register/register_company.jhtml" target="_top">
                    <i class="i-company"></i>
                    <span>企业用户注册</span>
                </a>
            </div>
           <!--  <div class="inter-cust">
                <a href="${base}/b2b/register/register_person.jhtml" target="_top">
                    <i class="i-global"></i>
                    <span>普通用户注册</span>
                </a>
            </div> -->
    ...
    [#include "/b2b/include/prototal.ftl"]
    <div class="ui-mask"></div>
</div>
<script type="text/javascript" src="${base}/resources/b2b/js/register/page_regist.js"></script>
<script type="text/javascript" src="${base}/resources/b2b/js/register/jquery.properties-1.0.9.js"></script>
<script type="text/javascript" src="${base}/resources/b2b/js/register/jquery.validate.js"></script>
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#getPhoneCode").click(function(){
            ...
            $.ajax({
                url: "${base}/b2b/register/send.jhtml",
                data: {
        ...
        $("#submit_register").click(function(){
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.ajax({
                        url: "${base}/b2b/register/register_company.jhtml",
                        type: "POST",
                        data: {
                        ...
                        success: function (message) {
                            ...
                            if(message.type=="success"){
                                if("redirectUrl"!=''){
                                    location.href="${base}/b2b/member/coupon_code/coupon.jhtml";
                                }else{
                                    $.message("success", "店铺等待审核中...");
