    ...
    <div class="personal">
        <div class="info">
            <div class="pic">
                ...
                [#else]
                    <img src="${base}/resources/b2b/img/AccountBitmap-head.png">
                [/#if]
                </div>
            </div>
            <div class="text">
    ...
    <div class="menu">
        <div class="menu-item">
            ...
            <div class="li [#if menu=='wallet']selected[/#if]">
                <a href="${base}/b2b/member/wallet/index.jhtml">
                    <span>我的钱包</span>
                    <em>></em>
                </a>
            </div>
            <div class="li [#if menu=='coupon']selected[/#if]">
                <a href="${base}/b2b/member/coupon_code/list.jhtml">
                    <span>我的优惠券</span>
                    <em>></em>
                </a>
            </div>
            <div class="li [#if menu=='cart']selected[/#if]">
                <a href="${base}/b2b/cart/list.jhtml">
                    <span>购物车</span>
                    <em>></em>
                </a>
            </div>
            <div class="li [#if menu=='favorite']selected[/#if]">
                <a href="${base}/b2b/member/favorite/list.jhtml">
                    <span>我的收藏</span>
                    <em>></em>
                </a>
            </div>
            <div class="li [#if menu=='evaluate']selected[/#if]">
                <a href="${base}/b2b/member/order/evaluate/list.jhtml">
                    <span>我的评价</span>
                    <em>></em>
                </a>
            </div>
            <div class="li [#if menu=='safe']selected[/#if]">
                <a href="${base}/b2b/member/safe/index.jhtml">
                    <span>账号安全</span>
                    <em>></em>
                </a>
            </div>
            ...
            <div class="li [#if menu=='return']selected[/#if]">
                <a href="${base}/b2b/member/order/return/return_management.jhtml">
                    <span>退货管理</span>
                    <em>></em>
                </a>
            </div>
            <div class="li [#if menu=='message']selected[/#if]">
                <a href="${base}/b2b/member/message/list.jhtml">
                    <span>消息管理</span>
                    <em>></em>
                </a>
            </div>
