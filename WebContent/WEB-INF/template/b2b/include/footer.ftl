...
<div class="footer">
    ...
    [/@article_category_root_list]
        <dl>
            <dt>商家入驻</dt>
            <dd>
                <div><a href="${base}/b2b/supplier/login.jhtml" target="_blank">供应商入口</a></div>
    ...
    <div class="container">
        ...
        <div class="authentication">
            ...
            <a rel="nofollow" target="_blank" id="urlknet" tabindex="-1" href="javascript:;">
                <img alt="可信网站" src="${base}/resources/b2b/images/54b8872dNe37a9860.png" border="true" height="32" width="103">
            </a>
            <a rel="nofollow" target="_blank" href="http://www.bj.cyberpolice.cn/index.do">
                <img alt="网络警察" src="${base}/resources/b2b/images/56a89b8fNfbaade9a.jpg" height="32" width="103">
            </a>
            <a rel="nofollow" target="_blank" href="javascript:;">
                <img alt="诚信网站" src="${base}/resources/b2b/images/54b8875fNad1e0c4c.png" height="32" width="103">
            </a>
            <a rel="nofollow" target="_blank" href="http://www.12377.cn">
                <img alt="中国互联网举报中心" src="${base}/resources/b2b/images/5698dc03N23f2e3b8.jpg" height="32" width="103">
            </a>
            <a rel="nofollow" target="_blank" href="http://www.12377.cn/node_548446.htm">
                <img alt="网络举报APP下载" src="${base}/resources/b2b/images/5698dc16Nb2ab99df.jpg" height="32" width="103">
            </a>
        </div>
    </div>
</div>
