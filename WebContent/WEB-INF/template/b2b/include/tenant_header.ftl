        ...
        <div class="container shop-summary">
            <span class="line-left">
                ...
                <span class="shop-name">
                    店铺：<a href="${base}/b2b/tenant/index.jhtml?id=${tenant.id}">${tenant.name}</a>
                </span>
    ...
    <div class="mainNav">
        <div class="container ">
            <div class="merchantNav">
                <ul>
                    <li>
                        <a href="${base}/b2b/tenant/index.jhtml?id=${tenant.id}">首页</a>
                    </li>
                    <li>
                        <a href="${base}/b2b/tenant/search.jhtml?tenantId=${tenant.id}">所有商品</a>
                    </li>
                [#list tenant.productCategoryTenants as productCategoryTenant]
                    [#if productCategoryTenant_index<6]
                        <li>
                            <a href="${base}/b2b/tenant/search.jhtml?tenantId=${tenant.id}&productCategoryTenantId=${productCategoryTenant.id}">${productCategoryTenant.name}</a>
                        </li>
                    [/#if]
                [/#list]
                </ul>
