...
<head>
    ...
    <script type="text/javascript">
        ...
        $().ready(function () {
            if ("${coupon.status}" == "Expired") {//已过期
                ...
                $(".shop_img_get").css("background", "url(${base}/resources/wap/img/coupons_0011.png) no-repeat center");
            ...
            $("#clickCoupon").click(function () {
                if ($("#clickCoupon").text().trim() == "告诉小伙伴" && "${coupon.status}" == "canUse") {
                ...
                } else if ($("#clickCoupon").text().trim() == "点击领取优惠券") {
                    $.ajax({
    ...
    <script type="text/javascript">
        ...
        [#if browse_version=="MicroMessenger"]
            ...
            // });
            // //分享那妞
            //   $('.m_shareclose').on('click',function(){alert(11111);
            //              $('.m_share1').hide();
            //             $('.m_sharebg').hide();
            //     });
            //     $('.m_sharebg').on('click',function(){alert(2222);
            //              $('.m_share1').hide();
            //             $('.m_sharebg').hide();
            //     });
...
<div class="am-g Shop_coupons">
    ...
    <div class="am-intro-bd am-container">
        <span class="ft-bs15 clr-grey01" id="showIOSDialog2" style="font-size: 30px">使用规则</span>
        <div class="am-intro-left am-u-sm-3 none"
        ...
        <div class="am-intro-right am-u-sm-9 none">
            ...
            <div class="weui-dialog">
                <div class="weui-dialog__bd">
                    <div class="rule-window">
                        <p>1、使用时间不限。</p>
                        <p>2、使用商家：<span>菲小姐瑶海万达店、</span><span>鱼尾湾台湾商品馆、</span><span>花千代秘制烤鱼、</span><span>韩国雪冰、</span>
                            <span>名家柠檬鱼、</span><span>王妃家的年糕火锅、</span><span>moment.cafe烘培、</span><span>金泉家韩国料理、</span><span>板烧厨房。</span>
                        </p>
                        <p>3、${setting.siteName}在法律允许范围内可对本次活动进行解释</p>
                    </div>
                </div>
    ...
    <div class="am-g Shop_coupons_bg">
        <div class="am-g">
            ...
            <div class="shop_sum_conditions mb_9 none">
                消费满${coupon.minimumPrice}元抵${coupon.amount}元
            </div>
            <div class="shop_sum_instructions none">
                剩余${coupon.count-coupon.sendCount}张
            </div>
            <div class="shop_sum_instructions none">
                有效期至：${coupon.endDate}
            </div>
            <div class="shuoming">---  ~ 平台券 ~  ---</div>
        </div>
        <div class="am-g">
            <div class="btn-shop_share am-u-sm-8 am-u-sm-centered mt_8 none">
                点击领取优惠券
            </div>
            <div class="btn-shop_share am-u-sm-8 am-u-sm-centered mt_8" id="clickCoupon">
                领取
            </div>
            <div class="btn-shop_share am-u-sm-8 am-u-sm-centered mt_3 none"
                 onclick="location.href='${base}/wap/tenant/index/${coupon.tenant.id}.jhtml'">
                进店逛逛
            </div>
...
<!-- 
<div class="weixin-tip" style="display: none; position: fixed; left:0; top:0; bottom:0; background: rgba(0,0,10,0.8); filter:alpha(opacity=80);  height: 100%; width: 100%; z-index: 9999999;">
    <p style="text-align: center; padding:0 5%;">
      <img src="${base}/resources/wap/image/am-wxprompt.png" style="width: 100%; height: auto;" />
    </p>
  </div>-->
